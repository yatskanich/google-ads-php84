...
use Google\Ads\GoogleAds\V20\Resources\ProductCategoryConstant;
use Google\Ads\GoogleAds\V20\Resources\ProductCategoryConstant\ProductCategoryLocalization;
    ...
    public static function runExample(GoogleAdsClient $googleAdsClient, int $customerId)
    {
        ...
        foreach ($response->iterateAllElements() as $googleAdsRow) {
            ...
            $filteredLocalizations = array_filter(
                ...
                fn(ProductCategoryLocalization $productCategoryLocalization
                ) => $productCategoryLocalization->getRegionCode() === 'US'
