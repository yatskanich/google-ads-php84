...
use Google\Ads\GoogleAds\V24\Enums\GenderTypeEnum\GenderType;
use Google\Ads\GoogleAds\V24\Enums\ReachPlanAgeRangeEnum\ReachPlanAgeRange;
...
use Google\Ads\GoogleAds\V24\Services\PlannableLocation;
use Google\Ads\GoogleAds\V24\Services\PlannedProduct;
use Google\Ads\GoogleAds\V24\Services\PlannedProductReachForecast;
use Google\Ads\GoogleAds\V24\Services\ProductMetadata;
use Google\Ads\GoogleAds\V24\Services\ReachForecast;
use Google\Ads\GoogleAds\V24\Services\Targeting;
...
class ForecastReach
{
    ...
    private const string LOCATION_ID = '2840'; // US
    private const int BUDGET_MICROS = 5000000; // 5
