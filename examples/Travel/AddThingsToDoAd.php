...
use Google\Ads\GoogleAds\V20\Resources\Campaign\TravelCampaignSettings;
...
class AddThingsToDoAd
{
    ...
    private const string THINGS_TO_DO_CENTER_ACCOUNT_ID = 'INSERT_THINGS_TO_DO_CENTER_ACCOUNT_ID_HERE';
