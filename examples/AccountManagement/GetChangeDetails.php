...
use Google\Ads\GoogleAds\V24\Enums\ChangeClientTypeEnum\ChangeClientType;
use Google\Ads\GoogleAds\V24\Enums\ChangeEventResourceTypeEnum\ChangeEventResourceType;
use Google\Ads\GoogleAds\V24\Enums\ResourceChangeOperationEnum\ResourceChangeOperation;
...
class GetChangeDetails
{
    ...
    private static function convertToString($value)
    {
        ...
        if (gettype($value) === 'boolean') {
            ...
            if ($value::class === RepeatedField::class) {
                $strValues = [];
