...
{
    public const string ACCESS_ROLE = 'accessRole';
    public const string ADJUSTMENT_DATE_TIME = 'adjustmentDateTime';
    public const string ADJUSTMENT_TYPE = 'adjustmentType';
    public const string ADVERTISER_UPLOAD_DATE_TIME = 'advertiserUploadDateTime';
    public const string AD_ID = 'adId';
    public const string AD_GROUP_ID = 'adGroupId';
    public const string AD_GROUP_IDS = 'adGroupIds';
    public const string AD_PERSONALIZATION_CONSENT = 'adPersonalizationConsent';
    public const string AD_USER_DATA_CONSENT = 'adUserDataConsent';
    public const string ASSET_GROUP_ID = 'assetGroupId';
    public const string ATTRIBUTE_VALUE = 'attributeValue';
    public const string AUDIENCE_ID = 'audienceId';
    public const string BASE_CAMPAIGN_ID = 'baseCampaignId';
    public const string BID_MODIFIER_VALUE = 'bidModifierValue';
    public const string BILLING_SETUP_ID = 'billingSetupId';
    public const string BRAND_GUIDELINES_ENABLED = 'brandGuidelinesEnabled';
    public const string BRIDGE_MAP_VERSION_ID = 'bridgeMapVersionId';
    public const string BUSINESS_ACCOUNT_IDENTIFIER = 'businessAccountIdentifier';
    public const string BUSINESS_PROFILE_LOCATION = 'businessProfileLocation';
    public const string BUSINESS_NAME = 'businessName';
    public const string CALL_START_DATE_TIME = 'callStartDateTime';
    public const string CALLER_ID = 'callerId';
    public const string CALLOUT_TEXT = 'calloutText';
    public const string CAMPAIGN_BUDGET_ID = 'campaignBudgetId';
    public const string CAMPAIGN_EXPERIMENT_ID = 'campaignExperimentId';
    public const string CAMPAIGN_ID = 'campaignId';
    public const string CAMPAIGN_IDS = 'campaignIds';
    public const string CARRIER_COUNTRY_CODE = 'carrierCountryCode';
    public const string CHAIN_ID = 'chainId';
    public const string CHECK_IN_DAY_CRITERION_ID = 'checkInDayCriterionId';
    public const string CONVERSION_ACTION_ID = 'conversionActionId';
    public const string CONVERSION_ACTION_IDS = 'conversionActionIds';
    public const string CONVERSION_CUSTOM_VARIABLE_ID = 'conversionCustomVariableId';
    public const string CONVERSION_CUSTOM_VARIABLE_VALUE = 'conversionCustomVariableValue';
    public const string CONVERSION_DATE_TIME = 'conversionDateTime';
    public const string CONVERSION_RATE_MODIFIER = "conversionRateModifier";
    public const string CONVERSION_VALUE = 'conversionValue';
    public const string COUNTRY_CODE = 'countryCode';
    public const string CPC_BID_CEILING_MICRO_AMOUNT = 'cpcBidCeilingMicroAmount';
    public const string CPC_BID_MICRO_AMOUNT = 'cpcBidMicroAmount';
    public const string CRITERION_ID = 'criterionId';
    public const string CURRENCY_CODE = 'currencyCode';
    public const string CUSTOMER_ID = 'customerId';
    public const string CUSTOMIZER_ATTRIBUTE_NAME = 'customizerAttributeName';
    public const string CUSTOM_KEY = 'customKey';
    public const string DRAFT_ID = 'draftId';
    ...
    public const string FEED_ITEM_ID = 'feedItemId';
    public const string FEED_ITEM_IDS = 'feedItemIds';
    public const string FEED_ITEM_SET_ID = 'feedItemSetId';
    public const string FINAL_URL = 'finalUrl';
    public const string FLIGHT_PLACEHOLDER_FIELD_NAME = 'flightPlaceholderFieldName';
    public const string FREE_FORM_KEYWORD_TEXT = 'freeFormKeywordText';
    public const string GBRAID = 'gbraid';
    public const string GCLID = 'gclid';
    public const string GEO_TARGET_CONSTANT_ID = 'geoTargetConstantId';
    public const string BUSINESS_PROFILE_ACCESS_TOKEN = 'businessProfileAccessToken';
    public const string BUSINESS_PROFILE_EMAIL = 'businessProfileEmail';
    public const string HOTEL_CENTER_ACCOUNT_ID = 'hotelCenterAccountId';
    public const string IMAGE_ASSET_ID = 'imageAssetId';
    public const string ITEM_ID = 'itemId';
    public const string KEYWORD_PLAN_ID = 'keywordPlanId';
    public const string KEYWORD_TEXT = 'keywordText';
    public const string KEYWORD_TEXTS = 'keywordTexts';
    ...
    public const string LOCATION_IDS = 'locationIds';
    public const string LOCATION_NAMES = 'locationNames';
    public const string LOGIN_CUSTOMER_ID = 'loginCustomerId';
    public const string MANAGER_CUSTOMER_ID = 'managerCustomerId';
    public const string MARKETING_IMAGE_ASSET_ID = 'marketingImageAssetId';
    public const string MERCHANT_CENTER_ACCOUNT_ID = 'merchantCenterAccountId';
    public const string NAME_PREFIX = 'namePrefix';
    public const string OFFLINE_USER_DATA_JOB_ID = 'offlineUserDataJobId';
    public const string OFFLINE_USER_DATA_JOB_TYPE = 'offlineUserDataJobType';
    public const string OMIT_UNSELECTED_RESOURCE_NAMES = 'omitUnselectedResourceNames';
    public const string ORDER_ID = 'orderId';
    public const string OUTPUT_FILE_PATH = 'outputFilePath';
    public const string PAGE_URL = 'pageUrl';
    public const string PARTNER_ID = 'partnerId';
    public const string PAYMENTS_ACCOUNT_ID = 'paymentsAccountId';
    public const string PAYMENTS_PROFILE_ID = 'paymentsProfileId';
    public const string PERCENT_CPC_BID_MICRO_AMOUNT = 'percentCpcBidMicroAmount';
    public const string PHONE_COUNTRY = 'phoneCountry';
    public const string PHONE_NUMBER = 'phoneNumber';
    public const string PLACE_ID = 'placeId';
    public const string RECOMMENDATION_ID = 'recommendationId';
    public const string RESTATEMENT_VALUE = 'restatementValue';
    public const string CREATE_DEFAULT_LISTING_GROUP = 'createDefaultListingGroup';
    public const string DELETE_EXISTING_FEEDS = 'deleteExistingFeeds';
    public const string REPLACE_EXISTING_TREE = 'replaceExistingTree';
    public const string QUANTITY = 'quantity';
    public const string RUN_JOB = 'runJob';
    public const string SESSION_ATTRIBUTES_ENCODED = 'sessionAttributesEncoded';
    public const string SESSION_ATTRIBUTES_DICT = 'sessionAttributesDict';
    public const string SITELINK_TEXT = 'sitelinkText';
    public const string SQUARE_MARKETING_IMAGE_ASSET_ID = 'squareMarketingImageAssetId';
    public const string START_DATE_TIME = "startDateTime";
    public const string THINGS_TO_DO_CENTER_ACCOUNT_ID = 'thingsToDoCenterAccountId';
    public const string USER_AGENT = 'userAgent';
    public const string USER_LIST_ID = 'userListId';
    public const string USER_LIST_IDS = 'userListIds';
    public const string WBRAID = 'wbraid';
