 ...
 * if applicable.
 *
 * Generated from protobuf message <code>google.ads.googleads.v19.resources.AccountBudget.PendingAccountBudgetProposal</code>
 */
class PendingAccountBudgetProposal extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v19.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType proposal_type = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * Output only. The end time as a well-defined type, for example, FOREVER.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v19.enums.TimeTypeEnum.TimeType end_time_type = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
     ...
     * INFINITE.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v19.enums.SpendingLimitTypeEnum.SpendingLimitType spending_limit_type = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
...
class_alias(PendingAccountBudgetProposal::class, \Google\Ads\GoogleAds\V19\Resources\AccountBudget_PendingAccountBudgetProposal::class);
