 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v19.services.RemoveAutomaticallyCreatedAssetsRequest</code>
 */
class RemoveAutomaticallyCreatedAssetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v19.services.AssetsWithFieldType assets_with_field_type = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *                                                                                      automatically created assets.
     * @param \Google\Ads\GoogleAds\V19\Services\AssetsWithFieldType[] $assetsWithFieldType Required. List of assets with field type to be removed from the AdGroupAd.
     *
     * @return \Google\Ads\GoogleAds\V19\Services\RemoveAutomaticallyCreatedAssetsRequest
     *
     * @experimental
     */
     ...
     *           Required. The resource name of the AdGroupAd from which to remove
     *           automatically created assets.
     *     @type array<\Google\Ads\GoogleAds\V19\Services\AssetsWithFieldType>|\Google\Protobuf\Internal\RepeatedField $assets_with_field_type
     *           Required. List of assets with field type to be removed from the AdGroupAd.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v19.services.AssetsWithFieldType assets_with_field_type = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V19\Services\AssetsWithFieldType>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAssetsWithFieldType($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V19\Services\AssetsWithFieldType::class);
