...
class ConversionValueRuleServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * returned.
     * @param \Google\Ads\GoogleAds\V19\Services\MutateConversionValueRulesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateConversionValueRules(\Google\Ads\GoogleAds\V19\Services\MutateConversionValueRulesRequest $argument,
      $metadata = [], $options = []) {
