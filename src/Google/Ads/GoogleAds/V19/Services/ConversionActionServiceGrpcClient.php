...
class ConversionActionServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V19\Services\MutateConversionActionsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateConversionActions(\Google\Ads\GoogleAds\V19\Services\MutateConversionActionsRequest $argument,
      $metadata = [], $options = []) {
