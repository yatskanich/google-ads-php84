 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v19.services.GenerateAudienceOverlapInsightsRequest</code>
 */
class GenerateAudienceOverlapInsightsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * audiences.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v19.common.LocationInfo country_location = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v19.common.AudienceInsightsAttribute primary_attribute = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Ads\GoogleAds\V19\Common\LocationInfo              $countryLocation  Required. The country in which to calculate the sizes and overlaps of
     *                                                                                     audiences.
     * @param \Google\Ads\GoogleAds\V19\Common\AudienceInsightsAttribute $primaryAttribute Required. The audience attribute that should be intersected with all other
     *                                                                                     eligible audiences.  This must be an Affinity or In-Market UserInterest, an
     *                                                                                     AgeRange or a Gender.
     ...
     *
     * @return \Google\Ads\GoogleAds\V19\Services\GenerateAudienceOverlapInsightsRequest
     *
     * @experimental
     */
     ...
     *           Required. The country in which to calculate the sizes and overlaps of
     *           audiences.
     *     @type \Google\Ads\GoogleAds\V19\Common\AudienceInsightsAttribute $primary_attribute
     *           Required. The audience attribute that should be intersected with all other
     *           eligible audiences.  This must be an Affinity or In-Market UserInterest, an
     *           AgeRange or a Gender.
