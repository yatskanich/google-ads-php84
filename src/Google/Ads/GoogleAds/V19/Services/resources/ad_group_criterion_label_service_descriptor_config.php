...
return [
    'interfaces' => [
        'google.ads.googleads.v19.services.AdGroupCriterionLabelService' => [
            'MutateAdGroupCriterionLabels' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V19\Services\MutateAdGroupCriterionLabelsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
