...
return [
    'interfaces' => [
        'google.ads.googleads.v19.services.BatchJobService' => [
            'RunBatchJob' => [
                'longRunning' => [
                    'operationReturnType' => \Google\Protobuf\GPBEmpty::class,
                    'metadataReturnType' => \Google\Ads\GoogleAds\V19\Resources\BatchJob\BatchJobMetadata::class,
            ...
            'AddBatchJobOperations' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V19\Services\AddBatchJobOperationsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'resource_name',
                        'fieldAccessors' => [
            ...
            'ListBatchJobResults' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V19\Services\ListBatchJobResultsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'resource_name',
                        'fieldAccessors' => [
            ...
            'MutateBatchJob' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V19\Services\MutateBatchJobResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
