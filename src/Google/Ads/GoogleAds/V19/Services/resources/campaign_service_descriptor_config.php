...
return [
    'interfaces' => [
        'google.ads.googleads.v19.services.CampaignService' => [
            'EnablePMaxBrandGuidelines' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V19\Services\EnablePMaxBrandGuidelinesResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
            ...
            'MutateCampaigns' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V19\Services\MutateCampaignsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
