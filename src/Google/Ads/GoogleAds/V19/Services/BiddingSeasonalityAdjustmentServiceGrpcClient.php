...
class BiddingSeasonalityAdjustmentServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V19\Services\MutateBiddingSeasonalityAdjustmentsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateBiddingSeasonalityAdjustments(\Google\Ads\GoogleAds\V19\Services\MutateBiddingSeasonalityAdjustmentsRequest $argument,
      $metadata = [], $options = []) {
