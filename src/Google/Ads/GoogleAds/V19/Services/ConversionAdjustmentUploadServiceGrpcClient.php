...
class ConversionAdjustmentUploadServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V19\Services\UploadConversionAdjustmentsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function UploadConversionAdjustments(\Google\Ads\GoogleAds\V19\Services\UploadConversionAdjustmentsRequest $argument,
      $metadata = [], $options = []) {
