...
class AdGroupCustomizerServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * returned.
     * @param \Google\Ads\GoogleAds\V19\Services\MutateAdGroupCustomizersRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateAdGroupCustomizers(\Google\Ads\GoogleAds\V19\Services\MutateAdGroupCustomizersRequest $argument,
      $metadata = [], $options = []) {
