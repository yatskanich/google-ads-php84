...
class AdParameterServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V19\Services\MutateAdParametersRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateAdParameters(\Google\Ads\GoogleAds\V19\Services\MutateAdParametersRequest $argument,
      $metadata = [], $options = []) {
