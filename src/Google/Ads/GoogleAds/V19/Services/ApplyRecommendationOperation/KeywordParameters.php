 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v19.services.ApplyRecommendationOperation.KeywordParameters</code>
 */
class KeywordParameters extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v19.enums.KeywordMatchTypeEnum.KeywordMatchType match_type = 2;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V19\Enums\KeywordMatchTypeEnum\KeywordMatchType::class);
        $this->match_type = $var;
...
class_alias(KeywordParameters::class, \Google\Ads\GoogleAds\V19\Services\ApplyRecommendationOperation_KeywordParameters::class);
