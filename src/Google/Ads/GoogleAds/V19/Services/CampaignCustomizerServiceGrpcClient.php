...
class CampaignCustomizerServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * returned.
     * @param \Google\Ads\GoogleAds\V19\Services\MutateCampaignCustomizersRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateCampaignCustomizers(\Google\Ads\GoogleAds\V19\Services\MutateCampaignCustomizersRequest $argument,
      $metadata = [], $options = []) {
