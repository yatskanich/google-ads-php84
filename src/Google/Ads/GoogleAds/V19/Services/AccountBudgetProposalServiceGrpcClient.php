...
class AccountBudgetProposalServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [RequestError]()
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V19\Services\MutateAccountBudgetProposalRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateAccountBudgetProposal(\Google\Ads\GoogleAds\V19\Services\MutateAccountBudgetProposalRequest $argument,
      $metadata = [], $options = []) {
