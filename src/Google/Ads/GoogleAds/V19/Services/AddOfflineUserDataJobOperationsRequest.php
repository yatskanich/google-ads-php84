 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v19.services.AddOfflineUserDataJobOperationsRequest</code>
 */
class AddOfflineUserDataJobOperationsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v19.services.OfflineUserDataJobOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     * @param \Google\Ads\GoogleAds\V19\Services\OfflineUserDataJobOperation[] $operations   Required. The list of operations to be done.
     *
     * @return \Google\Ads\GoogleAds\V19\Services\AddOfflineUserDataJobOperationsRequest
     *
     * @experimental
     */
     ...
     *           warning will not block the OfflineUserDataJobOperation, and will also
     *           return warning messages about malformed field values.
     *     @type array<\Google\Ads\GoogleAds\V19\Services\OfflineUserDataJobOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to be done.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v19.services.OfflineUserDataJobOperation operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V19\Services\OfflineUserDataJobOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V19\Services\OfflineUserDataJobOperation::class);
        $this->operations = $arr;
