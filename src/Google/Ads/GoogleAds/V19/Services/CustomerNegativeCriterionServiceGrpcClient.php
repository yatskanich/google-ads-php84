...
class CustomerNegativeCriterionServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V19\Services\MutateCustomerNegativeCriteriaRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateCustomerNegativeCriteria(\Google\Ads\GoogleAds\V19\Services\MutateCustomerNegativeCriteriaRequest $argument,
      $metadata = [], $options = []) {
