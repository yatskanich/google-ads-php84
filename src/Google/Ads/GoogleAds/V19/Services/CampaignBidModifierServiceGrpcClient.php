...
class CampaignBidModifierServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringFormatError]()
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V19\Services\MutateCampaignBidModifiersRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateCampaignBidModifiers(\Google\Ads\GoogleAds\V19\Services\MutateCampaignBidModifiersRequest $argument,
      $metadata = [], $options = []) {
