...
namespace Google\Ads\GoogleAds\V19\Enums\AdFormatTypeEnum;
...
class_alias(AdFormatType::class, \Google\Ads\GoogleAds\V19\Enums\AdFormatTypeEnum_AdFormatType::class);
