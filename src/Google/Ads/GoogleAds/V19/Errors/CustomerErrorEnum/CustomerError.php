...
# source: google/ads/googleads/v19/errors/customer_error.proto

namespace Google\Ads\GoogleAds\V19\Errors\CustomerErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v19.errors.CustomerErrorEnum.CustomerError</code>
 */
class CustomerError
{
    /**
     ...
     *
     * Generated from protobuf enum <code>CREATION_DENIED_FOR_POLICY_VIOLATION = 4;</code>
     */
    const CREATION_DENIED_FOR_POLICY_VIOLATION = 4;
    /**
     * Manager account is ineligible to create new accounts.
     *
     * Generated from protobuf enum <code>CREATION_DENIED_INELIGIBLE_MCC = 5;</code>
     */
    const CREATION_DENIED_INELIGIBLE_MCC = 5;
    ...
    private static $valueToName = [
        ...
        self::CREATION_DENIED_FOR_POLICY_VIOLATION => 'CREATION_DENIED_FOR_POLICY_VIOLATION',
        self::CREATION_DENIED_INELIGIBLE_MCC => 'CREATION_DENIED_INELIGIBLE_MCC',
    ];
...
class_alias(CustomerError::class, \Google\Ads\GoogleAds\V19\Errors\CustomerErrorEnum_CustomerError::class);
