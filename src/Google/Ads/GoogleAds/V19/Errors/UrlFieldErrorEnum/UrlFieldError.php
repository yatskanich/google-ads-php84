...
namespace Google\Ads\GoogleAds\V19\Errors\UrlFieldErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v19.errors.UrlFieldErrorEnum.UrlFieldError</code>
 */
class UrlFieldError
{
    /**
     ...
     *
     * Generated from protobuf enum <code>UNSUPPORTED_APP_STORE = 59;</code>
     */
    const UNSUPPORTED_APP_STORE = 59;
    ...
    private static $valueToName = [
        ...
        self::UNSUPPORTED_APP_STORE => 'UNSUPPORTED_APP_STORE',
    ];
...
class_alias(UrlFieldError::class, \Google\Ads\GoogleAds\V19\Errors\UrlFieldErrorEnum_UrlFieldError::class);
