...
# source: google/ads/googleads/v19/errors/extension_setting_error.proto

namespace Google\Ads\GoogleAds\V19\Errors\ExtensionSettingErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v19.errors.ExtensionSettingErrorEnum.ExtensionSettingError</code>
 */
class ExtensionSettingError
{
    ...
    private static $valueToName = [
        ...
        self::DISALLOWED_TEXT => 'DISALLOWED_TEXT',
    ];
...
class_alias(ExtensionSettingError::class, \Google\Ads\GoogleAds\V19\Errors\ExtensionSettingErrorEnum_ExtensionSettingError::class);
