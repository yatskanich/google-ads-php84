...
class CustomerManagerLinkServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V21\Services\MutateCustomerManagerLinkRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V21\Services\MutateCustomerManagerLinkResponse>
     */
    public function MutateCustomerManagerLink(\Google\Ads\GoogleAds\V21\Services\MutateCustomerManagerLinkRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V21\Services\MoveManagerLinkRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V21\Services\MoveManagerLinkResponse>
     */
    public function MoveManagerLink(\Google\Ads\GoogleAds\V21\Services\MoveManagerLinkRequest $argument,
      $metadata = [], $options = []) {
