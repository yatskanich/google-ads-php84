...
class CustomerConversionGoalServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * are returned.
     * @param \Google\Ads\GoogleAds\V21\Services\MutateCustomerConversionGoalsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V21\Services\MutateCustomerConversionGoalsResponse>
     */
    public function MutateCustomerConversionGoals(\Google\Ads\GoogleAds\V21\Services\MutateCustomerConversionGoalsRequest $argument,
      $metadata = [], $options = []) {
