...
class ShareablePreviewServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V21\Services\GenerateShareablePreviewsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V21\Services\GenerateShareablePreviewsResponse>
     */
    public function GenerateShareablePreviews(\Google\Ads\GoogleAds\V21\Services\GenerateShareablePreviewsRequest $argument,
      $metadata = [], $options = []) {
