...
class AutomaticallyCreatedAssetRemovalServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V21\Services\RemoveCampaignAutomaticallyCreatedAssetRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V21\Services\RemoveCampaignAutomaticallyCreatedAssetResponse>
     */
    public function RemoveCampaignAutomaticallyCreatedAsset(\Google\Ads\GoogleAds\V21\Services\RemoveCampaignAutomaticallyCreatedAssetRequest $argument,
      $metadata = [], $options = []) {
