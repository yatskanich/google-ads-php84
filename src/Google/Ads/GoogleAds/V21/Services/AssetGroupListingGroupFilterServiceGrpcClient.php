...
class AssetGroupListingGroupFilterServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateAssetGroupListingGroupFilters(\Google\Ads\GoogleAds\V21\Services\MutateAssetGroupListingGroupFiltersRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.AssetGroupListingGroupFilterService/MutateAssetGroupListingGroupFilters',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\MutateAssetGroupListingGroupFiltersResponse::class, 'decode'],
        $metadata, $options);
    }
