...
class ThirdPartyAppAnalyticsLinkServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function RegenerateShareableLinkId(\Google\Ads\GoogleAds\V21\Services\RegenerateShareableLinkIdRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.ThirdPartyAppAnalyticsLinkService/RegenerateShareableLinkId',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\RegenerateShareableLinkIdResponse::class, 'decode'],
        $metadata, $options);
    }
