...
return [
    'interfaces' => [
        'google.ads.googleads.v21.services.ConversionGoalCampaignConfigService' => [
            'MutateConversionGoalCampaignConfigs' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V21\Services\MutateConversionGoalCampaignConfigsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
