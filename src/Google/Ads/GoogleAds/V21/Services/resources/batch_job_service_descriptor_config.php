        ...
        'google.ads.googleads.v21.services.BatchJobService' => [
            'RunBatchJob' => [
                'longRunning' => [
                    ...
                    'metadataReturnType' => \Google\Ads\GoogleAds\V21\Resources\BatchJob\BatchJobMetadata::class,
            ...
            'AddBatchJobOperations' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V21\Services\AddBatchJobOperationsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'resource_name',
                        'fieldAccessors' => [
            ...
            'ListBatchJobResults' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V21\Services\ListBatchJobResultsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'resource_name',
                        'fieldAccessors' => [
            ...
            'MutateBatchJob' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V21\Services\MutateBatchJobResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
