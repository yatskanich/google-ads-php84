...
return [
    'interfaces' => [
        'google.ads.googleads.v21.services.KeywordPlanAdGroupKeywordService' => [
            'MutateKeywordPlanAdGroupKeywords' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V21\Services\MutateKeywordPlanAdGroupKeywordsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
