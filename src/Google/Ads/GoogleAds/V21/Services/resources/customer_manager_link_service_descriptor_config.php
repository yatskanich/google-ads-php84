    ...
    'interfaces' => [
        'google.ads.googleads.v21.services.CustomerManagerLinkService' => [
            'MoveManagerLink' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V21\Services\MoveManagerLinkResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
            ...
            'MutateCustomerManagerLink' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V21\Services\MutateCustomerManagerLinkResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
