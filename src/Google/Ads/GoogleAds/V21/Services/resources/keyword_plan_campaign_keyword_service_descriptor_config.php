...
return [
    'interfaces' => [
        'google.ads.googleads.v21.services.KeywordPlanCampaignKeywordService' => [
            'MutateKeywordPlanCampaignKeywords' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V21\Services\MutateKeywordPlanCampaignKeywordsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
