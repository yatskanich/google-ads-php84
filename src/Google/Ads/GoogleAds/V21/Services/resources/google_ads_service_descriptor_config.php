    ...
    'interfaces' => [
        'google.ads.googleads.v21.services.GoogleAdsService' => [
            'Mutate' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V21\Services\MutateGoogleAdsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
            ...
            'Search' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V21\Services\SearchGoogleAdsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
            ...
            'SearchStream' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V21\Services\SearchGoogleAdsStreamResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
