...
class GoogleAdsServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V21\Services\SearchGoogleAdsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V21\Services\SearchGoogleAdsResponse>
     */
    public function Search(\Google\Ads\GoogleAds\V21\Services\SearchGoogleAdsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.GoogleAdsService/Search',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\SearchGoogleAdsResponse::class, 'decode'],
        $metadata, $options);
    }
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V21\Services\SearchGoogleAdsStreamRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\ServerStreamingCall
     */
    public function SearchStream(\Google\Ads\GoogleAds\V21\Services\SearchGoogleAdsStreamRequest $argument,
      $metadata = [], $options = []) {
        return $this->_serverStreamRequest('/google.ads.googleads.v21.services.GoogleAdsService/SearchStream',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\SearchGoogleAdsStreamResponse::class, 'decode'],
        $metadata, $options);
    }
     ...
     * @param \Google\Ads\GoogleAds\V21\Services\MutateGoogleAdsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V21\Services\MutateGoogleAdsResponse>
     */
    public function Mutate(\Google\Ads\GoogleAds\V21\Services\MutateGoogleAdsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.GoogleAdsService/Mutate',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\MutateGoogleAdsResponse::class, 'decode'],
        $metadata, $options);
    }
