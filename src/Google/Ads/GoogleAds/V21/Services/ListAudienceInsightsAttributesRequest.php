 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.services.ListAudienceInsightsAttributesRequest</code>
 */
class ListAudienceInsightsAttributesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v21.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension dimensions = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $dimensions;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v21.common.LocationInfo location_country_filters = 5;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.common.LocationInfo youtube_reach_location = 6;</code>
     */
    protected $youtube_reach_location = null;

    /**
     * @param string $customerId Required. The ID of the customer.
     * @param int[]  $dimensions Required. The types of attributes to be returned. Supported
     *                           dimensions are CATEGORY, KNOWLEDGE_GRAPH, DEVICE,
     *                           GEO_TARGET_COUNTRY, SUB_COUNTRY_LOCATION, YOUTUBE_LINEUP,
     *                           AFFINITY_USER_INTEREST, IN_MARKET_USER_INTEREST, PARENTAL_STATUS,
     *                           INCOME_RANGE, AGE_RANGE, and GENDER.
     ...
     *                           returned.
     *
     * @return \Google\Ads\GoogleAds\V21\Services\ListAudienceInsightsAttributesRequest
     *
     * @experimental
     */
     ...
     *           Optional. Additional information on the application issuing the request.
     *     @type \Google\Ads\GoogleAds\V21\Common\LocationInfo[] $location_country_filters
     *           If SUB_COUNTRY_LOCATION attributes are one of the requested dimensions and
     *           this field is present, then the SUB_COUNTRY_LOCATION attributes returned
     *           will be located in these countries. If this field is absent, then location
     *           attributes are not filtered by country. Setting this field when
     *           SUB_COUNTRY_LOCATION attributes are not requested will return an error.
     *     @type \Google\Ads\GoogleAds\V21\Common\LocationInfo $youtube_reach_location
     *           If present, potential YouTube reach estimates within the specified market
     *           will be returned for attributes for which they are available.  Reach is
     *           only available for the AGE_RANGE, GENDER, AFFINITY_USER_INTEREST and
     *           IN_MARKET_USER_INTEREST dimensions, and may not be available for every
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v21.common.LocationInfo location_country_filters = 5;</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V21\Common\LocationInfo>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V21\Common\LocationInfo::class);
