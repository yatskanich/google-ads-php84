 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v21/services/ad_group_criterion_service.proto
 ...
 *
 * @method PromiseInterface<MutateAdGroupCriteriaResponse> mutateAdGroupCriteriaAsync(MutateAdGroupCriteriaRequest $request, array $optionalArgs = [])
 */
class AdGroupCriterionServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v21.services.AdGroupCriterionService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/ad_group_criterion_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/ad_group_criterion_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/ad_group_criterion_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/ad_group_criterion_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V21\Services\AdGroupCriterionServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AdGroupCriterionServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see AdGroupCriterionServiceClient::mutateAdGroupCriteriaAsync()} .
     *
     * @param MutateAdGroupCriteriaRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateAdGroupCriteriaResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAdGroupCriteria(MutateAdGroupCriteriaRequest $request, array $callOptions = []): MutateAdGroupCriteriaResponse
    {
        return $this->startApiCall('MutateAdGroupCriteria', $request, $callOptions)->wait();
    }
}
