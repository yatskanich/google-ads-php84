 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v21/services/campaign_budget_service.proto
 ...
 *
 * @method PromiseInterface<MutateCampaignBudgetsResponse> mutateCampaignBudgetsAsync(MutateCampaignBudgetsRequest $request, array $optionalArgs = [])
 */
class CampaignBudgetServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v21.services.CampaignBudgetService';
     ...
     *           use Google\Ads\GoogleAds\V21\Services\CampaignBudgetServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CampaignBudgetServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see CampaignBudgetServiceClient::mutateCampaignBudgetsAsync()} .
     *
     * @param MutateCampaignBudgetsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateCampaignBudgetsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCampaignBudgets(MutateCampaignBudgetsRequest $request, array $callOptions = []): MutateCampaignBudgetsResponse
    {
        return $this->startApiCall('MutateCampaignBudgets', $request, $callOptions)->wait();
    }
}
