...
class SharedSetServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringFormatError]()
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V21\Services\MutateSharedSetsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V21\Services\MutateSharedSetsResponse>
     */
    public function MutateSharedSets(\Google\Ads\GoogleAds\V21\Services\MutateSharedSetsRequest $argument,
      $metadata = [], $options = []) {
