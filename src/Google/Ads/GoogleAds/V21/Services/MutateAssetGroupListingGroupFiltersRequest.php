...
# source: google/ads/googleads/v21/services/asset_group_listing_group_filter_service.proto
...
/**
 * Request message for
 * [AssetGroupListingGroupFilterService.MutateAssetGroupListingGroupFilters][google.ads.googleads.v21.services.AssetGroupListingGroupFilterService.MutateAssetGroupListingGroupFilters].
 * partial_failure is not supported because the tree needs to be validated
 * together.
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.services.MutateAssetGroupListingGroupFiltersRequest</code>
 */
class MutateAssetGroupListingGroupFiltersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                                               are being modified.
     * @param \Google\Ads\GoogleAds\V21\Services\AssetGroupListingGroupFilterOperation[] $operations Required. The list of operations to perform on individual asset group
     *                                                                                               listing group filters.
     *
     * @return \Google\Ads\GoogleAds\V21\Services\MutateAssetGroupListingGroupFiltersRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V21\Services\AssetGroupListingGroupFilterService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V21\Services\AssetGroupListingGroupFilterOperation::class);
        $this->operations = $arr;
