...
class AdGroupCriterionServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringLengthError]()
     *   [UrlFieldError]()
     * @param \Google\Ads\GoogleAds\V21\Services\MutateAdGroupCriteriaRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V21\Services\MutateAdGroupCriteriaResponse>
     */
    public function MutateAdGroupCriteria(\Google\Ads\GoogleAds\V21\Services\MutateAdGroupCriteriaRequest $argument,
      $metadata = [], $options = []) {
