...
class BillingSetupServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V21\Services\MutateBillingSetupRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V21\Services\MutateBillingSetupResponse>
     */
    public function MutateBillingSetup(\Google\Ads\GoogleAds\V21\Services\MutateBillingSetupRequest $argument,
      $metadata = [], $options = []) {
