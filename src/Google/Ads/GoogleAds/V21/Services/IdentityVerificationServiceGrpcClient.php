...
class IdentityVerificationServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function StartIdentityVerification(\Google\Ads\GoogleAds\V21\Services\StartIdentityVerificationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.IdentityVerificationService/StartIdentityVerification',
        $argument,
    ...
    public function GetIdentityVerification(\Google\Ads\GoogleAds\V21\Services\GetIdentityVerificationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.IdentityVerificationService/GetIdentityVerification',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\GetIdentityVerificationResponse::class, 'decode'],
        $metadata, $options);
    }
