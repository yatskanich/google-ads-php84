...
class AdGroupBidModifierServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringFormatError]()
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V21\Services\MutateAdGroupBidModifiersRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V21\Services\MutateAdGroupBidModifiersResponse>
     */
    public function MutateAdGroupBidModifiers(\Google\Ads\GoogleAds\V21\Services\MutateAdGroupBidModifiersRequest $argument,
      $metadata = [], $options = []) {
