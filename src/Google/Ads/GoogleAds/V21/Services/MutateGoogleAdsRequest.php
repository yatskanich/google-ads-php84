 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.services.MutateGoogleAdsRequest</code>
 */
class MutateGoogleAdsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v21.services.MutateOperation mutate_operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Ads\GoogleAds\V21\Services\MutateOperation[] $mutateOperations Required. The list of operations to perform on individual resources.
     *
     * @return \Google\Ads\GoogleAds\V21\Services\MutateGoogleAdsRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V21\Services\GoogleAdsService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V21\Services\MutateOperation::class);
