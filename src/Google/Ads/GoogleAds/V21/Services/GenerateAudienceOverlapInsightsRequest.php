 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.services.GenerateAudienceOverlapInsightsRequest</code>
 */
class GenerateAudienceOverlapInsightsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * audiences.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.common.LocationInfo country_location = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.common.AudienceInsightsAttribute primary_attribute = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.common.AdditionalApplicationInfo insights_application_info = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $insights_application_info = null;

    /**
     * @param string                                                     $customerId       Required. The ID of the customer.
     * @param \Google\Ads\GoogleAds\V21\Common\LocationInfo              $countryLocation  Required. The country in which to calculate the sizes and overlaps of
     *                                                                                     audiences.
     * @param \Google\Ads\GoogleAds\V21\Common\AudienceInsightsAttribute $primaryAttribute Required. The audience attribute that should be intersected with all other
     *                                                                                     eligible audiences.  This must be an Affinity or In-Market UserInterest, an
     *                                                                                     AgeRange or a Gender.
     * @param int[]                                                      $dimensions       Required. The types of attributes of which to calculate the overlap with
     *                                                                                     the primary_attribute. The values must be a subset of
     *                                                                                     AFFINITY_USER_INTEREST, IN_MARKET_USER_INTEREST, AGE_RANGE and GENDER.
     *                                                                                     For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V21\Enums\AudienceInsightsDimensionEnum\AudienceInsightsDimension}
     *
     * @return \Google\Ads\GoogleAds\V21\Services\GenerateAudienceOverlapInsightsRequest
     *
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V21\Common\LocationInfo $countryLocation, \Google\Ads\GoogleAds\V21\Common\AudienceInsightsAttribute $primaryAttribute, array $dimensions): self
    {
        return new self()
     ...
     *           Required. The country in which to calculate the sizes and overlaps of
     *           audiences.
     *     @type \Google\Ads\GoogleAds\V21\Common\AudienceInsightsAttribute $primary_attribute
     *           Required. The audience attribute that should be intersected with all other
     *           eligible audiences.  This must be an Affinity or In-Market UserInterest, an
     *           AgeRange or a Gender.
     *     @type int[] $dimensions
     ...
     *           The name of the customer being planned for.  This is a user-defined value.
     *     @type \Google\Ads\GoogleAds\V21\Common\AdditionalApplicationInfo $insights_application_info
     *           Optional. Additional information on the application issuing the request.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V21\Services\AudienceInsightsService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V21\Enums\AudienceInsightsDimensionEnum\AudienceInsightsDimension::class);
        $this->dimensions = $arr;
