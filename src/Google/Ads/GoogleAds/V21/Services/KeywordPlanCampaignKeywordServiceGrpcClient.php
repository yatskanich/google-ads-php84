...
class KeywordPlanCampaignKeywordServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V21\Services\MutateKeywordPlanCampaignKeywordsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V21\Services\MutateKeywordPlanCampaignKeywordsResponse>
     */
    public function MutateKeywordPlanCampaignKeywords(\Google\Ads\GoogleAds\V21\Services\MutateKeywordPlanCampaignKeywordsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.KeywordPlanCampaignKeywordService/MutateKeywordPlanCampaignKeywords',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\MutateKeywordPlanCampaignKeywordsResponse::class, 'decode'],
        $metadata, $options);
    }
