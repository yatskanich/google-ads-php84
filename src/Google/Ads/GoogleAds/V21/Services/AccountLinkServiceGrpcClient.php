...
class AccountLinkServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function CreateAccountLink(\Google\Ads\GoogleAds\V21\Services\CreateAccountLinkRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.AccountLinkService/CreateAccountLink',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\CreateAccountLinkResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function MutateAccountLink(\Google\Ads\GoogleAds\V21\Services\MutateAccountLinkRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.AccountLinkService/MutateAccountLink',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\MutateAccountLinkResponse::class, 'decode'],
        $metadata, $options);
    }
