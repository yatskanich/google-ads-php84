...
class RecommendationSubscriptionServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateRecommendationSubscription(\Google\Ads\GoogleAds\V21\Services\MutateRecommendationSubscriptionRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.RecommendationSubscriptionService/MutateRecommendationSubscription',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\MutateRecommendationSubscriptionResponse::class, 'decode'],
        $metadata, $options);
    }
