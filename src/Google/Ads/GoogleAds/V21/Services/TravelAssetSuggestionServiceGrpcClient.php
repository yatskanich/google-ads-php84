...
class TravelAssetSuggestionServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function SuggestTravelAssets(\Google\Ads\GoogleAds\V21\Services\SuggestTravelAssetsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.TravelAssetSuggestionService/SuggestTravelAssets',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\SuggestTravelAssetsResponse::class, 'decode'],
        $metadata, $options);
    }
