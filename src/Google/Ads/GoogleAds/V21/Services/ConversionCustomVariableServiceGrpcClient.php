...
class ConversionCustomVariableServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateConversionCustomVariables(\Google\Ads\GoogleAds\V21\Services\MutateConversionCustomVariablesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.ConversionCustomVariableService/MutateConversionCustomVariables',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\MutateConversionCustomVariablesResponse::class, 'decode'],
        $metadata, $options);
    }
