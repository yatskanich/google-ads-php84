...
/**
 * Request message for
 * [LabelService.MutateLabels][google.ads.googleads.v21.services.LabelService.MutateLabels].
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.services.MutateLabelsRequest</code>
 */
class MutateLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Ads\GoogleAds\V21\Services\LabelOperation[] $operations Required. The list of operations to perform on labels.
     *
     * @return \Google\Ads\GoogleAds\V21\Services\MutateLabelsRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V21\Services\LabelService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V21\Services\LabelOperation::class);
        $this->operations = $arr;
