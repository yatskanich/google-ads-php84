...
class AdGroupCriterionLabelServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateAdGroupCriterionLabels(\Google\Ads\GoogleAds\V21\Services\MutateAdGroupCriterionLabelsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.AdGroupCriterionLabelService/MutateAdGroupCriterionLabels',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\MutateAdGroupCriterionLabelsResponse::class, 'decode'],
        $metadata, $options);
    }
