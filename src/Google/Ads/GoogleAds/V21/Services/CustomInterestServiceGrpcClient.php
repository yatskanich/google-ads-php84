...
class CustomInterestServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [RequestError]()
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V21\Services\MutateCustomInterestsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V21\Services\MutateCustomInterestsResponse>
     */
    public function MutateCustomInterests(\Google\Ads\GoogleAds\V21\Services\MutateCustomInterestsRequest $argument,
      $metadata = [], $options = []) {
