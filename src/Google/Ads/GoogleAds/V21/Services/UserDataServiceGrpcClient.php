...
class UserDataServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [RequestError]()
     *   [UserDataError]()
     * @param \Google\Ads\GoogleAds\V21\Services\UploadUserDataRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V21\Services\UploadUserDataResponse>
     */
    public function UploadUserData(\Google\Ads\GoogleAds\V21\Services\UploadUserDataRequest $argument,
      $metadata = [], $options = []) {
