...
class KeywordPlanAdGroupServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateKeywordPlanAdGroups(\Google\Ads\GoogleAds\V21\Services\MutateKeywordPlanAdGroupsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\MutateKeywordPlanAdGroupsResponse::class, 'decode'],
        $metadata, $options);
    }
