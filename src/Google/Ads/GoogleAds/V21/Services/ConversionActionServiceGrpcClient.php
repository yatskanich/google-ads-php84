...
class ConversionActionServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateConversionActions(\Google\Ads\GoogleAds\V21\Services\MutateConversionActionsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v21.services.ConversionActionService/MutateConversionActions',
        $argument,
        [\Google\Ads\GoogleAds\V21\Services\MutateConversionActionsResponse::class, 'decode'],
        $metadata, $options);
    }
