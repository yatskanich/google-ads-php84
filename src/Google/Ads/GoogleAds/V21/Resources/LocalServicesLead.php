...
# source: google/ads/googleads/v21/resources/local_services_lead.proto
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.resources.LocalServicesLead</code>
 */
class LocalServicesLead extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.resources.ContactDetails contact_details = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $contact_details = null;
    /**
     * Output only. Type of Local Services lead: phone, message, booking, etc.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.enums.LocalServicesLeadTypeEnum.LeadType lead_type = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $lead_type = 0;
    /**
     * Output only. Current status of lead.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.enums.LocalServicesLeadStatusEnum.LeadStatus lead_status = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v21.resources.Note note = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $note = null;
    /**
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v21.resources.CreditDetails credit_details = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           `seller_agent` for the category of
     *           `xcat:service_area_business_real_estate_agent`.
     *     @type \Google\Ads\GoogleAds\V21\Resources\ContactDetails $contact_details
     *           Output only. Lead's contact details.
     *     @type int $lead_type
     *           Output only. Type of Local Services lead: phone, message, booking, etc.
     ...
     *           Output only. Language used by the Local Services provider linked to lead.
     *           See https://developers.google.com/google-ads/api/data/codes-formats#locales
     *     @type \Google\Ads\GoogleAds\V21\Resources\Note $note
     *           Output only. Note added by advertiser for the lead.
     *     @type bool $lead_charged
     *           Output only. True if the advertiser was charged for the lead.
     *     @type \Google\Ads\GoogleAds\V21\Resources\CreditDetails $credit_details
     *           Output only. Credit details of the lead.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V21\Resources\LocalServicesLead::initOnce();
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.resources.ContactDetails contact_details = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V21\Resources\ContactDetails|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.resources.ContactDetails contact_details = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V21\Resources\ContactDetails $var
     * @return $this
     */
    public function setContactDetails($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V21\Resources\ContactDetails::class);
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v21.resources.Note note = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V21\Resources\Note|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v21.resources.Note note = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V21\Resources\Note $var
     * @return $this
     */
    public function setNote($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V21\Resources\Note::class);
        $this->note = $var;
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v21.resources.CreditDetails credit_details = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V21\Resources\CreditDetails|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v21.resources.CreditDetails credit_details = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V21\Resources\CreditDetails $var
     * @return $this
     */
    public function setCreditDetails($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V21\Resources\CreditDetails::class);
