...
# source: google/ads/googleads/v21/resources/android_privacy_shared_key_google_network_type.proto
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.resources.AndroidPrivacySharedKeyGoogleNetworkType</code>
 */
class AndroidPrivacySharedKeyGoogleNetworkType extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.enums.AndroidPrivacyInteractionTypeEnum.AndroidPrivacyInteractionType android_privacy_interaction_type = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.enums.AndroidPrivacyNetworkTypeEnum.AndroidPrivacyNetworkType android_privacy_network_type = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>string shared_network_type_key = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $shared_network_type_key = '';
     ...
     *           Output only. The network type enum used in the share key encoding.
     *     @type string $shared_network_type_key
     *           Output only. 128 bit hex string of the encoded shared network type key,
     *           including a '0x' prefix. This key can be used to do a bitwise OR operator
     *           with the aggregate conversion key to create a full aggregation key to
     *           retrieve the Aggregate API Report in Android Privacy Sandbox.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V21\Resources\AndroidPrivacySharedKeyGoogleNetworkType::initOnce();
     ...
     * @return string
     */
    public function getSharedNetworkTypeKey()
    {
        return $this->shared_network_type_key;
    }
     ...
     * @return $this
     */
    public function setSharedNetworkTypeKey($var)
    {
        GPBUtil::checkString($var, True);
        $this->shared_network_type_key = $var;
