 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.resources.Invoice</code>
 */
class Invoice extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.enums.InvoiceTypeEnum.InvoiceType type = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $type = 0;
    /**
     ...
     * inclusive.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.common.DateRange service_date_range = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The due date in yyyy-mm-dd format.
     *     @type \Google\Ads\GoogleAds\V21\Common\DateRange $service_date_range
     *           Output only. The service period date range of this invoice. The end date is
     *           inclusive.
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V21\Resources\Invoice\AccountBudgetSummary::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V21\Resources\Invoice\AccountSummary::class);
