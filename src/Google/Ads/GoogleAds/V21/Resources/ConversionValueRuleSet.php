...
# source: google/ads/googleads/v21/resources/conversion_value_rule_set.proto
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.resources.ConversionValueRuleSet</code>
 */
class ConversionValueRuleSet extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v21.enums.ValueRuleSetDimensionEnum.ValueRuleSetDimension dimensions = 4;</code>
     */
    private $dimensions;
    /**
     ...
     * attached.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.enums.ValueRuleSetAttachmentTypeEnum.ValueRuleSetAttachmentType attachment_type = 6 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
     ...
     * ** Read-only **
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.enums.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus status = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     ...
     * set.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v21.enums.ConversionActionCategoryEnum.ConversionActionCategory conversion_action_categories = 9 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
     ...
     *     @type int|string $id
     *           Output only. The ID of the conversion value rule set.
     *     @type string[] $conversion_value_rules
     *           Resource names of rules within the rule set.
     *     @type int[] $dimensions
     *           Defines dimensions for Value Rule conditions. The condition types of value
     *           rules within this value rule set must be of these dimensions. The first
     ...
     *           Output only. The status of the conversion value rule set.
     *           ** Read-only **
     *     @type int[] $conversion_action_categories
     *           Immutable. The conversion action categories of the conversion value rule
     *           set.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V21\Resources\ConversionValueRuleSet::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V21\Enums\ValueRuleSetDimensionEnum\ValueRuleSetDimension::class);
        $this->dimensions = $arr;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V21\Enums\ConversionActionCategoryEnum\ConversionActionCategory::class);
