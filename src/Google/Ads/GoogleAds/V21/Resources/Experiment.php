...
# source: google/ads/googleads/v21/resources/experiment.proto
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v21.resources.Experiment</code>
 */
class Experiment extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.enums.ExperimentTypeEnum.ExperimentType type = 13 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $type = 0;
    /**
     * The Advertiser-chosen status of this experiment.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.enums.ExperimentStatusEnum.ExperimentStatus status = 14;</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v21.enums.AsyncActionStatusEnum.AsyncActionStatus promote_status = 19 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V21\Resources\Experiment::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V21\Common\MetricGoal::class);
        $this->goals = $arr;
