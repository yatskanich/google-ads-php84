 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.resources.Invoice.AccountSummary</code>
 */
class AccountSummary extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Resources\Invoice\RegulatoryCostSummary::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Resources\Invoice\AdjustmentSummary::class);
