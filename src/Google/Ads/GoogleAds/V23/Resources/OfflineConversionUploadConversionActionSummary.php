 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.resources.OfflineConversionUploadConversionActionSummary</code>
 */
class OfflineConversionUploadConversionActionSummary extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.enums.OfflineEventUploadClientEnum.OfflineEventUploadClient client = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $client = 0;
    /**
     ...
     * stats.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.enums.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus status = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.resources.OfflineConversionSummary daily_summaries = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $daily_summaries;
    /**
     * Output only. Summary of history stats by last N jobs.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.resources.OfflineConversionSummary job_summaries = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.resources.OfflineConversionAlert alerts = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $alerts;
     ...
     *           Output only. Date for the latest upload batch. The format is "yyyy-mm-dd
     *           hh:mm:ss", and it's in the time zone of the Google Ads account.
     *     @type \Google\Ads\GoogleAds\V23\Resources\OfflineConversionSummary[] $daily_summaries
     *           Output only. Summary of history stats by last N days.
     *     @type \Google\Ads\GoogleAds\V23\Resources\OfflineConversionSummary[] $job_summaries
     *           Output only. Summary of history stats by last N jobs.
     *     @type \Google\Ads\GoogleAds\V23\Resources\OfflineConversionAlert[] $alerts
     *           Output only. Details for each error code. Alerts are generated from most
     *           recent calendar day with upload stats.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V23\Resources\OfflineConversionUploadConversionActionSummary::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.resources.OfflineConversionSummary daily_summaries = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V23\Resources\OfflineConversionSummary>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.resources.OfflineConversionSummary daily_summaries = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V23\Resources\OfflineConversionSummary[] $var
     * @return $this
     */
    public function setDailySummaries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Resources\OfflineConversionSummary::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.resources.OfflineConversionAlert alerts = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V23\Resources\OfflineConversionAlert>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.resources.OfflineConversionAlert alerts = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V23\Resources\OfflineConversionAlert[] $var
     * @return $this
     */
    public function setAlerts($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Resources\OfflineConversionAlert::class);
        $this->alerts = $arr;
