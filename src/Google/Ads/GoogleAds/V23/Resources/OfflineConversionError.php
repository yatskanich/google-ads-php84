 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.resources.OfflineConversionError</code>
 */
class OfflineConversionError extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V23\Resources\OfflineConversionUploadClientSummary::initOnce();
     ...
     * Output only. Collection size error.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.errors.CollectionSizeErrorEnum.CollectionSizeError collection_size_error = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
     ...
     * Output only. Conversion adjustment upload error.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.errors.ConversionAdjustmentUploadErrorEnum.ConversionAdjustmentUploadError conversion_adjustment_upload_error = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
     ...
     * Output only. Conversion upload error.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.errors.ConversionUploadErrorEnum.ConversionUploadError conversion_upload_error = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
     ...
     * Output only. Date error.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.errors.DateErrorEnum.DateError date_error = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
     ...
     * Output only. Distinct error.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.errors.DistinctErrorEnum.DistinctError distinct_error = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
     ...
     * Output only. Field error.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.errors.FieldErrorEnum.FieldError field_error = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
     ...
     * Output only. Mutate error.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.errors.MutateErrorEnum.MutateError mutate_error = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
     ...
     * Output only. Not allowlisted error.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.errors.NotAllowlistedErrorEnum.NotAllowlistedError not_allowlisted_error = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
     ...
     * Output only. String format error.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.errors.StringFormatErrorEnum.StringFormatError string_format_error = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
     ...
     * Output only. String length error.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.errors.StringLengthErrorEnum.StringLengthError string_length_error = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return int
     */
