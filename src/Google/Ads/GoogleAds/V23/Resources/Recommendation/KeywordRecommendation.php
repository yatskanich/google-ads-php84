 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.resources.Recommendation.KeywordRecommendation</code>
 */
class KeywordRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.common.KeywordInfo keyword = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.resources.Recommendation.KeywordRecommendation.SearchTerm search_terms = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The recommended keyword.
     *     @type \Google\Ads\GoogleAds\V23\Resources\Recommendation\KeywordRecommendation\SearchTerm[] $search_terms
     *           Output only. A list of search terms this keyword matches. The same search
     *           term may be repeated for multiple keywords.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.resources.Recommendation.KeywordRecommendation.SearchTerm search_terms = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V23\Resources\Recommendation\KeywordRecommendation\SearchTerm>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.resources.Recommendation.KeywordRecommendation.SearchTerm search_terms = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V23\Resources\Recommendation\KeywordRecommendation\SearchTerm[] $var
     * @return $this
     */
    public function setSearchTerms($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Resources\Recommendation\KeywordRecommendation\SearchTerm::class);
