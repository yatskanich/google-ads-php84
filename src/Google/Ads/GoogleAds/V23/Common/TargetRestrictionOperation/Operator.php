...
namespace Google\Ads\GoogleAds\V23\Common\TargetRestrictionOperation;
 ...
 * The operator.
 *
 * Protobuf type <code>google.ads.googleads.v23.common.TargetRestrictionOperation.Operator</code>
 */
class Operator
{
    /**
