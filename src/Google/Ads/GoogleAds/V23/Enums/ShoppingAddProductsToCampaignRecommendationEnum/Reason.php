...
namespace Google\Ads\GoogleAds\V23\Enums\ShoppingAddProductsToCampaignRecommendationEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v23.enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason</code>
 */
class Reason
{
    /**
