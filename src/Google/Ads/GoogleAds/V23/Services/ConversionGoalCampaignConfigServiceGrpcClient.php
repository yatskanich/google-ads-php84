...
class ConversionGoalCampaignConfigServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateConversionGoalCampaignConfigs(\Google\Ads\GoogleAds\V23\Services\MutateConversionGoalCampaignConfigsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.ConversionGoalCampaignConfigService/MutateConversionGoalCampaignConfigs',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\MutateConversionGoalCampaignConfigsResponse::class, 'decode'],
        $metadata, $options);
    }
