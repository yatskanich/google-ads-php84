...
class RemarketingActionServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateRemarketingActions(\Google\Ads\GoogleAds\V23\Services\MutateRemarketingActionsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.RemarketingActionService/MutateRemarketingActions',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\MutateRemarketingActionsResponse::class, 'decode'],
        $metadata, $options);
    }
