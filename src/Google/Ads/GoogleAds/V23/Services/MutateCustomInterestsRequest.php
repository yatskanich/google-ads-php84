 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.services.MutateCustomInterestsRequest</code>
 */
class MutateCustomInterestsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Ads\GoogleAds\V23\Services\CustomInterestOperation[] $operations Required. The list of operations to perform on individual custom interests.
     *
     * @return \Google\Ads\GoogleAds\V23\Services\MutateCustomInterestsRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V23\Services\CustomInterestService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Services\CustomInterestOperation::class);
        $this->operations = $arr;
