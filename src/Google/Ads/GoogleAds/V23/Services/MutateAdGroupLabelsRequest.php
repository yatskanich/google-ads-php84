...
/**
 * Request message for
 * [AdGroupLabelService.MutateAdGroupLabels][google.ads.googleads.v23.services.AdGroupLabelService.MutateAdGroupLabels].
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.services.MutateAdGroupLabelsRequest</code>
 */
class MutateAdGroupLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Ads\GoogleAds\V23\Services\AdGroupLabelOperation[] $operations Required. The list of operations to perform on ad group labels.
     *
     * @return \Google\Ads\GoogleAds\V23\Services\MutateAdGroupLabelsRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V23\Services\AdGroupLabelService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Services\AdGroupLabelOperation::class);
        $this->operations = $arr;
