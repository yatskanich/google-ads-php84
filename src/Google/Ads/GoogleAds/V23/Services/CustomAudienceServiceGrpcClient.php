...
class CustomAudienceServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateCustomAudiences(\Google\Ads\GoogleAds\V23\Services\MutateCustomAudiencesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.CustomAudienceService/MutateCustomAudiences',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\MutateCustomAudiencesResponse::class, 'decode'],
        $metadata, $options);
    }
