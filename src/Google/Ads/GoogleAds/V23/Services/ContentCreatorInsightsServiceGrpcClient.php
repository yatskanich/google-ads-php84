...
class ContentCreatorInsightsServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GenerateCreatorInsights(\Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.ContentCreatorInsightsService/GenerateCreatorInsights',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function GenerateTrendingInsights(\Google\Ads\GoogleAds\V23\Services\GenerateTrendingInsightsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.ContentCreatorInsightsService/GenerateTrendingInsights',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\GenerateTrendingInsightsResponse::class, 'decode'],
        $metadata, $options);
    }
