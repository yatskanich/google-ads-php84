...
class AdGroupAdServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateAdGroupAds(\Google\Ads\GoogleAds\V23\Services\MutateAdGroupAdsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.AdGroupAdService/MutateAdGroupAds',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\MutateAdGroupAdsResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function RemoveAutomaticallyCreatedAssets(\Google\Ads\GoogleAds\V23\Services\RemoveAutomaticallyCreatedAssetsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.AdGroupAdService/RemoveAutomaticallyCreatedAssets',
        $argument,
