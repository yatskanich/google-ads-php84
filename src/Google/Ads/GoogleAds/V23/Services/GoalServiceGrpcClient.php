...
class GoalServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateGoals(\Google\Ads\GoogleAds\V23\Services\MutateGoalsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.GoalService/MutateGoals',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\MutateGoalsResponse::class, 'decode'],
        $metadata, $options);
    }
