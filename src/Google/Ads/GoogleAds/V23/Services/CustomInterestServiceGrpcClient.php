...
class CustomInterestServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateCustomInterests(\Google\Ads\GoogleAds\V23\Services\MutateCustomInterestsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.CustomInterestService/MutateCustomInterests',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\MutateCustomInterestsResponse::class, 'decode'],
        $metadata, $options);
    }
