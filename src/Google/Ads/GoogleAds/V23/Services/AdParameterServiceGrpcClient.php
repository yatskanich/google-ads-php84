...
class AdParameterServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateAdParameters(\Google\Ads\GoogleAds\V23\Services\MutateAdParametersRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.AdParameterService/MutateAdParameters',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\MutateAdParametersResponse::class, 'decode'],
        $metadata, $options);
    }
