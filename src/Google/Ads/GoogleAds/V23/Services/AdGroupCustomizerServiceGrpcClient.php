...
class AdGroupCustomizerServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateAdGroupCustomizers(\Google\Ads\GoogleAds\V23\Services\MutateAdGroupCustomizersRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.AdGroupCustomizerService/MutateAdGroupCustomizers',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\MutateAdGroupCustomizersResponse::class, 'decode'],
        $metadata, $options);
    }
