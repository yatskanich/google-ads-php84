...
class YouTubeVideoUploadServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function CreateYouTubeVideoUpload(\Google\Ads\GoogleAds\V23\Services\CreateYouTubeVideoUploadRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.YouTubeVideoUploadService/CreateYouTubeVideoUpload',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\CreateYouTubeVideoUploadResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function UpdateYouTubeVideoUpload(\Google\Ads\GoogleAds\V23\Services\UpdateYouTubeVideoUploadRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.YouTubeVideoUploadService/UpdateYouTubeVideoUpload',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\UpdateYouTubeVideoUploadResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function RemoveYouTubeVideoUpload(\Google\Ads\GoogleAds\V23\Services\RemoveYouTubeVideoUploadRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.YouTubeVideoUploadService/RemoveYouTubeVideoUpload',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\RemoveYouTubeVideoUploadResponse::class, 'decode'],
        $metadata, $options);
    }
