    ...
    'interfaces' => [
        'google.ads.googleads.v23.services.GoogleAdsService' => [
            'Mutate' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V23\Services\MutateGoogleAdsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
            ...
            'Search' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V23\Services\SearchGoogleAdsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
            ...
            'SearchStream' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V23\Services\SearchGoogleAdsStreamResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
