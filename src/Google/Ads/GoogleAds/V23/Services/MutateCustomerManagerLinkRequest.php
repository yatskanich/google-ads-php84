...
/**
 * Request message for
 * [CustomerManagerLinkService.MutateCustomerManagerLink][google.ads.googleads.v23.services.CustomerManagerLinkService.MutateCustomerManagerLink].
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.services.MutateCustomerManagerLinkRequest</code>
 */
class MutateCustomerManagerLinkRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                                      modified.
     * @param \Google\Ads\GoogleAds\V23\Services\CustomerManagerLinkOperation[] $operations Required. The list of operations to perform on individual customer manager
     *                                                                                      links.
     *
     * @return \Google\Ads\GoogleAds\V23\Services\MutateCustomerManagerLinkRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V23\Services\CustomerManagerLinkService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Services\CustomerManagerLinkOperation::class);
        $this->operations = $arr;
