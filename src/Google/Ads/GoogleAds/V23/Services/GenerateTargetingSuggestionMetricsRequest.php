 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.services.GenerateTargetingSuggestionMetricsRequest</code>
 */
class GenerateTargetingSuggestionMetricsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.services.InsightsAudience audiences = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $audiences;
    /**
     ...
     * @param \Google\Ads\GoogleAds\V23\Services\InsightsAudience[] $audiences  Required. Audiences to request metrics for.
     *
     * @return \Google\Ads\GoogleAds\V23\Services\GenerateTargetingSuggestionMetricsRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer.
     *     @type \Google\Ads\GoogleAds\V23\Services\InsightsAudience[] $audiences
     *           Required. Audiences to request metrics for.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.services.InsightsAudience audiences = 5 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V23\Services\InsightsAudience>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Services\InsightsAudience::class);
        $this->audiences = $arr;
