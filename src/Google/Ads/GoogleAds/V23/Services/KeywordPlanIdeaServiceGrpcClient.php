...
class KeywordPlanIdeaServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GenerateKeywordIdeas(\Google\Ads\GoogleAds\V23\Services\GenerateKeywordIdeasRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.KeywordPlanIdeaService/GenerateKeywordIdeas',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\GenerateKeywordIdeaResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function GenerateKeywordHistoricalMetrics(\Google\Ads\GoogleAds\V23\Services\GenerateKeywordHistoricalMetricsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.KeywordPlanIdeaService/GenerateKeywordHistoricalMetrics',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\GenerateKeywordHistoricalMetricsResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function GenerateAdGroupThemes(\Google\Ads\GoogleAds\V23\Services\GenerateAdGroupThemesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.KeywordPlanIdeaService/GenerateAdGroupThemes',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\GenerateAdGroupThemesResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function GenerateKeywordForecastMetrics(\Google\Ads\GoogleAds\V23\Services\GenerateKeywordForecastMetricsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.KeywordPlanIdeaService/GenerateKeywordForecastMetrics',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\GenerateKeywordForecastMetricsResponse::class, 'decode'],
        $metadata, $options);
    }
