...
class AssetSetServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateAssetSets(\Google\Ads\GoogleAds\V23\Services\MutateAssetSetsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.AssetSetService/MutateAssetSets',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\MutateAssetSetsResponse::class, 'decode'],
        $metadata, $options);
    }
