...
class ConversionUploadServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function UploadClickConversions(\Google\Ads\GoogleAds\V23\Services\UploadClickConversionsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.ConversionUploadService/UploadClickConversions',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\UploadClickConversionsResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function UploadCallConversions(\Google\Ads\GoogleAds\V23\Services\UploadCallConversionsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.ConversionUploadService/UploadCallConversions',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\UploadCallConversionsResponse::class, 'decode'],
        $metadata, $options);
    }
