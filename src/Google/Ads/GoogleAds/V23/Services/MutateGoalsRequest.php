 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.services.MutateGoalsRequest</code>
 */
class MutateGoalsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Ads\GoogleAds\V23\Services\GoalOperation[] $operations Required. The list of operations to perform on the goals.
     *
     * @return \Google\Ads\GoogleAds\V23\Services\MutateGoalsRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V23\Services\GoalService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Services\GoalOperation::class);
        $this->operations = $arr;
