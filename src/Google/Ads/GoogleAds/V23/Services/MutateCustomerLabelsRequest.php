...
class MutateCustomerLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * relationships.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.services.CustomerLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *                                                                                modified.
     * @param \Google\Ads\GoogleAds\V23\Services\CustomerLabelOperation[] $operations Required. The list of operations to perform on customer-label
     *                                                                                relationships.
     *
     * @return \Google\Ads\GoogleAds\V23\Services\MutateCustomerLabelsRequest
     *
     * @experimental
     */
     ...
     *           Required. ID of the customer whose customer-label relationships are being
     *           modified.
     *     @type \Google\Ads\GoogleAds\V23\Services\CustomerLabelOperation[] $operations
     *           Required. The list of operations to perform on customer-label
     *           relationships.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V23\Services\CustomerLabelService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.services.CustomerLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V23\Services\CustomerLabelOperation>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.services.CustomerLabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V23\Services\CustomerLabelOperation[] $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Services\CustomerLabelOperation::class);
        $this->operations = $arr;
