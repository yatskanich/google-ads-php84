 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.services.Targeting</code>
 */
class Targeting extends \Google\Protobuf\Internal\Message
{
     ...
     * obtained from
     * [ReachPlanService.ListPlannableLocations][google.ads.googleads.v23.services.ReachPlanService.ListPlannableLocations].
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange age_range = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.common.GenderInfo genders = 3;</code>
     */
    private $genders;
    /**
     * Targeted devices.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.common.DeviceInfo devices = 4;</code>
     */
    private $devices;
    /**
     ...
     * [ReachPlanService.ListPlannableProducts][google.ads.googleads.v23.services.ReachPlanService.ListPlannableProducts].
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.enums.ReachPlanNetworkEnum.ReachPlanNetwork network = 5;</code>
     */
    protected $network = 0;
    /**
     * Targeted audiences.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.services.AudienceTargeting audience_targeting = 7;</code>
     */
     ...
     *           Targeted age range.
     *           An unset value is equivalent to targeting all ages.
     *     @type \Google\Ads\GoogleAds\V23\Common\GenderInfo[] $genders
     *           Targeted genders.
     *           An unset value is equivalent to targeting MALE and FEMALE.
     *     @type \Google\Ads\GoogleAds\V23\Common\DeviceInfo[] $devices
     *           Targeted devices.
     *           If not specified, targets all applicable devices. Applicable devices vary
     *           by product and region and can be obtained from
     *           [ReachPlanService.ListPlannableProducts][google.ads.googleads.v23.services.ReachPlanService.ListPlannableProducts].
     ...
     *           by product and region and can be obtained from
     *           [ReachPlanService.ListPlannableProducts][google.ads.googleads.v23.services.ReachPlanService.ListPlannableProducts].
     *     @type \Google\Ads\GoogleAds\V23\Services\AudienceTargeting $audience_targeting
     *           Targeted audiences.
     *           If not specified, does not target any specific audience.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.common.GenderInfo genders = 3;</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V23\Common\GenderInfo>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Common\GenderInfo::class);
        $this->genders = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.common.DeviceInfo devices = 4;</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V23\Common\DeviceInfo>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Common\DeviceInfo::class);
        $this->devices = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.services.AudienceTargeting audience_targeting = 7;</code>
     * @return \Google\Ads\GoogleAds\V23\Services\AudienceTargeting|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.services.AudienceTargeting audience_targeting = 7;</code>
     * @param \Google\Ads\GoogleAds\V23\Services\AudienceTargeting $var
     * @return $this
     */
    public function setAudienceTargeting($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V23\Services\AudienceTargeting::class);
