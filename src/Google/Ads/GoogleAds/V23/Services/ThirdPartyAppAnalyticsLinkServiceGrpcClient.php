...
class ThirdPartyAppAnalyticsLinkServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V23\Services\RegenerateShareableLinkIdRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V23\Services\RegenerateShareableLinkIdResponse>
     */
    public function RegenerateShareableLinkId(\Google\Ads\GoogleAds\V23\Services\RegenerateShareableLinkIdRequest $argument,
      $metadata = [], $options = []) {
