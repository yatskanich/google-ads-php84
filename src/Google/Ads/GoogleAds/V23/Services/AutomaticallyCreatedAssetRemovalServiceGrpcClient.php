...
class AutomaticallyCreatedAssetRemovalServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function RemoveCampaignAutomaticallyCreatedAsset(\Google\Ads\GoogleAds\V23\Services\RemoveCampaignAutomaticallyCreatedAssetRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.AutomaticallyCreatedAssetRemovalService/RemoveCampaignAutomaticallyCreatedAsset',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\RemoveCampaignAutomaticallyCreatedAssetResponse::class, 'decode'],
        $metadata, $options);
    }
