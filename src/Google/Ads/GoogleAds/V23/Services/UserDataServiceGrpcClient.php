...
class UserDataServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [RequestError]()
     *   [UserDataError]()
     * @param \Google\Ads\GoogleAds\V23\Services\UploadUserDataRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V23\Services\UploadUserDataResponse>
     */
    public function UploadUserData(\Google\Ads\GoogleAds\V23\Services\UploadUserDataRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.UserDataService/UploadUserData',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\UploadUserDataResponse::class, 'decode'],
        $metadata, $options);
    }
