 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.services.AppendLeadConversationRequest</code>
 */
class AppendLeadConversationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                         conversations will be appended.
     * @param \Google\Ads\GoogleAds\V23\Services\Conversation[] $conversations Required. Conversations that are being appended.
     *
     * @return \Google\Ads\GoogleAds\V23\Services\AppendLeadConversationRequest
     *
     * @experimental
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Services\Conversation::class);
