...
class AccountLinkServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V23\Services\CreateAccountLinkRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V23\Services\CreateAccountLinkResponse>
     */
    public function CreateAccountLink(\Google\Ads\GoogleAds\V23\Services\CreateAccountLinkRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V23\Services\MutateAccountLinkRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V23\Services\MutateAccountLinkResponse>
     */
    public function MutateAccountLink(\Google\Ads\GoogleAds\V23\Services\MutateAccountLinkRequest $argument,
      $metadata = [], $options = []) {
