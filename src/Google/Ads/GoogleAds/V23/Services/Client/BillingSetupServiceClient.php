 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/billing_setup_service.proto
 ...
 *
 * @method PromiseInterface<MutateBillingSetupResponse> mutateBillingSetupAsync(MutateBillingSetupRequest $request, array $optionalArgs = [])
 */
class BillingSetupServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.BillingSetupService';
     ...
     */
    public static function paymentsAccountName(string $customerId, string $paymentsAccountId): string
    {
        return self::getPathTemplate('paymentsAccount')->render([
            'customer_id' => $customerId,
     ...
     *           use Google\Ads\GoogleAds\V23\Services\BillingSetupServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new BillingSetupServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * [RequestError]()
     *
     * The async variant is {@see BillingSetupServiceClient::mutateBillingSetupAsync()}
     * .
     *
     * @param MutateBillingSetupRequest $request     A request to house fields associated with the call.
     ...
     */
    public function mutateBillingSetup(MutateBillingSetupRequest $request, array $callOptions = []): MutateBillingSetupResponse
    {
        return $this->startApiCall('MutateBillingSetup', $request, $callOptions)->wait();
    }
}
