 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/keyword_plan_service.proto
 ...
 *
 * @method PromiseInterface<MutateKeywordPlansResponse> mutateKeywordPlansAsync(MutateKeywordPlansRequest $request, array $optionalArgs = [])
 */
class KeywordPlanServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.KeywordPlanService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\KeywordPlanServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new KeywordPlanServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateKeywordPlansResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateKeywordPlans(MutateKeywordPlansRequest $request, array $callOptions = []): MutateKeywordPlansResponse
    {
        return $this->startApiCall('MutateKeywordPlans', $request, $callOptions)->wait();
    }
}
