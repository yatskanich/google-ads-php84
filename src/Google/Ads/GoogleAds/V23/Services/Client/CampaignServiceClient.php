 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/campaign_service.proto
...
class CampaignServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.CampaignService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\CampaignServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CampaignServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
