 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/ad_group_service.proto
 ...
 *
 * @method PromiseInterface<MutateAdGroupsResponse> mutateAdGroupsAsync(MutateAdGroupsRequest $request, array $optionalArgs = [])
 */
class AdGroupServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AdGroupService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AdGroupServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AdGroupServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * [UrlFieldError]()
     *
     * The async variant is {@see AdGroupServiceClient::mutateAdGroupsAsync()} .
     *
     * @param MutateAdGroupsRequest $request     A request to house fields associated with the call.
     ...
     */
    public function mutateAdGroups(MutateAdGroupsRequest $request, array $callOptions = []): MutateAdGroupsResponse
    {
        return $this->startApiCall('MutateAdGroups', $request, $callOptions)->wait();
    }
}
