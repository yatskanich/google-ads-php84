 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/ad_group_asset_service.proto
 ...
 *
 * @method PromiseInterface<MutateAdGroupAssetsResponse> mutateAdGroupAssetsAsync(MutateAdGroupAssetsRequest $request, array $optionalArgs = [])
 */
class AdGroupAssetServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AdGroupAssetService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/ad_group_asset_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/ad_group_asset_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/ad_group_asset_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/ad_group_asset_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AdGroupAssetServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AdGroupAssetServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see AdGroupAssetServiceClient::mutateAdGroupAssetsAsync()} .
     *
     * @param MutateAdGroupAssetsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateAdGroupAssetsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAdGroupAssets(MutateAdGroupAssetsRequest $request, array $callOptions = []): MutateAdGroupAssetsResponse
    {
        return $this->startApiCall('MutateAdGroupAssets', $request, $callOptions)->wait();
    }
}
