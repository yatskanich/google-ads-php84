 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/content_creator_insights_service.proto
 ...
 * @method PromiseInterface<GenerateTrendingInsightsResponse> generateTrendingInsightsAsync(GenerateTrendingInsightsRequest $request, array $optionalArgs = [])
 */
class ContentCreatorInsightsServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.ContentCreatorInsightsService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/content_creator_insights_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\ContentCreatorInsightsServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ContentCreatorInsightsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function generateCreatorInsights(GenerateCreatorInsightsRequest $request, array $callOptions = []): GenerateCreatorInsightsResponse
    {
        return $this->startApiCall('GenerateCreatorInsights', $request, $callOptions)->wait();
    }
     ...
     * }
     *
     * @return GenerateTrendingInsightsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function generateTrendingInsights(GenerateTrendingInsightsRequest $request, array $callOptions = []): GenerateTrendingInsightsResponse
    {
        return $this->startApiCall('GenerateTrendingInsights', $request, $callOptions)->wait();
    }
}
