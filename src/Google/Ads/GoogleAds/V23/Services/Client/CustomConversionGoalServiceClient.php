 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/custom_conversion_goal_service.proto
 ...
 *
 * @method PromiseInterface<MutateCustomConversionGoalsResponse> mutateCustomConversionGoalsAsync(MutateCustomConversionGoalsRequest $request, array $optionalArgs = [])
 */
class CustomConversionGoalServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.CustomConversionGoalService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/custom_conversion_goal_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/custom_conversion_goal_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/custom_conversion_goal_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/custom_conversion_goal_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\CustomConversionGoalServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomConversionGoalServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateCustomConversionGoalsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCustomConversionGoals(MutateCustomConversionGoalsRequest $request, array $callOptions = []): MutateCustomConversionGoalsResponse
    {
        return $this->startApiCall('MutateCustomConversionGoals', $request, $callOptions)->wait();
    }
}
