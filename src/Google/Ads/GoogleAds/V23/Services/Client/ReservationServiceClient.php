 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/reservation_service.proto
...
/**
 * Service Description: Service for reservation related operations.
 * This service is not publicly available.
 *
 * This class provides the ability to make remote calls to the backing service through method
 * calls that map to API methods.
 *
 * @method PromiseInterface<BookCampaignsResponse> bookCampaignsAsync(BookCampaignsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<QuoteCampaignsResponse> quoteCampaignsAsync(QuoteCampaignsRequest $request, array $optionalArgs = [])
 */
class ReservationServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.ReservationService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\ReservationServiceClient;
     ...
     * }
     *
     * @return BookCampaignsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function bookCampaigns(BookCampaignsRequest $request, array $callOptions = []): BookCampaignsResponse
    {
        return $this->startApiCall('BookCampaigns', $request, $callOptions)->wait();
    }
     ...
     * }
     *
     * @return QuoteCampaignsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function quoteCampaigns(QuoteCampaignsRequest $request, array $callOptions = []): QuoteCampaignsResponse
    {
        return $this->startApiCall('QuoteCampaigns', $request, $callOptions)->wait();
    }
}
