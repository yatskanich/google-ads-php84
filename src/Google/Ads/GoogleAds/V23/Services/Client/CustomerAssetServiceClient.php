 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/customer_asset_service.proto
 ...
 *
 * @method PromiseInterface<MutateCustomerAssetsResponse> mutateCustomerAssetsAsync(MutateCustomerAssetsRequest $request, array $optionalArgs = [])
 */
class CustomerAssetServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.CustomerAssetService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/customer_asset_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/customer_asset_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/customer_asset_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/customer_asset_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\CustomerAssetServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomerAssetServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateCustomerAssetsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCustomerAssets(MutateCustomerAssetsRequest $request, array $callOptions = []): MutateCustomerAssetsResponse
    {
        return $this->startApiCall('MutateCustomerAssets', $request, $callOptions)->wait();
    }
}
