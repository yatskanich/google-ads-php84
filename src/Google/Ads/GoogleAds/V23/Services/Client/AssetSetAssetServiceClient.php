 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/asset_set_asset_service.proto
 ...
 *
 * @method PromiseInterface<MutateAssetSetAssetsResponse> mutateAssetSetAssetsAsync(MutateAssetSetAssetsRequest $request, array $optionalArgs = [])
 */
class AssetSetAssetServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AssetSetAssetService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/asset_set_asset_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/asset_set_asset_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/asset_set_asset_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/asset_set_asset_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AssetSetAssetServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AssetSetAssetServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see AssetSetAssetServiceClient::mutateAssetSetAssetsAsync()} .
     *
     * @param MutateAssetSetAssetsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateAssetSetAssetsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAssetSetAssets(MutateAssetSetAssetsRequest $request, array $callOptions = []): MutateAssetSetAssetsResponse
    {
        return $this->startApiCall('MutateAssetSetAssets', $request, $callOptions)->wait();
    }
}
