 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/ad_group_ad_service.proto
...
class AdGroupAdServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AdGroupAdService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AdGroupAdServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AdGroupAdServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
