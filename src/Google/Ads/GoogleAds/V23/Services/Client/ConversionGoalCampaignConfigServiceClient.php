 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/conversion_goal_campaign_config_service.proto
 ...
 *
 * @method PromiseInterface<MutateConversionGoalCampaignConfigsResponse> mutateConversionGoalCampaignConfigsAsync(MutateConversionGoalCampaignConfigsRequest $request, array $optionalArgs = [])
 */
class ConversionGoalCampaignConfigServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.ConversionGoalCampaignConfigService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\ConversionGoalCampaignConfigServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ConversionGoalCampaignConfigServiceClient(['credentials' =>
     *           $creds]);
     *           ```
     *           {@see
     ...
     * {@see ConversionGoalCampaignConfigServiceClient::mutateConversionGoalCampaignConfigsAsync()}
     * .
     *
     * @param MutateConversionGoalCampaignConfigsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateConversionGoalCampaignConfigsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateConversionGoalCampaignConfigs(MutateConversionGoalCampaignConfigsRequest $request, array $callOptions = []): MutateConversionGoalCampaignConfigsResponse
    {
        return $this->startApiCall('MutateConversionGoalCampaignConfigs', $request, $callOptions)->wait();
    }
}
