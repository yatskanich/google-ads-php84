 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/campaign_conversion_goal_service.proto
 ...
 *
 * @method PromiseInterface<MutateCampaignConversionGoalsResponse> mutateCampaignConversionGoalsAsync(MutateCampaignConversionGoalsRequest $request, array $optionalArgs = [])
 */
class CampaignConversionGoalServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.CampaignConversionGoalService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/campaign_conversion_goal_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/campaign_conversion_goal_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/campaign_conversion_goal_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/campaign_conversion_goal_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\CampaignConversionGoalServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CampaignConversionGoalServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see CampaignConversionGoalServiceClient::mutateCampaignConversionGoalsAsync()}
     * .
     *
     * @param MutateCampaignConversionGoalsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateCampaignConversionGoalsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCampaignConversionGoals(MutateCampaignConversionGoalsRequest $request, array $callOptions = []): MutateCampaignConversionGoalsResponse
    {
        return $this->startApiCall('MutateCampaignConversionGoals', $request, $callOptions)->wait();
    }
}
