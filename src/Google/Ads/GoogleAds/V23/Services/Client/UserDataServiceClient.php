 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/user_data_service.proto
 ...
 *
 * @method PromiseInterface<UploadUserDataResponse> uploadUserDataAsync(UploadUserDataRequest $request, array $optionalArgs = [])
 */
class UserDataServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.UserDataService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/user_data_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/user_data_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/user_data_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/user_data_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\UserDataServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new UserDataServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * [UserDataError]()
     *
     * The async variant is {@see UserDataServiceClient::uploadUserDataAsync()} .
     *
     * @param UploadUserDataRequest $request     A request to house fields associated with the call.
     ...
     */
    public function uploadUserData(UploadUserDataRequest $request, array $callOptions = []): UploadUserDataResponse
    {
        return $this->startApiCall('UploadUserData', $request, $callOptions)->wait();
    }
}
