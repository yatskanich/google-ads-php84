 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/bidding_data_exclusion_service.proto
 ...
 *
 * @method PromiseInterface<MutateBiddingDataExclusionsResponse> mutateBiddingDataExclusionsAsync(MutateBiddingDataExclusionsRequest $request, array $optionalArgs = [])
 */
class BiddingDataExclusionServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.BiddingDataExclusionService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/bidding_data_exclusion_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\BiddingDataExclusionServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new BiddingDataExclusionServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see BiddingDataExclusionServiceClient::mutateBiddingDataExclusionsAsync()} .
     *
     * @param MutateBiddingDataExclusionsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateBiddingDataExclusionsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateBiddingDataExclusions(MutateBiddingDataExclusionsRequest $request, array $callOptions = []): MutateBiddingDataExclusionsResponse
    {
        return $this->startApiCall('MutateBiddingDataExclusions', $request, $callOptions)->wait();
    }
}
