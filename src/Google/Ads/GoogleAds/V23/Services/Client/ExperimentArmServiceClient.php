 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/experiment_arm_service.proto
 ...
 *
 * @method PromiseInterface<MutateExperimentArmsResponse> mutateExperimentArmsAsync(MutateExperimentArmsRequest $request, array $optionalArgs = [])
 */
class ExperimentArmServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.ExperimentArmService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/experiment_arm_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/experiment_arm_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/experiment_arm_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/experiment_arm_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\ExperimentArmServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ExperimentArmServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see ExperimentArmServiceClient::mutateExperimentArmsAsync()} .
     *
     * @param MutateExperimentArmsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateExperimentArmsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateExperimentArms(MutateExperimentArmsRequest $request, array $callOptions = []): MutateExperimentArmsResponse
    {
        return $this->startApiCall('MutateExperimentArms', $request, $callOptions)->wait();
    }
}
