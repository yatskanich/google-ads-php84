 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/customer_label_service.proto
 ...
 *
 * @method PromiseInterface<MutateCustomerLabelsResponse> mutateCustomerLabelsAsync(MutateCustomerLabelsRequest $request, array $optionalArgs = [])
 */
class CustomerLabelServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.CustomerLabelService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\CustomerLabelServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomerLabelServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateCustomerLabelsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCustomerLabels(MutateCustomerLabelsRequest $request, array $callOptions = []): MutateCustomerLabelsResponse
    {
        return $this->startApiCall('MutateCustomerLabels', $request, $callOptions)->wait();
    }
}
