 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/recommendation_service.proto
 ...
 *
 * @method PromiseInterface<ApplyRecommendationResponse> applyRecommendationAsync(ApplyRecommendationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<DismissRecommendationResponse> dismissRecommendationAsync(DismissRecommendationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<GenerateRecommendationsResponse> generateRecommendationsAsync(GenerateRecommendationsRequest $request, array $optionalArgs = [])
 */
class RecommendationServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.RecommendationService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\RecommendationServiceClient;
