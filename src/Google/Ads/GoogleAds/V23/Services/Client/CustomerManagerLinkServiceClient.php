 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/customer_manager_link_service.proto
 ...
 *
 * @method PromiseInterface<MoveManagerLinkResponse> moveManagerLinkAsync(MoveManagerLinkRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<MutateCustomerManagerLinkResponse> mutateCustomerManagerLinkAsync(MutateCustomerManagerLinkRequest $request, array $optionalArgs = [])
 */
class CustomerManagerLinkServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.CustomerManagerLinkService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/customer_manager_link_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/customer_manager_link_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/customer_manager_link_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/customer_manager_link_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     */
    public static function customerManagerLinkName(string $customerId, string $managerCustomerId, string $managerLinkId): string
    {
        return self::getPathTemplate('customerManagerLink')->render([
            'customer_id' => $customerId,
     ...
     *           use Google\Ads\GoogleAds\V23\Services\CustomerManagerLinkServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomerManagerLinkServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MoveManagerLinkResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function moveManagerLink(MoveManagerLinkRequest $request, array $callOptions = []): MoveManagerLinkResponse
    {
        return $this->startApiCall('MoveManagerLink', $request, $callOptions)->wait();
    }
     ...
     * }
     *
     * @return MutateCustomerManagerLinkResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCustomerManagerLink(MutateCustomerManagerLinkRequest $request, array $callOptions = []): MutateCustomerManagerLinkResponse
    {
        return $this->startApiCall('MutateCustomerManagerLink', $request, $callOptions)->wait();
    }
}
