 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/shared_criterion_service.proto
 ...
 *
 * @method PromiseInterface<MutateSharedCriteriaResponse> mutateSharedCriteriaAsync(MutateSharedCriteriaRequest $request, array $optionalArgs = [])
 */
class SharedCriterionServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.SharedCriterionService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/shared_criterion_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/shared_criterion_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/shared_criterion_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/shared_criterion_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\SharedCriterionServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new SharedCriterionServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateSharedCriteriaResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateSharedCriteria(MutateSharedCriteriaRequest $request, array $callOptions = []): MutateSharedCriteriaResponse
    {
        return $this->startApiCall('MutateSharedCriteria', $request, $callOptions)->wait();
    }
}
