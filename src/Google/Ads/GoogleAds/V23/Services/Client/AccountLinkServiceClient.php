 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/account_link_service.proto
...
class AccountLinkServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AccountLinkService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/account_link_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/account_link_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/account_link_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/account_link_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a account_link
     * resource.
     *
     * @param string $customerId
     * @param string $accountLinkId
     *
     * @return string The formatted account_link resource.
     */
    public static function accountLinkName(string $customerId, string $accountLinkId): string
    {
        return self::getPathTemplate('accountLink')->render([
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AccountLinkServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AccountLinkServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function createAccountLink(CreateAccountLinkRequest $request, array $callOptions = []): CreateAccountLinkResponse
    {
        return $this->startApiCall('CreateAccountLink', $request, $callOptions)->wait();
    }
     ...
     * }
     *
     * @return MutateAccountLinkResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAccountLink(MutateAccountLinkRequest $request, array $callOptions = []): MutateAccountLinkResponse
    {
        return $this->startApiCall('MutateAccountLink', $request, $callOptions)->wait();
    }
}
