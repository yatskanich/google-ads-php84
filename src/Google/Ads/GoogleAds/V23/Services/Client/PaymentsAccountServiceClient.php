 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/payments_account_service.proto
 ...
 *
 * @method PromiseInterface<ListPaymentsAccountsResponse> listPaymentsAccountsAsync(ListPaymentsAccountsRequest $request, array $optionalArgs = [])
 */
class PaymentsAccountServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.PaymentsAccountService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\PaymentsAccountServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new PaymentsAccountServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function listPaymentsAccounts(ListPaymentsAccountsRequest $request, array $callOptions = []): ListPaymentsAccountsResponse
    {
        return $this->startApiCall('ListPaymentsAccounts', $request, $callOptions)->wait();
    }
}
