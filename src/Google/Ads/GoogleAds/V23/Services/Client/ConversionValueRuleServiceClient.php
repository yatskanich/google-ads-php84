 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/conversion_value_rule_service.proto
 ...
 *
 * @method PromiseInterface<MutateConversionValueRulesResponse> mutateConversionValueRulesAsync(MutateConversionValueRulesRequest $request, array $optionalArgs = [])
 */
class ConversionValueRuleServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.ConversionValueRuleService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/conversion_value_rule_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/conversion_value_rule_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/conversion_value_rule_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/conversion_value_rule_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\ConversionValueRuleServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ConversionValueRuleServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateConversionValueRulesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateConversionValueRules(MutateConversionValueRulesRequest $request, array $callOptions = []): MutateConversionValueRulesResponse
    {
        return $this->startApiCall('MutateConversionValueRules', $request, $callOptions)->wait();
    }
}
