 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/customer_negative_criterion_service.proto
 ...
 *
 * @method PromiseInterface<MutateCustomerNegativeCriteriaResponse> mutateCustomerNegativeCriteriaAsync(MutateCustomerNegativeCriteriaRequest $request, array $optionalArgs = [])
 */
class CustomerNegativeCriterionServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.CustomerNegativeCriterionService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/customer_negative_criterion_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/customer_negative_criterion_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/customer_negative_criterion_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/customer_negative_criterion_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\CustomerNegativeCriterionServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomerNegativeCriterionServiceClient(['credentials' =>
     *           $creds]);
     *           ```
     *           {@see
     ...
     * {@see CustomerNegativeCriterionServiceClient::mutateCustomerNegativeCriteriaAsync()}
     * .
     *
     * @param MutateCustomerNegativeCriteriaRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateCustomerNegativeCriteriaResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCustomerNegativeCriteria(MutateCustomerNegativeCriteriaRequest $request, array $callOptions = []): MutateCustomerNegativeCriteriaResponse
    {
        return $this->startApiCall('MutateCustomerNegativeCriteria', $request, $callOptions)->wait();
    }
}
