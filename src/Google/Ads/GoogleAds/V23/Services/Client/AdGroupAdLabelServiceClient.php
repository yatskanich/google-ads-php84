 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/ad_group_ad_label_service.proto
...
class AdGroupAdLabelServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AdGroupAdLabelService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AdGroupAdLabelServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AdGroupAdLabelServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see AdGroupAdLabelServiceClient::mutateAdGroupAdLabelsAsync()} .
     *
     * @param MutateAdGroupAdLabelsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateAdGroupAdLabelsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAdGroupAdLabels(MutateAdGroupAdLabelsRequest $request, array $callOptions = []): MutateAdGroupAdLabelsResponse
    {
        return $this->startApiCall('MutateAdGroupAdLabels', $request, $callOptions)->wait();
    }
}
