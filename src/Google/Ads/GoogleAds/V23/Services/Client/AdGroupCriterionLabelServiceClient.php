 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/ad_group_criterion_label_service.proto
 ...
 *
 * @method PromiseInterface<MutateAdGroupCriterionLabelsResponse> mutateAdGroupCriterionLabelsAsync(MutateAdGroupCriterionLabelsRequest $request, array $optionalArgs = [])
 */
class AdGroupCriterionLabelServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AdGroupCriterionLabelService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/ad_group_criterion_label_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/ad_group_criterion_label_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/ad_group_criterion_label_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/ad_group_criterion_label_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AdGroupCriterionLabelServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AdGroupCriterionLabelServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateAdGroupCriterionLabelsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAdGroupCriterionLabels(MutateAdGroupCriterionLabelsRequest $request, array $callOptions = []): MutateAdGroupCriterionLabelsResponse
    {
        return $this->startApiCall('MutateAdGroupCriterionLabels', $request, $callOptions)->wait();
    }
}
