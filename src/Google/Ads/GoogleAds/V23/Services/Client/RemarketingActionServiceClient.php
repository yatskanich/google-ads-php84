 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/remarketing_action_service.proto
 ...
 *
 * @method PromiseInterface<MutateRemarketingActionsResponse> mutateRemarketingActionsAsync(MutateRemarketingActionsRequest $request, array $optionalArgs = [])
 */
class RemarketingActionServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.RemarketingActionService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/remarketing_action_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/remarketing_action_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/remarketing_action_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/remarketing_action_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\RemarketingActionServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new RemarketingActionServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateRemarketingActionsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateRemarketingActions(MutateRemarketingActionsRequest $request, array $callOptions = []): MutateRemarketingActionsResponse
    {
        return $this->startApiCall('MutateRemarketingActions', $request, $callOptions)->wait();
    }
}
