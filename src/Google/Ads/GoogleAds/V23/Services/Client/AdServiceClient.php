 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/ad_service.proto
 ...
 *
 * @method PromiseInterface<MutateAdsResponse> mutateAdsAsync(MutateAdsRequest $request, array $optionalArgs = [])
 */
class AdServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AdService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/ad_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/ad_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/ad_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/ad_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AdServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AdServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * [UrlFieldError]()
     *
     * The async variant is {@see AdServiceClient::mutateAdsAsync()} .
     *
     * @param MutateAdsRequest $request     A request to house fields associated with the call.
     ...
     */
    public function mutateAds(MutateAdsRequest $request, array $callOptions = []): MutateAdsResponse
    {
        return $this->startApiCall('MutateAds', $request, $callOptions)->wait();
    }
}
