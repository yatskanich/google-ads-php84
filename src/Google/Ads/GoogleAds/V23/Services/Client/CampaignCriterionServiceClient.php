 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/campaign_criterion_service.proto
 ...
 *
 * @method PromiseInterface<MutateCampaignCriteriaResponse> mutateCampaignCriteriaAsync(MutateCampaignCriteriaRequest $request, array $optionalArgs = [])
 */
class CampaignCriterionServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.CampaignCriterionService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\CampaignCriterionServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CampaignCriterionServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
