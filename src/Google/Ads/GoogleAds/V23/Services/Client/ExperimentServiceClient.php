 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/experiment_service.proto
...
class ExperimentServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.ExperimentService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\ExperimentServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ExperimentServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
