 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/conversion_value_rule_set_service.proto
 ...
 *
 * @method PromiseInterface<MutateConversionValueRuleSetsResponse> mutateConversionValueRuleSetsAsync(MutateConversionValueRuleSetsRequest $request, array $optionalArgs = [])
 */
class ConversionValueRuleSetServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.ConversionValueRuleSetService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/conversion_value_rule_set_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/conversion_value_rule_set_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/conversion_value_rule_set_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/conversion_value_rule_set_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\ConversionValueRuleSetServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ConversionValueRuleSetServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see ConversionValueRuleSetServiceClient::mutateConversionValueRuleSetsAsync()}
     * .
     *
     * @param MutateConversionValueRuleSetsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateConversionValueRuleSetsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateConversionValueRuleSets(MutateConversionValueRuleSetsRequest $request, array $callOptions = []): MutateConversionValueRuleSetsResponse
    {
        return $this->startApiCall('MutateConversionValueRuleSets', $request, $callOptions)->wait();
    }
}
