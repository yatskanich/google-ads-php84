 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/youtube_video_upload_service.proto
 ...
 */
class YouTubeVideoUploadServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.YouTubeVideoUploadService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/you_tube_video_upload_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/you_tube_video_upload_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/you_tube_video_upload_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/you_tube_video_upload_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * you_tube_video_upload resource.
     *
     * @param string $customerId
     * @param string $videoUploadId
     *
     * @return string The formatted you_tube_video_upload resource.
     */
     ...
     *           use Google\Ads\GoogleAds\V23\Services\YouTubeVideoUploadServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new YouTubeVideoUploadServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return RemoveYouTubeVideoUploadResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function removeYouTubeVideoUpload(RemoveYouTubeVideoUploadRequest $request, array $callOptions = []): RemoveYouTubeVideoUploadResponse
    {
        return $this->startApiCall('RemoveYouTubeVideoUpload', $request, $callOptions)->wait();
    }
     ...
     * }
     *
     * @return UpdateYouTubeVideoUploadResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateYouTubeVideoUpload(UpdateYouTubeVideoUploadRequest $request, array $callOptions = []): UpdateYouTubeVideoUploadResponse
    {
        return $this->startApiCall('UpdateYouTubeVideoUpload', $request, $callOptions)->wait();
    }
}
