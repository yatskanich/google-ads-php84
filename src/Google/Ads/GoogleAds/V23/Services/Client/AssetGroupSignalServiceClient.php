 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/asset_group_signal_service.proto
 ...
 *
 * @method PromiseInterface<MutateAssetGroupSignalsResponse> mutateAssetGroupSignalsAsync(MutateAssetGroupSignalsRequest $request, array $optionalArgs = [])
 */
class AssetGroupSignalServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AssetGroupSignalService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/asset_group_signal_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/asset_group_signal_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/asset_group_signal_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/asset_group_signal_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AssetGroupSignalServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AssetGroupSignalServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateAssetGroupSignalsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAssetGroupSignals(MutateAssetGroupSignalsRequest $request, array $callOptions = []): MutateAssetGroupSignalsResponse
    {
        return $this->startApiCall('MutateAssetGroupSignals', $request, $callOptions)->wait();
    }
}
