 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/campaign_label_service.proto
 ...
 *
 * @method PromiseInterface<MutateCampaignLabelsResponse> mutateCampaignLabelsAsync(MutateCampaignLabelsRequest $request, array $optionalArgs = [])
 */
class CampaignLabelServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.CampaignLabelService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/campaign_label_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/campaign_label_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/campaign_label_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/campaign_label_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\CampaignLabelServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CampaignLabelServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateCampaignLabelsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCampaignLabels(MutateCampaignLabelsRequest $request, array $callOptions = []): MutateCampaignLabelsResponse
    {
        return $this->startApiCall('MutateCampaignLabels', $request, $callOptions)->wait();
    }
}
