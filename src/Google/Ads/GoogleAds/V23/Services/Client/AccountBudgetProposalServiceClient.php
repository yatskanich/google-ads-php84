 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/account_budget_proposal_service.proto
...
class AccountBudgetProposalServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AccountBudgetProposalService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AccountBudgetProposalServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AccountBudgetProposalServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function mutateAccountBudgetProposal(MutateAccountBudgetProposalRequest $request, array $callOptions = []): MutateAccountBudgetProposalResponse
    {
        return $this->startApiCall('MutateAccountBudgetProposal', $request, $callOptions)->wait();
    }
}
