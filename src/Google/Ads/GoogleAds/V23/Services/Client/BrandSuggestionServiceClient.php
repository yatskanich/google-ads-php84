 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/brand_suggestion_service.proto
 ...
 *
 * @method PromiseInterface<SuggestBrandsResponse> suggestBrandsAsync(SuggestBrandsRequest $request, array $optionalArgs = [])
 */
class BrandSuggestionServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.BrandSuggestionService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/brand_suggestion_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\BrandSuggestionServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new BrandSuggestionServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function suggestBrands(SuggestBrandsRequest $request, array $callOptions = []): SuggestBrandsResponse
    {
        return $this->startApiCall('SuggestBrands', $request, $callOptions)->wait();
    }
}
