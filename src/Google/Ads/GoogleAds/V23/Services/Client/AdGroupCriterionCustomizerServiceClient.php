 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/ad_group_criterion_customizer_service.proto
 ...
 *
 * @method PromiseInterface<MutateAdGroupCriterionCustomizersResponse> mutateAdGroupCriterionCustomizersAsync(MutateAdGroupCriterionCustomizersRequest $request, array $optionalArgs = [])
 */
class AdGroupCriterionCustomizerServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AdGroupCriterionCustomizerService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/ad_group_criterion_customizer_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/ad_group_criterion_customizer_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/ad_group_criterion_customizer_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/ad_group_criterion_customizer_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AdGroupCriterionCustomizerServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AdGroupCriterionCustomizerServiceClient(['credentials' =>
     *           $creds]);
     *           ```
     *           {@see
     ...
     * {@see AdGroupCriterionCustomizerServiceClient::mutateAdGroupCriterionCustomizersAsync()}
     * .
     *
     * @param MutateAdGroupCriterionCustomizersRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateAdGroupCriterionCustomizersResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAdGroupCriterionCustomizers(MutateAdGroupCriterionCustomizersRequest $request, array $callOptions = []): MutateAdGroupCriterionCustomizersResponse
    {
        return $this->startApiCall('MutateAdGroupCriterionCustomizers', $request, $callOptions)->wait();
    }
}
