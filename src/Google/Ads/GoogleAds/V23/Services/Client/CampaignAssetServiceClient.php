 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/campaign_asset_service.proto
 ...
 *
 * @method PromiseInterface<MutateCampaignAssetsResponse> mutateCampaignAssetsAsync(MutateCampaignAssetsRequest $request, array $optionalArgs = [])
 */
class CampaignAssetServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.CampaignAssetService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/campaign_asset_service_client_config.json',
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/campaign_asset_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\CampaignAssetServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CampaignAssetServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see CampaignAssetServiceClient::mutateCampaignAssetsAsync()} .
     *
     * @param MutateCampaignAssetsRequest $request     A request to house fields associated with the call.
     ...
     */
    public function mutateCampaignAssets(MutateCampaignAssetsRequest $request, array $callOptions = []): MutateCampaignAssetsResponse
    {
        return $this->startApiCall('MutateCampaignAssets', $request, $callOptions)->wait();
    }
}
