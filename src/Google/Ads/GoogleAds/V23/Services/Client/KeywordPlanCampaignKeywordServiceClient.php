 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/keyword_plan_campaign_keyword_service.proto
 ...
 *
 * @method PromiseInterface<MutateKeywordPlanCampaignKeywordsResponse> mutateKeywordPlanCampaignKeywordsAsync(MutateKeywordPlanCampaignKeywordsRequest $request, array $optionalArgs = [])
 */
class KeywordPlanCampaignKeywordServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.KeywordPlanCampaignKeywordService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/keyword_plan_campaign_keyword_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/keyword_plan_campaign_keyword_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/keyword_plan_campaign_keyword_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/keyword_plan_campaign_keyword_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\KeywordPlanCampaignKeywordServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new KeywordPlanCampaignKeywordServiceClient(['credentials' =>
     *           $creds]);
     *           ```
     *           {@see
     ...
     * {@see KeywordPlanCampaignKeywordServiceClient::mutateKeywordPlanCampaignKeywordsAsync()}
     * .
     *
     * @param MutateKeywordPlanCampaignKeywordsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateKeywordPlanCampaignKeywordsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateKeywordPlanCampaignKeywords(MutateKeywordPlanCampaignKeywordsRequest $request, array $callOptions = []): MutateKeywordPlanCampaignKeywordsResponse
    {
        return $this->startApiCall('MutateKeywordPlanCampaignKeywords', $request, $callOptions)->wait();
    }
}
