 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/asset_group_asset_service.proto
 ...
 *
 * @method PromiseInterface<MutateAssetGroupAssetsResponse> mutateAssetGroupAssetsAsync(MutateAssetGroupAssetsRequest $request, array $optionalArgs = [])
 */
class AssetGroupAssetServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AssetGroupAssetService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/asset_group_asset_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/asset_group_asset_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/asset_group_asset_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/asset_group_asset_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AssetGroupAssetServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AssetGroupAssetServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see AssetGroupAssetServiceClient::mutateAssetGroupAssetsAsync()} .
     *
     * @param MutateAssetGroupAssetsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateAssetGroupAssetsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAssetGroupAssets(MutateAssetGroupAssetsRequest $request, array $callOptions = []): MutateAssetGroupAssetsResponse
    {
        return $this->startApiCall('MutateAssetGroupAssets', $request, $callOptions)->wait();
    }
}
