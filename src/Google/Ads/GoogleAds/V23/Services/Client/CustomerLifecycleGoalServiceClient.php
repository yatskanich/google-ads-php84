 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/customer_lifecycle_goal_service.proto
 ...
 *
 * @method PromiseInterface<ConfigureCustomerLifecycleGoalsResponse> configureCustomerLifecycleGoalsAsync(ConfigureCustomerLifecycleGoalsRequest $request, array $optionalArgs = [])
 */
class CustomerLifecycleGoalServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.CustomerLifecycleGoalService';
     ...
     */
    public static function customerLifecycleGoalName(string $customerId): string
    {
        return self::getPathTemplate('customerLifecycleGoal')->render([
            'customer_id' => $customerId,
        ]);
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\CustomerLifecycleGoalServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomerLifecycleGoalServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see CustomerLifecycleGoalServiceClient::configureCustomerLifecycleGoalsAsync()}
     * .
     *
     * @param ConfigureCustomerLifecycleGoalsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return ConfigureCustomerLifecycleGoalsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function configureCustomerLifecycleGoals(ConfigureCustomerLifecycleGoalsRequest $request, array $callOptions = []): ConfigureCustomerLifecycleGoalsResponse
    {
        return $this->startApiCall('ConfigureCustomerLifecycleGoals', $request, $callOptions)->wait();
    }
}
