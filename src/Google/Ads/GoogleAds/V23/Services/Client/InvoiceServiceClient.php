 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/invoice_service.proto
 ...
 *
 * @method PromiseInterface<ListInvoicesResponse> listInvoicesAsync(ListInvoicesRequest $request, array $optionalArgs = [])
 */
class InvoiceServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.InvoiceService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\InvoiceServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new InvoiceServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function listInvoices(ListInvoicesRequest $request, array $callOptions = []): ListInvoicesResponse
    {
        return $this->startApiCall('ListInvoices', $request, $callOptions)->wait();
    }
}
