 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/customer_customizer_service.proto
 ...
 *
 * @method PromiseInterface<MutateCustomerCustomizersResponse> mutateCustomerCustomizersAsync(MutateCustomerCustomizersRequest $request, array $optionalArgs = [])
 */
class CustomerCustomizerServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.CustomerCustomizerService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/customer_customizer_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/customer_customizer_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/customer_customizer_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/customer_customizer_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\CustomerCustomizerServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomerCustomizerServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see CustomerCustomizerServiceClient::mutateCustomerCustomizersAsync()} .
     *
     * @param MutateCustomerCustomizersRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateCustomerCustomizersResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCustomerCustomizers(MutateCustomerCustomizersRequest $request, array $callOptions = []): MutateCustomerCustomizersResponse
    {
        return $this->startApiCall('MutateCustomerCustomizers', $request, $callOptions)->wait();
    }
}
