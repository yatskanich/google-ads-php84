 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/ad_group_bid_modifier_service.proto
 ...
 *
 * @method PromiseInterface<MutateAdGroupBidModifiersResponse> mutateAdGroupBidModifiersAsync(MutateAdGroupBidModifiersRequest $request, array $optionalArgs = [])
 */
class AdGroupBidModifierServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AdGroupBidModifierService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/ad_group_bid_modifier_service_client_config.json',
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/ad_group_bid_modifier_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AdGroupBidModifierServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AdGroupBidModifierServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateAdGroupBidModifiersResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAdGroupBidModifiers(MutateAdGroupBidModifiersRequest $request, array $callOptions = []): MutateAdGroupBidModifiersResponse
    {
        return $this->startApiCall('MutateAdGroupBidModifiers', $request, $callOptions)->wait();
    }
}
