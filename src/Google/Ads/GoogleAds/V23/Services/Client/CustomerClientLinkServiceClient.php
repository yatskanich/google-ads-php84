 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/customer_client_link_service.proto
 ...
 *
 * @method PromiseInterface<MutateCustomerClientLinkResponse> mutateCustomerClientLinkAsync(MutateCustomerClientLinkRequest $request, array $optionalArgs = [])
 */
class CustomerClientLinkServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.CustomerClientLinkService';
     ...
     */
    public static function customerClientLinkName(string $customerId, string $clientCustomerId, string $managerLinkId): string
    {
        return self::getPathTemplate('customerClientLink')->render([
            'customer_id' => $customerId,
     ...
     *           use Google\Ads\GoogleAds\V23\Services\CustomerClientLinkServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomerClientLinkServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function mutateCustomerClientLink(MutateCustomerClientLinkRequest $request, array $callOptions = []): MutateCustomerClientLinkResponse
    {
        return $this->startApiCall('MutateCustomerClientLink', $request, $callOptions)->wait();
    }
}
