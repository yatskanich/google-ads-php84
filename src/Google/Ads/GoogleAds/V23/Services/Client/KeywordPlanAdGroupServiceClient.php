 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/keyword_plan_ad_group_service.proto
 ...
 *
 * @method PromiseInterface<MutateKeywordPlanAdGroupsResponse> mutateKeywordPlanAdGroupsAsync(MutateKeywordPlanAdGroupsRequest $request, array $optionalArgs = [])
 */
class KeywordPlanAdGroupServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.KeywordPlanAdGroupService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\KeywordPlanAdGroupServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new KeywordPlanAdGroupServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see KeywordPlanAdGroupServiceClient::mutateKeywordPlanAdGroupsAsync()} .
     *
     * @param MutateKeywordPlanAdGroupsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateKeywordPlanAdGroupsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateKeywordPlanAdGroups(MutateKeywordPlanAdGroupsRequest $request, array $callOptions = []): MutateKeywordPlanAdGroupsResponse
    {
        return $this->startApiCall('MutateKeywordPlanAdGroups', $request, $callOptions)->wait();
    }
}
