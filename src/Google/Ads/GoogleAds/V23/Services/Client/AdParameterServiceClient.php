 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/ad_parameter_service.proto
 ...
 *
 * @method PromiseInterface<MutateAdParametersResponse> mutateAdParametersAsync(MutateAdParametersRequest $request, array $optionalArgs = [])
 */
class AdParameterServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AdParameterService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/ad_parameter_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/ad_parameter_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/ad_parameter_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/ad_parameter_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AdParameterServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AdParameterServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateAdParametersResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAdParameters(MutateAdParametersRequest $request, array $callOptions = []): MutateAdParametersResponse
    {
        return $this->startApiCall('MutateAdParameters', $request, $callOptions)->wait();
    }
}
