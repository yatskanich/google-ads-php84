 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/audience_insights_service.proto
 ...
 * @method PromiseInterface<GenerateAudienceDefinitionResponse> generateAudienceDefinitionAsync(GenerateAudienceDefinitionRequest $request, array $optionalArgs = [])
...
class AudienceInsightsServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AudienceInsightsService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AudienceInsightsServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AudienceInsightsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return GenerateAudienceDefinitionResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function generateAudienceDefinition(GenerateAudienceDefinitionRequest $request, array $callOptions = []): GenerateAudienceDefinitionResponse
    {
        return $this->startApiCall('GenerateAudienceDefinition', $request, $callOptions)->wait();
    }
