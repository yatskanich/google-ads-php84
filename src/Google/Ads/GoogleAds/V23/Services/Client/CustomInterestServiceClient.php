 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/custom_interest_service.proto
 ...
 *
 * @method PromiseInterface<MutateCustomInterestsResponse> mutateCustomInterestsAsync(MutateCustomInterestsRequest $request, array $optionalArgs = [])
 */
class CustomInterestServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.CustomInterestService';
     ...
     */
    public static function customInterestName(string $customerId, string $customInterestId): string
    {
        return self::getPathTemplate('customInterest')->render([
     ...
     *           use Google\Ads\GoogleAds\V23\Services\CustomInterestServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomInterestServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateCustomInterestsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCustomInterests(MutateCustomInterestsRequest $request, array $callOptions = []): MutateCustomInterestsResponse
    {
        return $this->startApiCall('MutateCustomInterests', $request, $callOptions)->wait();
    }
}
