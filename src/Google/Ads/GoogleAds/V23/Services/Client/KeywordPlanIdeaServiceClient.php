 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/keyword_plan_idea_service.proto
...
class KeywordPlanIdeaServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.KeywordPlanIdeaService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\KeywordPlanIdeaServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new KeywordPlanIdeaServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function generateAdGroupThemes(GenerateAdGroupThemesRequest $request, array $callOptions = []): GenerateAdGroupThemesResponse
    {
        return $this->startApiCall('GenerateAdGroupThemes', $request, $callOptions)->wait();
    }
     ...
     * }
     *
     * @return GenerateKeywordForecastMetricsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function generateKeywordForecastMetrics(GenerateKeywordForecastMetricsRequest $request, array $callOptions = []): GenerateKeywordForecastMetricsResponse
    {
        return $this->startApiCall('GenerateKeywordForecastMetrics', $request, $callOptions)->wait();
    }
     ...
     * }
     *
     * @return GenerateKeywordHistoricalMetricsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function generateKeywordHistoricalMetrics(GenerateKeywordHistoricalMetricsRequest $request, array $callOptions = []): GenerateKeywordHistoricalMetricsResponse
    {
        return $this->startApiCall('GenerateKeywordHistoricalMetrics', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function generateKeywordIdeas(GenerateKeywordIdeasRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('GenerateKeywordIdeas', $request, $callOptions);
    }
}
