 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/asset_group_service.proto
 ...
 *
 * @method PromiseInterface<MutateAssetGroupsResponse> mutateAssetGroupsAsync(MutateAssetGroupsRequest $request, array $optionalArgs = [])
 */
class AssetGroupServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AssetGroupService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/asset_group_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/asset_group_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/asset_group_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/asset_group_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AssetGroupServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AssetGroupServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * returned.
     *
     * The async variant is {@see AssetGroupServiceClient::mutateAssetGroupsAsync()} .
     *
     * @param MutateAssetGroupsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateAssetGroupsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAssetGroups(MutateAssetGroupsRequest $request, array $callOptions = []): MutateAssetGroupsResponse
    {
        return $this->startApiCall('MutateAssetGroups', $request, $callOptions)->wait();
    }
}
