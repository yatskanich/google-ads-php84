 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/bidding_strategy_service.proto
 ...
 *
 * @method PromiseInterface<MutateBiddingStrategiesResponse> mutateBiddingStrategiesAsync(MutateBiddingStrategiesRequest $request, array $optionalArgs = [])
 */
class BiddingStrategyServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.BiddingStrategyService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/bidding_strategy_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V23\Services\BiddingStrategyServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new BiddingStrategyServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateBiddingStrategiesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateBiddingStrategies(MutateBiddingStrategiesRequest $request, array $callOptions = []): MutateBiddingStrategiesResponse
    {
        return $this->startApiCall('MutateBiddingStrategies', $request, $callOptions)->wait();
    }
}
