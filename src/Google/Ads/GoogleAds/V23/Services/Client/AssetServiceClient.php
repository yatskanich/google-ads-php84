 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v23/services/asset_service.proto
 ...
 *
 * @method PromiseInterface<MutateAssetsResponse> mutateAssetsAsync(MutateAssetsRequest $request, array $optionalArgs = [])
 */
class AssetServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v23.services.AssetService';
     ...
     *           use Google\Ads\GoogleAds\V23\Services\AssetServiceClient;
     ...
     */
    public function mutateAssets(MutateAssetsRequest $request, array $callOptions = []): MutateAssetsResponse
    {
        return $this->startApiCall('MutateAssets', $request, $callOptions)->wait();
    }
}
