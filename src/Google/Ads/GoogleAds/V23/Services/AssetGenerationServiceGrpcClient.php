...
class AssetGenerationServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GenerateText(\Google\Ads\GoogleAds\V23\Services\GenerateTextRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.AssetGenerationService/GenerateText',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\GenerateTextResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function GenerateImages(\Google\Ads\GoogleAds\V23\Services\GenerateImagesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.AssetGenerationService/GenerateImages',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\GenerateImagesResponse::class, 'decode'],
        $metadata, $options);
    }
