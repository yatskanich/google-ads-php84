...
class SharedCriterionServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringFormatError]()
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V23\Services\MutateSharedCriteriaRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V23\Services\MutateSharedCriteriaResponse>
     */
    public function MutateSharedCriteria(\Google\Ads\GoogleAds\V23\Services\MutateSharedCriteriaRequest $argument,
      $metadata = [], $options = []) {
