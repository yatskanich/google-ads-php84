...
class RecommendationServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function ApplyRecommendation(\Google\Ads\GoogleAds\V23\Services\ApplyRecommendationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.RecommendationService/ApplyRecommendation',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\ApplyRecommendationResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function DismissRecommendation(\Google\Ads\GoogleAds\V23\Services\DismissRecommendationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.RecommendationService/DismissRecommendation',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\DismissRecommendationResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function GenerateRecommendations(\Google\Ads\GoogleAds\V23\Services\GenerateRecommendationsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.RecommendationService/GenerateRecommendations',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\GenerateRecommendationsResponse::class, 'decode'],
        $metadata, $options);
    }
