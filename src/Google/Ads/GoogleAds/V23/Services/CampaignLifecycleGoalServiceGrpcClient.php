...
class CampaignLifecycleGoalServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function ConfigureCampaignLifecycleGoals(\Google\Ads\GoogleAds\V23\Services\ConfigureCampaignLifecycleGoalsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.CampaignLifecycleGoalService/ConfigureCampaignLifecycleGoals',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\ConfigureCampaignLifecycleGoalsResponse::class, 'decode'],
        $metadata, $options);
    }
