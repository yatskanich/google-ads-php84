...
class CustomerUserAccessServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V23\Services\MutateCustomerUserAccessRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V23\Services\MutateCustomerUserAccessResponse>
     */
    public function MutateCustomerUserAccess(\Google\Ads\GoogleAds\V23\Services\MutateCustomerUserAccessRequest $argument,
      $metadata = [], $options = []) {
