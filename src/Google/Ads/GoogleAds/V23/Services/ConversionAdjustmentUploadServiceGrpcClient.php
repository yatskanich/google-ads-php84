...
class ConversionAdjustmentUploadServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function UploadConversionAdjustments(\Google\Ads\GoogleAds\V23\Services\UploadConversionAdjustmentsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.ConversionAdjustmentUploadService/UploadConversionAdjustments',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\UploadConversionAdjustmentsResponse::class, 'decode'],
        $metadata, $options);
    }
