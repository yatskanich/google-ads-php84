...
class AccountBudgetProposalServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateAccountBudgetProposal(\Google\Ads\GoogleAds\V23\Services\MutateAccountBudgetProposalRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v23.services.AccountBudgetProposalService/MutateAccountBudgetProposal',
        $argument,
        [\Google\Ads\GoogleAds\V23\Services\MutateAccountBudgetProposalResponse::class, 'decode'],
        $metadata, $options);
    }
