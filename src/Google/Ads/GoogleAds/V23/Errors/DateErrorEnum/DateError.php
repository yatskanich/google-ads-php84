...
namespace Google\Ads\GoogleAds\V23\Errors\DateErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v23.errors.DateErrorEnum.DateError</code>
 */
class DateError
{
    /**
     ...
     * of the day.
     *
     * Generated from protobuf enum <code>DATE_RANGE_ERROR_START_TIME_MUST_BE_THE_START_OF_A_DAY = 13;</code>
     */
    const DATE_RANGE_ERROR_START_TIME_MUST_BE_THE_START_OF_A_DAY = 13;
    /**
     * This campaign type doesn't support an end date time that isn't the end of
     * the day.
     *
     * Generated from protobuf enum <code>DATE_RANGE_ERROR_END_TIME_MUST_BE_THE_END_OF_A_DAY = 14;</code>
     */
    const DATE_RANGE_ERROR_END_TIME_MUST_BE_THE_END_OF_A_DAY = 14;
    ...
    private static $valueToName = [
        ...
        self::DATE_RANGE_ERROR_START_TIME_MUST_BE_THE_START_OF_A_DAY => 'DATE_RANGE_ERROR_START_TIME_MUST_BE_THE_START_OF_A_DAY',
        self::DATE_RANGE_ERROR_END_TIME_MUST_BE_THE_END_OF_A_DAY => 'DATE_RANGE_ERROR_END_TIME_MUST_BE_THE_END_OF_A_DAY',
    ];
