...
namespace Google\Ads\GoogleAds\V23\Errors\AdGroupErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v23.errors.AdGroupErrorEnum.AdGroupError</code>
 */
class AdGroupError
{
    /**
     ...
     *
     * Generated from protobuf enum <code>CANNOT_ADD_AD_GROUP_FOR_CAMPAIGN_TYPE = 18;</code>
     */
    const CANNOT_ADD_AD_GROUP_FOR_CAMPAIGN_TYPE = 18;
    /**
     * Invalid status for the ad group.
     *
     * Generated from protobuf enum <code>INVALID_STATUS = 19;</code>
     */
    const INVALID_STATUS = 19;
    /**
     ...
     *
     * Generated from protobuf enum <code>INVALID_STEP_ID_FOR_VIDEO_ADS_SEQUENCING = 20;</code>
     */
    const INVALID_STEP_ID_FOR_VIDEO_ADS_SEQUENCING = 20;
    /**
     * For video ads sequencing, AdGroup type has to use a type defined in
     * `campaign.video_campaign_settings.video_ad_sequence`.
     *
     * Generated from protobuf enum <code>INVALID_AD_GROUP_TYPE_FOR_VIDEO_ADS_SEQUENCING = 21;</code>
     */
    const INVALID_AD_GROUP_TYPE_FOR_VIDEO_ADS_SEQUENCING = 21;
    /**
     * Only one AdGroup is allowed for each step ID in video ads sequencing.
     *
     * Generated from protobuf enum <code>DUPLICATE_STEP_ID = 22;</code>
     */
    const DUPLICATE_STEP_ID = 22;
    /**
     * At least one Vertical Ads format must be enabled for a campaign under
     * Travel Ads in Search Campaigns.
     *
     * Generated from protobuf enum <code>INVALID_VERTICAL_ADS_FORMAT_SETTING = 23;</code>
     */
    const INVALID_VERTICAL_ADS_FORMAT_SETTING = 23;
    /**
     * AI max setting must be enabled to enable Vertical Ads formats for a
     * campaign under Travel Ads in Search Campaigns.
     *
     * Generated from protobuf enum <code>VERTICAL_ADS_FORMAT_SETTING_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_AI_MAX = 24;</code>
     */
    const VERTICAL_ADS_FORMAT_SETTING_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_AI_MAX = 24;
    /**
     * An enabled travel feed must be linked to enable Vertical Ads formats for
     * a campaign under Travel Ads in Search Campaigns.
     *
     * Generated from protobuf enum <code>VERTICAL_ADS_FORMAT_SETTING_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_ENABLED_TRAVEL_FEED = 25;</code>
     */
    const VERTICAL_ADS_FORMAT_SETTING_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_ENABLED_TRAVEL_FEED = 25;
    ...
    private static $valueToName = [
        ...
        self::CANNOT_ADD_AD_GROUP_FOR_CAMPAIGN_TYPE => 'CANNOT_ADD_AD_GROUP_FOR_CAMPAIGN_TYPE',
        self::INVALID_STATUS => 'INVALID_STATUS',
        self::INVALID_STEP_ID_FOR_VIDEO_ADS_SEQUENCING => 'INVALID_STEP_ID_FOR_VIDEO_ADS_SEQUENCING',
        self::INVALID_AD_GROUP_TYPE_FOR_VIDEO_ADS_SEQUENCING => 'INVALID_AD_GROUP_TYPE_FOR_VIDEO_ADS_SEQUENCING',
        self::DUPLICATE_STEP_ID => 'DUPLICATE_STEP_ID',
        self::INVALID_VERTICAL_ADS_FORMAT_SETTING => 'INVALID_VERTICAL_ADS_FORMAT_SETTING',
        self::VERTICAL_ADS_FORMAT_SETTING_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_AI_MAX => 'VERTICAL_ADS_FORMAT_SETTING_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_AI_MAX',
        self::VERTICAL_ADS_FORMAT_SETTING_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_ENABLED_TRAVEL_FEED => 'VERTICAL_ADS_FORMAT_SETTING_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_ENABLED_TRAVEL_FEED',
    ];
