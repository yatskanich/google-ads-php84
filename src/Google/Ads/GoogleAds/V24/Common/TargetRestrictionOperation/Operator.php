...
namespace Google\Ads\GoogleAds\V24\Common\TargetRestrictionOperation;
 ...
 * The operator.
 *
 * Protobuf type <code>google.ads.googleads.v24.common.TargetRestrictionOperation.Operator</code>
 */
class Operator
{
    /**
