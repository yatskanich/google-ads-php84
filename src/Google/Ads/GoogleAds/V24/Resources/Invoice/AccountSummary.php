 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v24.resources.Invoice.AccountSummary</code>
 */
class AccountSummary extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional int64 export_charge_subtotal_amount_micros = 17 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $export_charge_subtotal_amount_micros = null;
    /**
     * Output only. Tax on export charge, in micros.
     *
     * Generated from protobuf field <code>optional int64 export_charge_tax_amount_micros = 18 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $export_charge_tax_amount_micros = null;
    /**
     * Output only. Total export charge amount, in micros.
     *
     * Generated from protobuf field <code>optional int64 export_charge_total_amount_micros = 19 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * account.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v24.resources.Invoice.RegulatoryCostSummary regulatory_cost_summaries = 20 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $regulatory_cost_summaries;
    /**
     * Output only. The list of adjustment information associated with this
     * account.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v24.resources.Invoice.AdjustmentSummary adjustment_summaries = 21 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $adjustment_summaries;
     ...
     *           period, in micros. This equals the sum of the subtotal_amount_micros and
     *           tax_amount_micros.
     *     @type \Google\Ads\GoogleAds\V24\Resources\Invoice\RegulatoryCostSummary[] $regulatory_cost_summaries
     *           Output only. The list of regulatory cost information associated with this
     *           account.
     *     @type \Google\Ads\GoogleAds\V24\Resources\Invoice\AdjustmentSummary[] $adjustment_summaries
     *           Output only. The list of adjustment information associated with this
     *           account.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v24.resources.Invoice.RegulatoryCostSummary regulatory_cost_summaries = 20 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V24\Resources\Invoice\RegulatoryCostSummary>
     */
    public function getRegulatoryCostSummaries()
    {
        return $this->regulatory_cost_summaries;
    }
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v24.resources.Invoice.RegulatoryCostSummary regulatory_cost_summaries = 20 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V24\Resources\Invoice\RegulatoryCostSummary[] $var
     * @return $this
     */
    public function setRegulatoryCostSummaries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V24\Resources\Invoice\RegulatoryCostSummary::class);
        $this->regulatory_cost_summaries = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v24.resources.Invoice.AdjustmentSummary adjustment_summaries = 21 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V24\Resources\Invoice\AdjustmentSummary>
     */
    public function getAdjustmentSummaries()
    {
        return $this->adjustment_summaries;
    }
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v24.resources.Invoice.AdjustmentSummary adjustment_summaries = 21 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V24\Resources\Invoice\AdjustmentSummary[] $var
     * @return $this
     */
    public function setAdjustmentSummaries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V24\Resources\Invoice\AdjustmentSummary::class);
        $this->adjustment_summaries = $arr;
