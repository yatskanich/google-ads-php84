 ...
 * {-- next tag to use: 5 --}
 *
 * Generated from protobuf message <code>google.ads.googleads.v24.resources.VideoEnhancement</code>
 */
class VideoEnhancement extends \Google\Protobuf\Internal\Message
{
     ...
     * Ads).
     *
     * Generated from protobuf field <code>.google.ads.googleads.v24.enums.VideoEnhancementSourceEnum.VideoEnhancementSource source = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $source = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V24\Resources\VideoEnhancement::initOnce();
