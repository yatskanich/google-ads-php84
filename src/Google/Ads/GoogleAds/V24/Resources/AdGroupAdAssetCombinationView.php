...
# source: google/ads/googleads/v24/resources/ad_group_ad_asset_combination_view.proto
 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v24.resources.AdGroupAdAssetCombinationView</code>
 */
class AdGroupAdAssetCombinationView extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v24.common.AssetUsage served_assets = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           AdGroupAd Asset Combination view resource names have the form:
     *           `customers/{customer_id}/adGroupAdAssetCombinationViews/{AdGroupAd.ad_group_id}~{AdGroupAd.ad.ad_id}~{AssetCombination.asset_combination_id_low}~{AssetCombination.asset_combination_id_high}`
     *     @type \Google\Ads\GoogleAds\V24\Common\AssetUsage[] $served_assets
     *           Output only. Served assets.
     *     @type bool $enabled
     *           Output only. The status between the asset combination and the latest
     *           version of the ad. If true, the asset combination is linked to the latest
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V24\Resources\AdGroupAdAssetCombinationView::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v24.common.AssetUsage served_assets = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V24\Common\AssetUsage>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v24.common.AssetUsage served_assets = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V24\Common\AssetUsage[] $var
     * @return $this
     */
    public function setServedAssets($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V24\Common\AssetUsage::class);
