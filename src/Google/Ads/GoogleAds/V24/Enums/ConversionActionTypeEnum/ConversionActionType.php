...
namespace Google\Ads\GoogleAds\V24\Enums\ConversionActionTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v24.enums.ConversionActionTypeEnum.ConversionActionType</code>
 */
class ConversionActionType
{
     ...
     */
    const GOOGLE_ANALYTICS_4_CLOSE_CONVERT_LEAD = 44;
    /**
     * Conversions that come from linked Firebase Android generate lead
     * conversions.
     *
     * Generated from protobuf enum <code>FIREBASE_ANDROID_GENERATE_LEAD = 45;</code>
     */
    const FIREBASE_ANDROID_GENERATE_LEAD = 45;
    /**
     * Conversions that come from linked Firebase Android qualify lead
     * conversions.
     *
     * Generated from protobuf enum <code>FIREBASE_ANDROID_QUALIFY_LEAD = 46;</code>
     */
    const FIREBASE_ANDROID_QUALIFY_LEAD = 46;
    /**
     * Conversions that come from linked Firebase Android close convert lead
     * conversions.
     *
     * Generated from protobuf enum <code>FIREBASE_ANDROID_CLOSE_CONVERT_LEAD = 47;</code>
     */
    const FIREBASE_ANDROID_CLOSE_CONVERT_LEAD = 47;
    /**
     * Conversions that come from linked Firebase iOS generate lead
     * conversions.
     *
     * Generated from protobuf enum <code>FIREBASE_IOS_GENERATE_LEAD = 48;</code>
     */
    const FIREBASE_IOS_GENERATE_LEAD = 48;
    /**
     * Conversions that come from linked Firebase iOS qualify lead
     * conversions.
     *
     * Generated from protobuf enum <code>FIREBASE_IOS_QUALIFY_LEAD = 49;</code>
     */
    const FIREBASE_IOS_QUALIFY_LEAD = 49;
    /**
     * Conversions that come from linked Firebase iOS close convert lead
     * conversions.
     *
    ...
    private static $valueToName = [
        ...
        self::GOOGLE_ANALYTICS_4_GENERATE_LEAD => 'GOOGLE_ANALYTICS_4_GENERATE_LEAD',
        self::GOOGLE_ANALYTICS_4_QUALIFY_LEAD => 'GOOGLE_ANALYTICS_4_QUALIFY_LEAD',
        self::GOOGLE_ANALYTICS_4_CLOSE_CONVERT_LEAD => 'GOOGLE_ANALYTICS_4_CLOSE_CONVERT_LEAD',
        self::FIREBASE_ANDROID_GENERATE_LEAD => 'FIREBASE_ANDROID_GENERATE_LEAD',
        self::FIREBASE_ANDROID_QUALIFY_LEAD => 'FIREBASE_ANDROID_QUALIFY_LEAD',
        self::FIREBASE_ANDROID_CLOSE_CONVERT_LEAD => 'FIREBASE_ANDROID_CLOSE_CONVERT_LEAD',
