...
namespace Google\Ads\GoogleAds\V24\Enums\AppCampaignBiddingStrategyGoalTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v24.enums.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalType</code>
 */
class AppCampaignBiddingStrategyGoalType
{
     ...
     *
     * Generated from protobuf enum <code>OPTIMIZE_IN_APP_CONVERSIONS_WITHOUT_TARGET_CPA = 8;</code>
     */
    const OPTIMIZE_IN_APP_CONVERSIONS_WITHOUT_TARGET_CPA = 8;
    /**
     ...
     *
     * Generated from protobuf enum <code>OPTIMIZE_TOTAL_VALUE_WITHOUT_TARGET_ROAS = 9;</code>
     */
    const OPTIMIZE_TOTAL_VALUE_WITHOUT_TARGET_ROAS = 9;
    ...
    private static $valueToName = [
        ...
        self::OPTIMIZE_IN_APP_CONVERSIONS_WITHOUT_TARGET_CPA => 'OPTIMIZE_IN_APP_CONVERSIONS_WITHOUT_TARGET_CPA',
        self::OPTIMIZE_TOTAL_VALUE_WITHOUT_TARGET_ROAS => 'OPTIMIZE_TOTAL_VALUE_WITHOUT_TARGET_ROAS',
    ];
