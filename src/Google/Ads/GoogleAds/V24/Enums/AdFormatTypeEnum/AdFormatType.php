...
namespace Google\Ads\GoogleAds\V24\Enums\AdFormatTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v24.enums.AdFormatTypeEnum.AdFormatType</code>
 */
class AdFormatType
{
    /**
     ...
     *
     * Generated from protobuf enum <code>PAUSE = 12;</code>
     */
    const PAUSE = 12;
    /**
     ...
     *
     * Generated from protobuf enum <code>VERTICAL_ADS_PROMOTION = 13;</code>
     */
    const VERTICAL_ADS_PROMOTION = 13;
    /**
     * An ad format for a booking link call-to-action within a vertical ad, for
     * example a 'Book Now' link for a hotel ad.
     *
     * Generated from protobuf enum <code>VERTICAL_ADS_BOOKING_LINK = 14;</code>
     */
    const VERTICAL_ADS_BOOKING_LINK = 14;
    /**
     * A standard text ad format. This is currently only used for ads on the
     * Search network.
     *
     * Generated from protobuf enum <code>TEXT = 15;</code>
     */
    const TEXT = 15;
    ...
    private static $valueToName = [
        ...
        self::SHORTS => 'SHORTS',
        self::PAUSE => 'PAUSE',
        self::VERTICAL_ADS_PROMOTION => 'VERTICAL_ADS_PROMOTION',
        self::VERTICAL_ADS_BOOKING_LINK => 'VERTICAL_ADS_BOOKING_LINK',
        self::TEXT => 'TEXT',
    ];
