...
# source: google/ads/googleads/v24/enums/resource_limit_type.proto

namespace Google\Ads\GoogleAds\V24\Enums\ResourceLimitTypeEnum;
 ...
 * Resource limit type.
 *
 * Protobuf type <code>google.ads.googleads.v24.enums.ResourceLimitTypeEnum.ResourceLimitType</code>
 */
class ResourceLimitType
{
     ...
     *
     * Generated from protobuf enum <code>BUSINESS_MESSAGE_ASSET_LINKS_PER_CUSTOMER = 188;</code>
     */
    const BUSINESS_MESSAGE_ASSET_LINKS_PER_CUSTOMER = 188;
    /**
     * Maximum number of active WhatsApp business message asset links at
     * campaign level.
     *
     * Generated from protobuf enum <code>WHATSAPP_BUSINESS_MESSAGE_ASSET_LINKS_PER_CAMPAIGN = 189;</code>
     */
    const WHATSAPP_BUSINESS_MESSAGE_ASSET_LINKS_PER_CAMPAIGN = 189;
    /**
     * Maximum number of active WhatsApp business message asset links at ad
     * group level.
     *
     * Generated from protobuf enum <code>WHATSAPP_BUSINESS_MESSAGE_ASSET_LINKS_PER_AD_GROUP = 190;</code>
     */
    const WHATSAPP_BUSINESS_MESSAGE_ASSET_LINKS_PER_AD_GROUP = 190;
    /**
     * Number of ENABLED brand list criteria per ad group.
     *
     * Generated from protobuf enum <code>BRAND_LIST_CRITERIA_PER_AD_GROUP = 193;</code>
     */
    const BRAND_LIST_CRITERIA_PER_AD_GROUP = 193;
    ...
    private static $valueToName = [
        ...
        self::BUSINESS_MESSAGE_ASSET_LINKS_PER_CUSTOMER => 'BUSINESS_MESSAGE_ASSET_LINKS_PER_CUSTOMER',
        self::WHATSAPP_BUSINESS_MESSAGE_ASSET_LINKS_PER_CAMPAIGN => 'WHATSAPP_BUSINESS_MESSAGE_ASSET_LINKS_PER_CAMPAIGN',
        self::WHATSAPP_BUSINESS_MESSAGE_ASSET_LINKS_PER_AD_GROUP => 'WHATSAPP_BUSINESS_MESSAGE_ASSET_LINKS_PER_AD_GROUP',
        self::BRAND_LIST_CRITERIA_PER_AD_GROUP => 'BRAND_LIST_CRITERIA_PER_AD_GROUP',
    ];
