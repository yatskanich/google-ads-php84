...
class PaymentsAccountServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V24\Services\ListPaymentsAccountsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V24\Services\ListPaymentsAccountsResponse>
     */
    public function ListPaymentsAccounts(\Google\Ads\GoogleAds\V24\Services\ListPaymentsAccountsRequest $argument,
      $metadata = [], $options = []) {
