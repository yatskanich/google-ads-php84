...
return [
    'interfaces' => [
        'google.ads.googleads.v24.services.AssetGroupListingGroupFilterService' => [
            'MutateAssetGroupListingGroupFilters' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V24\Services\MutateAssetGroupListingGroupFiltersResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
