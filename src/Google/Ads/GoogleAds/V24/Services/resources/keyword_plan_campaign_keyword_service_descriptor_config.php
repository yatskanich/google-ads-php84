...
return [
    'interfaces' => [
        'google.ads.googleads.v24.services.KeywordPlanCampaignKeywordService' => [
            'MutateKeywordPlanCampaignKeywords' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V24\Services\MutateKeywordPlanCampaignKeywordsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
