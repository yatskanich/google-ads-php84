...
class RemarketingActionServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V24\Services\MutateRemarketingActionsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V24\Services\MutateRemarketingActionsResponse>
     */
    public function MutateRemarketingActions(\Google\Ads\GoogleAds\V24\Services\MutateRemarketingActionsRequest $argument,
      $metadata = [], $options = []) {
