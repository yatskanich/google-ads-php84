...
class SmartCampaignSuggestServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V24\Services\SuggestSmartCampaignBudgetOptionsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V24\Services\SuggestSmartCampaignBudgetOptionsResponse>
     */
    public function SuggestSmartCampaignBudgetOptions(\Google\Ads\GoogleAds\V24\Services\SuggestSmartCampaignBudgetOptionsRequest $argument,
      $metadata = [], $options = []) {
     ...
     * @param \Google\Ads\GoogleAds\V24\Services\SuggestSmartCampaignAdRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V24\Services\SuggestSmartCampaignAdResponse>
     */
    public function SuggestSmartCampaignAd(\Google\Ads\GoogleAds\V24\Services\SuggestSmartCampaignAdRequest $argument,
      $metadata = [], $options = []) {
     ...
     * @param \Google\Ads\GoogleAds\V24\Services\SuggestKeywordThemesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V24\Services\SuggestKeywordThemesResponse>
     */
    public function SuggestKeywordThemes(\Google\Ads\GoogleAds\V24\Services\SuggestKeywordThemesRequest $argument,
      $metadata = [], $options = []) {
