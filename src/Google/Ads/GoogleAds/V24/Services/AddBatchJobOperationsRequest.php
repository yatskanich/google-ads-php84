...
/**
 * Request message for
 * [BatchJobService.AddBatchJobOperations][google.ads.googleads.v24.services.BatchJobService.AddBatchJobOperations].
 *
 * Generated from protobuf message <code>google.ads.googleads.v24.services.AddBatchJobOperationsRequest</code>
 */
class AddBatchJobOperationsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v24.services.MutateOperation mutate_operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *                                                                               next_sequence_token received in the previous AddBatchJobOperations
     *                                                                               response.
     * @param \Google\Ads\GoogleAds\V24\Services\MutateOperation[] $mutateOperations Required. The list of mutates being added.
     *
     *                                                                               Operations can use negative integers as temp ids to signify dependencies
     *                                                                               between entities created in this batch job. For example, a customer with
     *                                                                               id = 1234 can create a campaign and an ad group in that same campaign by
     ...
     *                                                                               "customers/1234/campaigns/-1".
     *
     * @return \Google\Ads\GoogleAds\V24\Services\AddBatchJobOperationsRequest
     *
     * @experimental
     */
     ...
     *           next_sequence_token received in the previous AddBatchJobOperations
     *           response.
     *     @type \Google\Ads\GoogleAds\V24\Services\MutateOperation[] $mutate_operations
     *           Required. The list of mutates being added.
     *           Operations can use negative integers as temp ids to signify dependencies
     *           between entities created in this batch job. For example, a customer with
     *           id = 1234 can create a campaign and an ad group in that same campaign by
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v24.services.MutateOperation mutate_operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V24\Services\MutateOperation>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v24.services.MutateOperation mutate_operations = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V24\Services\MutateOperation[] $var
     * @return $this
     */
    public function setMutateOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V24\Services\MutateOperation::class);
