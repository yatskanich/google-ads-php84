...
class KeywordPlanAdGroupKeywordServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V24\Services\MutateKeywordPlanAdGroupKeywordsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V24\Services\MutateKeywordPlanAdGroupKeywordsResponse>
     */
    public function MutateKeywordPlanAdGroupKeywords(\Google\Ads\GoogleAds\V24\Services\MutateKeywordPlanAdGroupKeywordsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v24.services.KeywordPlanAdGroupKeywordService/MutateKeywordPlanAdGroupKeywords',
        $argument,
        [\Google\Ads\GoogleAds\V24\Services\MutateKeywordPlanAdGroupKeywordsResponse::class, 'decode'],
        $metadata, $options);
    }
