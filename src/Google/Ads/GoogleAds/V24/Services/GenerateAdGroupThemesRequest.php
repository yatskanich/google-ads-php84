...
/**
 * Request message for
 * [KeywordPlanIdeaService.GenerateAdGroupThemes][google.ads.googleads.v24.services.KeywordPlanIdeaService.GenerateAdGroupThemes].
 *
 * Generated from protobuf message <code>google.ads.googleads.v24.services.GenerateAdGroupThemesRequest</code>
 */
class GenerateAdGroupThemesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param string[] $keywords   Required. A list of keywords to group into the provided AdGroups.
     * @param string[] $adGroups   Required. A list of resource names of AdGroups to group keywords into.
     *                             Resource name format: `customers/{customer_id}/adGroups/{ad_group_id}`
     *
     * @return \Google\Ads\GoogleAds\V24\Services\GenerateAdGroupThemesRequest
     *
     * @experimental
     */
