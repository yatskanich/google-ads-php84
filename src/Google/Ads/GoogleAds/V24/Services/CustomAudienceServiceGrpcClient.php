...
class CustomAudienceServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V24\Services\MutateCustomAudiencesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V24\Services\MutateCustomAudiencesResponse>
     */
    public function MutateCustomAudiences(\Google\Ads\GoogleAds\V24\Services\MutateCustomAudiencesRequest $argument,
      $metadata = [], $options = []) {
