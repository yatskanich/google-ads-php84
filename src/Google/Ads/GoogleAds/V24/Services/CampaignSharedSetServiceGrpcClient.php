...
class CampaignSharedSetServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringFormatError]()
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V24\Services\MutateCampaignSharedSetsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V24\Services\MutateCampaignSharedSetsResponse>
     */
    public function MutateCampaignSharedSets(\Google\Ads\GoogleAds\V24\Services\MutateCampaignSharedSetsRequest $argument,
      $metadata = [], $options = []) {
