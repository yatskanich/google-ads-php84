...
class OfflineUserDataJobServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V24\Services\CreateOfflineUserDataJobRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V24\Services\CreateOfflineUserDataJobResponse>
     */
    public function CreateOfflineUserDataJob(\Google\Ads\GoogleAds\V24\Services\CreateOfflineUserDataJobRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V24\Services\AddOfflineUserDataJobOperationsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V24\Services\AddOfflineUserDataJobOperationsResponse>
     */
    public function AddOfflineUserDataJobOperations(\Google\Ads\GoogleAds\V24\Services\AddOfflineUserDataJobOperationsRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V24\Services\RunOfflineUserDataJobRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\LongRunning\Operation>
     */
    public function RunOfflineUserDataJob(\Google\Ads\GoogleAds\V24\Services\RunOfflineUserDataJobRequest $argument,
      $metadata = [], $options = []) {
