...
/**
 * Request message for
 * [AudienceInsightsService.GenerateInsightsFinderReport][google.ads.googleads.v24.services.AudienceInsightsService.GenerateInsightsFinderReport].
 *
 * Generated from protobuf message <code>google.ads.googleads.v24.services.GenerateInsightsFinderReportRequest</code>
 */
class GenerateInsightsFinderReportRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * region.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v24.services.InsightsAudience baseline_audience = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v24.services.InsightsAudience specific_audience = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v24.common.AdditionalApplicationInfo insights_application_info = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $insights_application_info = null;

    /**
     * @param string                                              $customerId       Required. The ID of the customer.
     * @param \Google\Ads\GoogleAds\V24\Services\InsightsAudience $baselineAudience Required. A baseline audience for this report, typically all people in a
     *                                                                              region.
     * @param \Google\Ads\GoogleAds\V24\Services\InsightsAudience $specificAudience Required. The specific audience of interest for this report.  The insights
     *                                                                              in the report will be based on attributes more prevalent in this audience
     *                                                                              than in the report's baseline audience.
     *
     * @return \Google\Ads\GoogleAds\V24\Services\GenerateInsightsFinderReportRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer.
     *     @type \Google\Ads\GoogleAds\V24\Services\InsightsAudience $baseline_audience
     *           Required. A baseline audience for this report, typically all people in a
     *           region.
     *     @type \Google\Ads\GoogleAds\V24\Services\InsightsAudience $specific_audience
     *           Required. The specific audience of interest for this report.  The insights
     *           in the report will be based on attributes more prevalent in this audience
     *           than in the report's baseline audience.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v24.services.InsightsAudience baseline_audience = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V24\Services\InsightsAudience|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v24.services.InsightsAudience baseline_audience = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V24\Services\InsightsAudience $var
     * @return $this
     */
    public function setBaselineAudience($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V24\Services\InsightsAudience::class);
