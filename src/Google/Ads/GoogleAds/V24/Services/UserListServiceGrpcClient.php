...
class UserListServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringLengthError]()
     *   [UserListError]()
     * @param \Google\Ads\GoogleAds\V24\Services\MutateUserListsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V24\Services\MutateUserListsResponse>
     */
    public function MutateUserLists(\Google\Ads\GoogleAds\V24\Services\MutateUserListsRequest $argument,
      $metadata = [], $options = []) {
