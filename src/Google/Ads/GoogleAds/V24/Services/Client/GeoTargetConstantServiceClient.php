 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v24/services/geo_target_constant_service.proto
...
use Google\Ads\GoogleAds\V24\Services\SuggestGeoTargetConstantsResponse;
 ...
 *
 * @method PromiseInterface<SuggestGeoTargetConstantsResponse> suggestGeoTargetConstantsAsync(SuggestGeoTargetConstantsRequest $request, array $optionalArgs = [])
 */
class GeoTargetConstantServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v24.services.GeoTargetConstantService';
     ...
     *           use Google\Ads\GoogleAds\V24\Services\GeoTargetConstantServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new GeoTargetConstantServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function suggestGeoTargetConstants(SuggestGeoTargetConstantsRequest $request, array $callOptions = []): SuggestGeoTargetConstantsResponse
    {
        return $this->startApiCall('SuggestGeoTargetConstants', $request, $callOptions)->wait();
    }
}
