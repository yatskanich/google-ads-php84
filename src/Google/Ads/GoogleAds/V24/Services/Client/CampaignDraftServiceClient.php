 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v24/services/campaign_draft_service.proto
...
class CampaignDraftServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v24.services.CampaignDraftService';
     ...
     *           use Google\Ads\GoogleAds\V24\Services\CampaignDraftServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CampaignDraftServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
