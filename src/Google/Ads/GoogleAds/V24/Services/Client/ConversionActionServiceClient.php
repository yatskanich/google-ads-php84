 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v24/services/conversion_action_service.proto
 ...
 *
 * @method PromiseInterface<MutateConversionActionsResponse> mutateConversionActionsAsync(MutateConversionActionsRequest $request, array $optionalArgs = [])
 */
class ConversionActionServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v24.services.ConversionActionService';
     ...
     *           use Google\Ads\GoogleAds\V24\Services\ConversionActionServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ConversionActionServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function mutateConversionActions(MutateConversionActionsRequest $request, array $callOptions = []): MutateConversionActionsResponse
    {
        return $this->startApiCall('MutateConversionActions', $request, $callOptions)->wait();
    }
}
