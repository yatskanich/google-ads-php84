 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v24/services/conversion_upload_service.proto
 ...
 *
 * @method PromiseInterface<UploadCallConversionsResponse> uploadCallConversionsAsync(UploadCallConversionsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<UploadClickConversionsResponse> uploadClickConversionsAsync(UploadClickConversionsRequest $request, array $optionalArgs = [])
 */
class ConversionUploadServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v24.services.ConversionUploadService';
     ...
     *           use Google\Ads\GoogleAds\V24\Services\ConversionUploadServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ConversionUploadServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return UploadCallConversionsResponse
     *
