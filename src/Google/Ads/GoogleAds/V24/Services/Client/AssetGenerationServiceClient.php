 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v24/services/asset_generation_service.proto
 ...
 *
 * @method PromiseInterface<GenerateImagesResponse> generateImagesAsync(GenerateImagesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<GenerateTextResponse> generateTextAsync(GenerateTextRequest $request, array $optionalArgs = [])
 */
class AssetGenerationServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v24.services.AssetGenerationService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/asset_generation_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/asset_generation_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/asset_generation_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/asset_generation_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V24\Services\AssetGenerationServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AssetGenerationServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function generateImages(GenerateImagesRequest $request, array $callOptions = []): GenerateImagesResponse
    {
        return $this->startApiCall('GenerateImages', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function generateText(GenerateTextRequest $request, array $callOptions = []): GenerateTextResponse
    {
        return $this->startApiCall('GenerateText', $request, $callOptions)->wait();
    }
}
