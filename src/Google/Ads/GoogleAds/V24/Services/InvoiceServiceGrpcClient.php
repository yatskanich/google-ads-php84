...
class InvoiceServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V24\Services\ListInvoicesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V24\Services\ListInvoicesResponse>
     */
    public function ListInvoices(\Google\Ads\GoogleAds\V24\Services\ListInvoicesRequest $argument,
      $metadata = [], $options = []) {
