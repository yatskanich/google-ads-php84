...
class KeywordPlanServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V24\Services\MutateKeywordPlansRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V24\Services\MutateKeywordPlansResponse>
     */
    public function MutateKeywordPlans(\Google\Ads\GoogleAds\V24\Services\MutateKeywordPlansRequest $argument,
      $metadata = [], $options = []) {
