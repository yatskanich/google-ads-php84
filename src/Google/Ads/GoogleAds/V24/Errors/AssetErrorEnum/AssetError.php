...
namespace Google\Ads\GoogleAds\V24\Errors\AssetErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v24.errors.AssetErrorEnum.AssetError</code>
 */
class AssetError
{
    /**
     ...
     *
     * Generated from protobuf enum <code>PROMOTION_BARCODE_CANNOT_CONTAIN_LINKS = 41;</code>
     */
    const PROMOTION_BARCODE_CANNOT_CONTAIN_LINKS = 41;
    /**
     * Failed to encode promotion barcode: Invalid format.
     *
     * Generated from protobuf enum <code>PROMOTION_BARCODE_INVALID_FORMAT = 42;</code>
     */
    const PROMOTION_BARCODE_INVALID_FORMAT = 42;
    /**
     * Barcode type is not supported.
     *
     * Generated from protobuf enum <code>UNSUPPORTED_BARCODE_TYPE = 43;</code>
     */
    const UNSUPPORTED_BARCODE_TYPE = 43;
    /**
     * Promotion QR code cannot contain links.
     *
     * Generated from protobuf enum <code>PROMOTION_QR_CODE_CANNOT_CONTAIN_LINKS = 44;</code>
     */
    const PROMOTION_QR_CODE_CANNOT_CONTAIN_LINKS = 44;
    /**
     * Failed to encode promotion QR code: Invalid format.
     *
     * Generated from protobuf enum <code>PROMOTION_QR_CODE_INVALID_FORMAT = 45;</code>
     */
    const PROMOTION_QR_CODE_INVALID_FORMAT = 45;
    /**
     * The customer is not in the allow-list for Business message asset type.
     *
     * Generated from protobuf enum <code>CUSTOMER_NOT_ON_ALLOWLIST_FOR_MESSAGE_ASSETS = 46;</code>
     */
    const CUSTOMER_NOT_ON_ALLOWLIST_FOR_MESSAGE_ASSETS = 46;
    ...
    private static $valueToName = [
        ...
        self::PROMOTION_BARCODE_CANNOT_CONTAIN_LINKS => 'PROMOTION_BARCODE_CANNOT_CONTAIN_LINKS',
        self::PROMOTION_BARCODE_INVALID_FORMAT => 'PROMOTION_BARCODE_INVALID_FORMAT',
        self::UNSUPPORTED_BARCODE_TYPE => 'UNSUPPORTED_BARCODE_TYPE',
        self::PROMOTION_QR_CODE_CANNOT_CONTAIN_LINKS => 'PROMOTION_QR_CODE_CANNOT_CONTAIN_LINKS',
        self::PROMOTION_QR_CODE_INVALID_FORMAT => 'PROMOTION_QR_CODE_INVALID_FORMAT',
        self::CUSTOMER_NOT_ON_ALLOWLIST_FOR_MESSAGE_ASSETS => 'CUSTOMER_NOT_ON_ALLOWLIST_FOR_MESSAGE_ASSETS',
    ];
