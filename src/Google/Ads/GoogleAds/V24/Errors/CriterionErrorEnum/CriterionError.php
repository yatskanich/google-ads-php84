...
# source: google/ads/googleads/v24/errors/criterion_error.proto

namespace Google\Ads\GoogleAds\V24\Errors\CriterionErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v24.errors.CriterionErrorEnum.CriterionError</code>
 */
class CriterionError
{
     ...
     *
     * Generated from protobuf enum <code>LISTING_GROUP_ERROR_IN_ANOTHER_OPERATION = 169;</code>
     */
    const LISTING_GROUP_ERROR_IN_ANOTHER_OPERATION = 169;
    /**
     ...
     *
     * Generated from protobuf enum <code>LISTING_GROUP_TREE_WAS_INVALID_BEFORE_MUTATION = 170;</code>
     */
    const LISTING_GROUP_TREE_WAS_INVALID_BEFORE_MUTATION = 170;
    /**
     ...
     * valid brand.
     *
     * Generated from protobuf enum <code>CANNOT_RECOGNIZE_BRAND = 155;</code>
     */
    const CANNOT_RECOGNIZE_BRAND = 155;
    /**
     * The brand_list.shared_set_id references a shared set that does not
     * exist.
     *
     * Generated from protobuf enum <code>BRAND_SHARED_SET_DOES_NOT_EXIST = 156;</code>
     */
    const BRAND_SHARED_SET_DOES_NOT_EXIST = 156;
    /**
     * Cannot create a brand list with deleted shared set.
     *
     * Generated from protobuf enum <code>CANNOT_ADD_REMOVED_BRAND_SHARED_SET = 157;</code>
     */
    const CANNOT_ADD_REMOVED_BRAND_SHARED_SET = 157;
    /**
     ...
     *
     * Generated from protobuf enum <code>ONLY_INCLUSION_BRAND_LIST_ALLOWED_FOR_AD_GROUPS = 171;</code>
     */
    const ONLY_INCLUSION_BRAND_LIST_ALLOWED_FOR_AD_GROUPS = 171;
    /**
     * Cannot create a placement list with deleted shared set.
     *
     * Generated from protobuf enum <code>CANNOT_ADD_REMOVED_PLACEMENT_LIST_SHARED_SET = 172;</code>
     */
    const CANNOT_ADD_REMOVED_PLACEMENT_LIST_SHARED_SET = 172;
    /**
     * The placement_list.shared_set_id references a shared set that does not
     * exist.
     *
     * Generated from protobuf enum <code>PLACEMENT_LIST_SHARED_SET_DOES_NOT_EXIST = 173;</code>
     */
    const PLACEMENT_LIST_SHARED_SET_DOES_NOT_EXIST = 173;
    /**
     * This feature is only available for AI Max campaigns.
     *
     * Generated from protobuf enum <code>AI_MAX_MUST_BE_ENABLED = 174;</code>
     */
    const AI_MAX_MUST_BE_ENABLED = 174;
    /**
     * This feature is not available for AI Max campaigns.
     *
     * Generated from protobuf enum <code>NOT_AVAILABLE_FOR_AI_MAX_CAMPAIGNS = 175;</code>
     */
    const NOT_AVAILABLE_FOR_AI_MAX_CAMPAIGNS = 175;
    /**
     ...
     *
     * Generated from protobuf enum <code>INVALID_CAMPAIGN_TYPE_FOR_THIRD_PARTY_PARTNER_DATA_LIST = 177;</code>
     */
    const INVALID_CAMPAIGN_TYPE_FOR_THIRD_PARTY_PARTNER_DATA_LIST = 177;
    /**
     * The user list cannot be used while it is pending privacy review.
     *
     * Generated from protobuf enum <code>CANNOT_ADD_USER_LIST_PENDING_PRIVACY_REVIEW = 178;</code>
     */
    const CANNOT_ADD_USER_LIST_PENDING_PRIVACY_REVIEW = 178;
    /**
     * The referenced Vertical Ads item group rule list shared set does not
     * exist.
     *
     * Generated from protobuf enum <code>VERTICAL_ADS_ITEM_GROUP_RULE_LIST_DOES_NOT_EXIST = 179;</code>
     */
    const VERTICAL_ADS_ITEM_GROUP_RULE_LIST_DOES_NOT_EXIST = 179;
    /**
     * Cannot add Vertical Ads Item Group Rule List with deleted shared set.
     *
     * Generated from protobuf enum <code>CANNOT_ADD_REMOVED_VERTICAL_ADS_ITEM_GROUP_RULE_LIST_SHARED_SET = 180;</code>
     */
    const CANNOT_ADD_REMOVED_VERTICAL_ADS_ITEM_GROUP_RULE_LIST_SHARED_SET = 180;
    /**
     * Vertical Ads Item Group Rule List is not supported for campaigns that do
     * not have an active travel feed.
     *
     * Generated from protobuf enum <code>VERTICAL_ADS_ITEM_GROUP_RULE_LIST_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_ENABLED_TRAVEL_FEED = 181;</code>
     */
    const VERTICAL_ADS_ITEM_GROUP_RULE_LIST_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_ENABLED_TRAVEL_FEED = 181;
    /**
     * Vertical Ads Item Group Rule List is not supported for campaigns that do
     * not have AI max enabled.
     *
     * Generated from protobuf enum <code>VERTICAL_ADS_ITEM_GROUP_RULE_LIST_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_AI_MAX = 182;</code>
     */
    const VERTICAL_ADS_ITEM_GROUP_RULE_LIST_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_AI_MAX = 182;
    /**
     * The dimension of the Vertical Ads Item Group Rule criterion is not
     * supported for the shared set vertical type.
     *
     * Generated from protobuf enum <code>VERTICAL_ADS_ITEM_GROUP_RULE_NOT_SUPPORTED_FOR_THE_VERTICAL_TYPE = 183;</code>
     */
    const VERTICAL_ADS_ITEM_GROUP_RULE_NOT_SUPPORTED_FOR_THE_VERTICAL_TYPE = 183;
    /**
     * A RetailTag references a RetailFilterExpression name that does not exist.
     *
     * Generated from protobuf enum <code>RETAIL_FILTER_EXPRESSION_DOES_NOT_EXIST = 184;</code>
     */
    const RETAIL_FILTER_EXPRESSION_DOES_NOT_EXIST = 184;
    /**
     * A RetailFilterExpression cannot be removed as it is still referenced by
     * Tags.
     *
    ...
    private static $valueToName = [
        ...
        self::LISTING_GROUP_ERROR_IN_ANOTHER_OPERATION => 'LISTING_GROUP_ERROR_IN_ANOTHER_OPERATION',
        self::INVALID_LISTING_GROUP_HIERARCHY => 'INVALID_LISTING_GROUP_HIERARCHY',
        self::LISTING_GROUP_TREE_WAS_INVALID_BEFORE_MUTATION => 'LISTING_GROUP_TREE_WAS_INVALID_BEFORE_MUTATION',
        ...
        self::CANNOT_RECOGNIZE_BRAND => 'CANNOT_RECOGNIZE_BRAND',
        ...
        self::PLACEMENT_LIST_SHARED_SET_DOES_NOT_EXIST => 'PLACEMENT_LIST_SHARED_SET_DOES_NOT_EXIST',
        self::AI_MAX_MUST_BE_ENABLED => 'AI_MAX_MUST_BE_ENABLED',
        self::NOT_AVAILABLE_FOR_AI_MAX_CAMPAIGNS => 'NOT_AVAILABLE_FOR_AI_MAX_CAMPAIGNS',
        self::MISSING_EU_POLITICAL_ADVERTISING_SELF_DECLARATION => 'MISSING_EU_POLITICAL_ADVERTISING_SELF_DECLARATION',
        self::INVALID_CAMPAIGN_TYPE_FOR_THIRD_PARTY_PARTNER_DATA_LIST => 'INVALID_CAMPAIGN_TYPE_FOR_THIRD_PARTY_PARTNER_DATA_LIST',
        self::CANNOT_ADD_USER_LIST_PENDING_PRIVACY_REVIEW => 'CANNOT_ADD_USER_LIST_PENDING_PRIVACY_REVIEW',
        self::VERTICAL_ADS_ITEM_GROUP_RULE_LIST_DOES_NOT_EXIST => 'VERTICAL_ADS_ITEM_GROUP_RULE_LIST_DOES_NOT_EXIST',
        self::CANNOT_ADD_REMOVED_VERTICAL_ADS_ITEM_GROUP_RULE_LIST_SHARED_SET => 'CANNOT_ADD_REMOVED_VERTICAL_ADS_ITEM_GROUP_RULE_LIST_SHARED_SET',
        self::VERTICAL_ADS_ITEM_GROUP_RULE_LIST_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_ENABLED_TRAVEL_FEED => 'VERTICAL_ADS_ITEM_GROUP_RULE_LIST_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_ENABLED_TRAVEL_FEED',
        self::VERTICAL_ADS_ITEM_GROUP_RULE_LIST_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_AI_MAX => 'VERTICAL_ADS_ITEM_GROUP_RULE_LIST_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_AI_MAX',
