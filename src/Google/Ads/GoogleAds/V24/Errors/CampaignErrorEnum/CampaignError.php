...
# source: google/ads/googleads/v24/errors/campaign_error.proto

namespace Google\Ads\GoogleAds\V24\Errors\CampaignErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v24.errors.CampaignErrorEnum.CampaignError</code>
 */
class CampaignError
{
    /**
     ...
     *
     * Generated from protobuf enum <code>THIRD_PARTY_INTEGRATION_PARTNER_NOT_ALLOWED = 105;</code>
     */
    const THIRD_PARTY_INTEGRATION_PARTNER_NOT_ALLOWED = 105;
    /**
     * Campaign third-party integration partners are not allowed to share cost
     * if it is not enabled at the customer level.
     *
     * Generated from protobuf enum <code>THIRD_PARTY_INTEGRATION_PARTNER_SHARE_COST_NOT_ALLOWED = 106;</code>
     */
    const THIRD_PARTY_INTEGRATION_PARTNER_SHARE_COST_NOT_ALLOWED = 106;
    /**
     * Each `previous_step_interaction_type` can be used at most once for the
     * same `previous_step_id`
     *
     * Generated from protobuf enum <code>DUPLICATE_INTERACTION_TYPE = 107;</code>
     */
    const DUPLICATE_INTERACTION_TYPE = 107;
    /**
     ...
     * formats.
     *
     * Generated from protobuf enum <code>INVALID_INTERACTION_TYPE = 108;</code>
     */
    const INVALID_INTERACTION_TYPE = 108;
    /**
     * Campaign video ads sequence is required for `VIDEO_SEQUENCE` advertising
     * channel sub type.
     *
     * Generated from protobuf enum <code>VIDEO_SEQUENCE_ERROR_SEQUENCE_DEFINITION_REQUIRED = 109;</code>
     */
    const VIDEO_SEQUENCE_ERROR_SEQUENCE_DEFINITION_REQUIRED = 109;
    /**
     * This feature is only available for campaigns with AI Max enabled.
     *
     * Generated from protobuf enum <code>AI_MAX_MUST_BE_ENABLED = 110;</code>
     */
    const AI_MAX_MUST_BE_ENABLED = 110;
    /**
     * Duration too long for total budget.
     *
     * Generated from protobuf enum <code>DURATION_TOO_LONG_FOR_TOTAL_BUDGET = 111;</code>
     */
    const DURATION_TOO_LONG_FOR_TOTAL_BUDGET = 111;
    /**
     * Campaigns with total budgets must have end date/time specified.
     *
     * Generated from protobuf enum <code>END_DATE_TIME_REQUIRED_FOR_TOTAL_BUDGET = 112;</code>
     */
    const END_DATE_TIME_REQUIRED_FOR_TOTAL_BUDGET = 112;
    ...
    private static $valueToName = [
        ...
        self::THIRD_PARTY_INTEGRATION_PARTNER_NOT_ALLOWED => 'THIRD_PARTY_INTEGRATION_PARTNER_NOT_ALLOWED',
        self::THIRD_PARTY_INTEGRATION_PARTNER_SHARE_COST_NOT_ALLOWED => 'THIRD_PARTY_INTEGRATION_PARTNER_SHARE_COST_NOT_ALLOWED',
        self::DUPLICATE_INTERACTION_TYPE => 'DUPLICATE_INTERACTION_TYPE',
        self::INVALID_INTERACTION_TYPE => 'INVALID_INTERACTION_TYPE',
        self::VIDEO_SEQUENCE_ERROR_SEQUENCE_DEFINITION_REQUIRED => 'VIDEO_SEQUENCE_ERROR_SEQUENCE_DEFINITION_REQUIRED',
        self::AI_MAX_MUST_BE_ENABLED => 'AI_MAX_MUST_BE_ENABLED',
        self::DURATION_TOO_LONG_FOR_TOTAL_BUDGET => 'DURATION_TOO_LONG_FOR_TOTAL_BUDGET',
        self::END_DATE_TIME_REQUIRED_FOR_TOTAL_BUDGET => 'END_DATE_TIME_REQUIRED_FOR_TOTAL_BUDGET',
    ];
