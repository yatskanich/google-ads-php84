...
namespace Google\Ads\GoogleAds\V24\Errors\UserListErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v24.errors.UserListErrorEnum.UserListError</code>
 */
class UserListError
{
    /**
     ...
     * Lookalike.
     *
     * Generated from protobuf enum <code>DUPLICATE_LOOKALIKE = 46;</code>
     */
    const DUPLICATE_LOOKALIKE = 46;
    /**
     * The partner audience source is not supported for the user list type.
     *
     * Generated from protobuf enum <code>PARTNER_AUDIENCE_SOURCE_NOT_SUPPORTED_FOR_USER_LIST_TYPE = 47;</code>
     */
    const PARTNER_AUDIENCE_SOURCE_NOT_SUPPORTED_FOR_USER_LIST_TYPE = 47;
    /**
     * The commerce partner is only supported for COMMERCE_AUDIENCE.
     *
     * Generated from protobuf enum <code>COMMERCE_PARTNER_NOT_ALLOWED = 48;</code>
     */
    const COMMERCE_PARTNER_NOT_ALLOWED = 48;
    /**
     * The partner audience info is not supported for the user list type.
     *
     * Generated from protobuf enum <code>PARTNER_AUDIENCE_INFO_NOT_SUPPORTED_FOR_USER_LIST_TYPE = 49;</code>
     */
    const PARTNER_AUDIENCE_INFO_NOT_SUPPORTED_FOR_USER_LIST_TYPE = 49;
    /**
     * Manager account is not allowed to create this UserList.
     *
     * Generated from protobuf enum <code>PARTNER_MANAGER_ACCOUNT_DISALLOWED = 50;</code>
     */
    const PARTNER_MANAGER_ACCOUNT_DISALLOWED = 50;
    /**
     * This UserList can only be created by allowlisted partners.
     *
     * Generated from protobuf enum <code>PARTNER_NOT_ALLOWLISTED_FOR_THIRD_PARTY_PARTNER_DATA = 51;</code>
     */
    const PARTNER_NOT_ALLOWLISTED_FOR_THIRD_PARTY_PARTNER_DATA = 51;
    /**
     * The advertiser must accept the Terms of Service to create this UserList.
     *
     * Generated from protobuf enum <code>ADVERTISER_TOS_NOT_ACCEPTED = 52;</code>
     */
    const ADVERTISER_TOS_NOT_ACCEPTED = 52;
    /**
     * The advertiser must have an active link to the partner to create this
     * UserList.
     *
     * Generated from protobuf enum <code>ADVERTISER_PARTNER_LINK_MISSING = 53;</code>
     */
    const ADVERTISER_PARTNER_LINK_MISSING = 53;
    /**
     * This UserList can only be created for allowlisted advertisers.
     *
     * Generated from protobuf enum <code>ADVERTISER_NOT_ALLOWLISTED_FOR_THIRD_PARTY_PARTNER_DATA = 54;</code>
     */
    const ADVERTISER_NOT_ALLOWLISTED_FOR_THIRD_PARTY_PARTNER_DATA = 54;
    /**
     * This UserList is not allowed for this account type.
     *
     * Generated from protobuf enum <code>ACCOUNT_SETTING_TYPE_NOT_ALLOWED = 55;</code>
     */
    const ACCOUNT_SETTING_TYPE_NOT_ALLOWED = 55;
    ...
    private static $valueToName = [
        ...
        self::DUPLICATE_LOOKALIKE => 'DUPLICATE_LOOKALIKE',
        self::PARTNER_AUDIENCE_SOURCE_NOT_SUPPORTED_FOR_USER_LIST_TYPE => 'PARTNER_AUDIENCE_SOURCE_NOT_SUPPORTED_FOR_USER_LIST_TYPE',
        self::COMMERCE_PARTNER_NOT_ALLOWED => 'COMMERCE_PARTNER_NOT_ALLOWED',
        self::PARTNER_AUDIENCE_INFO_NOT_SUPPORTED_FOR_USER_LIST_TYPE => 'PARTNER_AUDIENCE_INFO_NOT_SUPPORTED_FOR_USER_LIST_TYPE',
        self::PARTNER_MANAGER_ACCOUNT_DISALLOWED => 'PARTNER_MANAGER_ACCOUNT_DISALLOWED',
        self::PARTNER_NOT_ALLOWLISTED_FOR_THIRD_PARTY_PARTNER_DATA => 'PARTNER_NOT_ALLOWLISTED_FOR_THIRD_PARTY_PARTNER_DATA',
        self::ADVERTISER_TOS_NOT_ACCEPTED => 'ADVERTISER_TOS_NOT_ACCEPTED',
        self::ADVERTISER_PARTNER_LINK_MISSING => 'ADVERTISER_PARTNER_LINK_MISSING',
        self::ADVERTISER_NOT_ALLOWLISTED_FOR_THIRD_PARTY_PARTNER_DATA => 'ADVERTISER_NOT_ALLOWLISTED_FOR_THIRD_PARTY_PARTNER_DATA',
        self::ACCOUNT_SETTING_TYPE_NOT_ALLOWED => 'ACCOUNT_SETTING_TYPE_NOT_ALLOWED',
    ];
