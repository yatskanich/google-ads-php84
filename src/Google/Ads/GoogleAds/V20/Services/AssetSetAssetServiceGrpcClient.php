...
class AssetSetAssetServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V20\Services\MutateAssetSetAssetsResponse>
     */
    public function MutateAssetSetAssets(\Google\Ads\GoogleAds\V20\Services\MutateAssetSetAssetsRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
            [\Google\Ads\GoogleAds\V20\Services\MutateAssetSetAssetsResponse::class, 'decode'],
        $metadata, $options);
    }
