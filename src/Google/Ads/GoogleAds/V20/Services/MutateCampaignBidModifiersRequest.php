...
/**
 * Request message for
 * [CampaignBidModifierService.MutateCampaignBidModifiers][google.ads.googleads.v20.services.CampaignBidModifierService.MutateCampaignBidModifiers].
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.services.MutateCampaignBidModifiersRequest</code>
 */
class MutateCampaignBidModifiersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                                      modified.
     * @param \Google\Ads\GoogleAds\V20\Services\CampaignBidModifierOperation[] $operations Required. The list of operations to perform on individual campaign bid
     *                                                                                      modifiers.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\MutateCampaignBidModifiersRequest
     *
     * @experimental
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\CampaignBidModifierOperation::class);
        $this->operations = $arr;
