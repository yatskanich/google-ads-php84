...
return [
    'interfaces' => [
        'google.ads.googleads.v20.services.ConversionValueRuleSetService' => [
            'MutateConversionValueRuleSets' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V20\Services\MutateConversionValueRuleSetsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
