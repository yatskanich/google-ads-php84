...
class ContentCreatorInsightsServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [RangeError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V20\Services\GenerateCreatorInsightsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V20\Services\GenerateCreatorInsightsResponse>
     */
    public function GenerateCreatorInsights(\Google\Ads\GoogleAds\V20\Services\GenerateCreatorInsightsRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [RangeError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V20\Services\GenerateTrendingInsightsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V20\Services\GenerateTrendingInsightsResponse>
     */
    public function GenerateTrendingInsights(\Google\Ads\GoogleAds\V20\Services\GenerateTrendingInsightsRequest $argument,
      $metadata = [], $options = []) {
