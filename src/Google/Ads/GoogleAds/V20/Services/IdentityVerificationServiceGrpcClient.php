...
class IdentityVerificationServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V20\Services\StartIdentityVerificationRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Protobuf\GPBEmpty>
     */
    public function StartIdentityVerification(\Google\Ads\GoogleAds\V20\Services\StartIdentityVerificationRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V20\Services\GetIdentityVerificationRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V20\Services\GetIdentityVerificationResponse>
     */
    public function GetIdentityVerification(\Google\Ads\GoogleAds\V20\Services\GetIdentityVerificationRequest $argument,
      $metadata = [], $options = []) {
