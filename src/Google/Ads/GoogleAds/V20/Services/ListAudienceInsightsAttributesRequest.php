 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.services.ListAudienceInsightsAttributesRequest</code>
 */
class ListAudienceInsightsAttributesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension dimensions = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $dimensions;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.common.LocationInfo location_country_filters = 5;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.common.LocationInfo youtube_reach_location = 6;</code>
     */
     ...
     *                           returned.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\ListAudienceInsightsAttributesRequest
     *
     * @experimental
     */
     ...
     *           Optional. Additional information on the application issuing the request.
     *     @type array<\Google\Ads\GoogleAds\V20\Common\LocationInfo>|\Google\Protobuf\Internal\RepeatedField $location_country_filters
     *           If SUB_COUNTRY_LOCATION attributes are one of the requested dimensions and
     *           this field is present, then the SUB_COUNTRY_LOCATION attributes returned
     *           will be located in these countries. If this field is absent, then location
     *           attributes are not filtered by country. Setting this field when
     *           SUB_COUNTRY_LOCATION attributes are not requested will return an error.
     *     @type \Google\Ads\GoogleAds\V20\Common\LocationInfo $youtube_reach_location
     *           If present, potential YouTube reach estimates within the specified market
     *           will be returned for attributes for which they are available.  Reach is
     *           only available for the AGE_RANGE, GENDER, AFFINITY_USER_INTEREST and
     *           IN_MARKET_USER_INTEREST dimensions, and may not be available for every
