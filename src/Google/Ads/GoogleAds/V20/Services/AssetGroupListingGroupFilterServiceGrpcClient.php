...
class AssetGroupListingGroupFilterServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V20\Services\MutateAssetGroupListingGroupFiltersRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V20\Services\MutateAssetGroupListingGroupFiltersResponse>
     */
    public function MutateAssetGroupListingGroupFilters(\Google\Ads\GoogleAds\V20\Services\MutateAssetGroupListingGroupFiltersRequest $argument,
      $metadata = [], $options = []) {
