...
class AdGroupCriterionServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateAdGroupCriteria(\Google\Ads\GoogleAds\V20\Services\MutateAdGroupCriteriaRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v20.services.AdGroupCriterionService/MutateAdGroupCriteria',
        $argument,
            [\Google\Ads\GoogleAds\V20\Services\MutateAdGroupCriteriaResponse::class, 'decode'],
        $metadata, $options);
    }
