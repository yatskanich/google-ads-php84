 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.services.MutateSmartCampaignSettingsRequest</code>
 */
class MutateSmartCampaignSettingsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * settings.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.services.SmartCampaignSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     *                                                                                       modified.
     * @param \Google\Ads\GoogleAds\V20\Services\SmartCampaignSettingOperation[] $operations Required. The list of operations to perform on individual Smart campaign
     *                                                                                       settings.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\MutateSmartCampaignSettingsRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose Smart campaign settings are being
     *           modified.
     *     @type array<\Google\Ads\GoogleAds\V20\Services\SmartCampaignSettingOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual Smart campaign
     *           settings.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.services.SmartCampaignSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V20\Services\SmartCampaignSettingOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\SmartCampaignSettingOperation::class);
        $this->operations = $arr;
