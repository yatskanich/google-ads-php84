 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.services.MutateKeywordPlanCampaignsRequest</code>
 */
class MutateKeywordPlanCampaignsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                                      modified.
     * @param \Google\Ads\GoogleAds\V20\Services\KeywordPlanCampaignOperation[] $operations Required. The list of operations to perform on individual Keyword Plan
     *                                                                                      campaigns.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\MutateKeywordPlanCampaignsRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V20\Services\KeywordPlanCampaignService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\KeywordPlanCampaignOperation::class);
        $this->operations = $arr;
