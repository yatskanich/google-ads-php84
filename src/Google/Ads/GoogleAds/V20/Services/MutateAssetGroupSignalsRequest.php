...
/**
 * Request message for
 * [AssetGroupSignalService.MutateAssetGroupSignals][google.ads.googleads.v20.services.AssetGroupSignalService.MutateAssetGroupSignals].
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.services.MutateAssetGroupSignalsRequest</code>
 */
class MutateAssetGroupSignalsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                                   modified.
     * @param \Google\Ads\GoogleAds\V20\Services\AssetGroupSignalOperation[] $operations Required. The list of operations to perform on individual asset group
     *                                                                                   signals.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\MutateAssetGroupSignalsRequest
     *
     * @experimental
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\AssetGroupSignalOperation::class);
        $this->operations = $arr;
