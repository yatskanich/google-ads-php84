...
class AssetGroupServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * returned.
     * @param \Google\Ads\GoogleAds\V20\Services\MutateAssetGroupsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V20\Services\MutateAssetGroupsResponse>
     */
    public function MutateAssetGroups(\Google\Ads\GoogleAds\V20\Services\MutateAssetGroupsRequest $argument,
      $metadata = [], $options = []) {
