 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.services.MutateCampaignsRequest</code>
 */
class MutateCampaignsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.services.CampaignOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     * @param \Google\Ads\GoogleAds\V20\Services\CampaignOperation[] $operations Required. The list of operations to perform on individual campaigns.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\MutateCampaignsRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose campaigns are being modified.
     *     @type array<\Google\Ads\GoogleAds\V20\Services\CampaignOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual campaigns.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.services.CampaignOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V20\Services\CampaignOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\CampaignOperation::class);
        $this->operations = $arr;
