 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.services.DismissRecommendationRequest</code>
 */
class DismissRecommendationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Ads\GoogleAds\V20\Services\DismissRecommendationRequest\DismissRecommendationOperation[] $operations Required. The list of operations to dismiss recommendations.
     *                                                                                                                     If partial_failure=false all recommendations should be of the same type
     *                                                                                                                     There is a limit of 100 operations per request.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\DismissRecommendationRequest
     *
     * @experimental
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\DismissRecommendationRequest\DismissRecommendationOperation::class);
        $this->operations = $arr;
