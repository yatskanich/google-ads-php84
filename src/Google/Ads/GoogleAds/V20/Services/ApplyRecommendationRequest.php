...
class ApplyRecommendationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The ID of the customer with the recommendation.
     *     @type \Google\Ads\GoogleAds\V20\Services\ApplyRecommendationOperation[] $operations
     *           Required. The list of operations to apply recommendations.
     *           If partial_failure=false all recommendations should be of the same type
     *           There is a limit of 100 operations per request.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.services.ApplyRecommendationOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V20\Services\ApplyRecommendationOperation>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.services.ApplyRecommendationOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V20\Services\ApplyRecommendationOperation[] $var
     * @return $this
     */
