 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.services.MutateAdGroupBidModifiersRequest</code>
 */
class MutateAdGroupBidModifiersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                                     modified.
     * @param \Google\Ads\GoogleAds\V20\Services\AdGroupBidModifierOperation[] $operations Required. The list of operations to perform on individual ad group bid
     *                                                                                     modifiers.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\MutateAdGroupBidModifiersRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V20\Services\AdGroupBidModifierService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\AdGroupBidModifierOperation::class);
        $this->operations = $arr;
