...
class MutateCustomerLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                                modified.
     * @param \Google\Ads\GoogleAds\V20\Services\CustomerLabelOperation[] $operations Required. The list of operations to perform on customer-label
     *                                                                                relationships.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\MutateCustomerLabelsRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V20\Services\CustomerLabelService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\CustomerLabelOperation::class);
        $this->operations = $arr;
