...
class ConversionCustomVariableServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateConversionCustomVariables(\Google\Ads\GoogleAds\V20\Services\MutateConversionCustomVariablesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v20.services.ConversionCustomVariableService/MutateConversionCustomVariables',
        $argument,
            [\Google\Ads\GoogleAds\V20\Services\MutateConversionCustomVariablesResponse::class, 'decode'],
        $metadata, $options);
    }
