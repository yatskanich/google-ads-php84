 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.services.MutateAudiencesRequest</code>
 */
class MutateAudiencesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Ads\GoogleAds\V20\Services\AudienceOperation[] $operations Required. The list of operations to perform on individual audiences.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\MutateAudiencesRequest
     *
     * @experimental
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\AudienceOperation::class);
        $this->operations = $arr;
