...
class ThirdPartyAppAnalyticsLinkServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V20\Services\RegenerateShareableLinkIdResponse>
     */
    public function RegenerateShareableLinkId(\Google\Ads\GoogleAds\V20\Services\RegenerateShareableLinkIdRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
            [\Google\Ads\GoogleAds\V20\Services\RegenerateShareableLinkIdResponse::class, 'decode'],
        $metadata, $options);
    }
