 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v20/services/customer_user_access_service.proto
 ...
 *
 * @method PromiseInterface<MutateCustomerUserAccessResponse> mutateCustomerUserAccessAsync(MutateCustomerUserAccessRequest $request, array $optionalArgs = [])
 */
class CustomerUserAccessServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v20.services.CustomerUserAccessService';
     ...
     */
    public static function customerUserAccessName(string $customerId, string $userId): string
    {
        return self::getPathTemplate('customerUserAccess')->render([
     ...
     *           use Google\Ads\GoogleAds\V20\Services\CustomerUserAccessServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomerUserAccessServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateCustomerUserAccessResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCustomerUserAccess(MutateCustomerUserAccessRequest $request, array $callOptions = []): MutateCustomerUserAccessResponse
    {
        return $this->startApiCall('MutateCustomerUserAccess', $request, $callOptions)->wait();
    }
}
