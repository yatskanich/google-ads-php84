 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.services.MutateCustomerConversionGoalsRequest</code>
 */
class MutateCustomerConversionGoalsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                                         modified.
     * @param \Google\Ads\GoogleAds\V20\Services\CustomerConversionGoalOperation[] $operations Required. The list of operations to perform on individual customer
     *                                                                                         conversion goal.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\MutateCustomerConversionGoalsRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V20\Services\CustomerConversionGoalService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\CustomerConversionGoalOperation::class);
        $this->operations = $arr;
