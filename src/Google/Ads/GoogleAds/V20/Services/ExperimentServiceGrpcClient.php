...
class ExperimentServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V20\Services\MutateExperimentsResponse>
     */
    public function MutateExperiments(\Google\Ads\GoogleAds\V20\Services\MutateExperimentsRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
            [\Google\Ads\GoogleAds\V20\Services\MutateExperimentsResponse::class, 'decode'],
        $metadata, $options);
    }
     ...
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V20\Services\ListExperimentAsyncErrorsResponse>
     */
    public function ListExperimentAsyncErrors(\Google\Ads\GoogleAds\V20\Services\ListExperimentAsyncErrorsRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
            [\Google\Ads\GoogleAds\V20\Services\ListExperimentAsyncErrorsResponse::class, 'decode'],
        $metadata, $options);
    }
