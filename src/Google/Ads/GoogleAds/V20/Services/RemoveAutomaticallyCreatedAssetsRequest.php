...
class RemoveAutomaticallyCreatedAssetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                                      automatically created assets.
     * @param \Google\Ads\GoogleAds\V20\Services\AssetsWithFieldType[] $assetsWithFieldType Required. List of assets with field type to be removed from the AdGroupAd.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\RemoveAutomaticallyCreatedAssetsRequest
     *
     * @experimental
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\AssetsWithFieldType::class);
