...
class ConfigureCustomerLifecycleGoalsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.services.CustomerLifecycleGoalOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Ads\GoogleAds\V20\Services\CustomerLifecycleGoalOperation $operation  Required. The operation to perform customer lifecycle goal update.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\ConfigureCustomerLifecycleGoalsRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer performing the upload.
     *     @type \Google\Ads\GoogleAds\V20\Services\CustomerLifecycleGoalOperation $operation
     *           Required. The operation to perform customer lifecycle goal update.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.services.CustomerLifecycleGoalOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\GoogleAds\V20\Services\CustomerLifecycleGoalOperation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.services.CustomerLifecycleGoalOperation operation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V20\Services\CustomerLifecycleGoalOperation $var
     * @return $this
     */
    public function setOperation($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V20\Services\CustomerLifecycleGoalOperation::class);
        $this->operation = $var;
