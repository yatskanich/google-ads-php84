...
class CustomerUserAccessServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateCustomerUserAccess(\Google\Ads\GoogleAds\V20\Services\MutateCustomerUserAccessRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v20.services.CustomerUserAccessService/MutateCustomerUserAccess',
        $argument,
            [\Google\Ads\GoogleAds\V20\Services\MutateCustomerUserAccessResponse::class, 'decode'],
        $metadata, $options);
    }
