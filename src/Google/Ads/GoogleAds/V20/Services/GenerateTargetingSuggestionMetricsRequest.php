 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.services.GenerateTargetingSuggestionMetricsRequest</code>
 */
class GenerateTargetingSuggestionMetricsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.common.AdditionalApplicationInfo insights_application_info = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $insights_application_info = null;

    /**
     * @param string                                                     $customerId Required. The ID of the customer.
     * @param \Google\Ads\GoogleAds\V20\Services\BasicInsightsAudience[] $audiences  Required. Audiences to request metrics for.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\GenerateTargetingSuggestionMetricsRequest
     *
     * @experimental
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\BasicInsightsAudience::class);
        $this->audiences = $arr;
