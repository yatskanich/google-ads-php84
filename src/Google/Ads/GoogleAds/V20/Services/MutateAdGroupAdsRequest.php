 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.services.MutateAdGroupAdsRequest</code>
 */
class MutateAdGroupAdsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.services.AdGroupAdOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
    /**
     ...
     * @param \Google\Ads\GoogleAds\V20\Services\AdGroupAdOperation[] $operations Required. The list of operations to perform on individual ads.
     *
     * @return \Google\Ads\GoogleAds\V20\Services\MutateAdGroupAdsRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose ads are being modified.
     *     @type array<\Google\Ads\GoogleAds\V20\Services\AdGroupAdOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *           Required. The list of operations to perform on individual ads.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V20\Services\AdGroupAdService::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.services.AdGroupAdOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V20\Services\AdGroupAdOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Services\AdGroupAdOperation::class);
        $this->operations = $arr;
