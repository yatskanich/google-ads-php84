...
class ForecastAdGroup extends \Google\Protobuf\Internal\Message
{
     ...
     *           This value will override the max cpc value set in the bidding strategy.
     *           Only specify this field for bidding strategies that max cpc values.
     *     @type array<\Google\Ads\GoogleAds\V20\Services\BiddableKeyword>|\Google\Protobuf\Internal\RepeatedField $biddable_keywords
     *           Required. The list of biddable keywords to be used in the ad group when
     *           doing the forecast. Requires at least one keyword.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.services.BiddableKeyword biddable_keywords = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V20\Services\BiddableKeyword>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
