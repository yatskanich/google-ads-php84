...
class ExperimentArmServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateExperimentArms(\Google\Ads\GoogleAds\V20\Services\MutateExperimentArmsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v20.services.ExperimentArmService/MutateExperimentArms',
        $argument,
            [\Google\Ads\GoogleAds\V20\Services\MutateExperimentArmsResponse::class, 'decode'],
        $metadata, $options);
    }
