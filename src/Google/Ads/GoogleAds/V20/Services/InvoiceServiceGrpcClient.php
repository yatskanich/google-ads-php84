...
class InvoiceServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function ListInvoices(\Google\Ads\GoogleAds\V20\Services\ListInvoicesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v20.services.InvoiceService/ListInvoices',
        $argument,
            [\Google\Ads\GoogleAds\V20\Services\ListInvoicesResponse::class, 'decode'],
        $metadata, $options);
    }
