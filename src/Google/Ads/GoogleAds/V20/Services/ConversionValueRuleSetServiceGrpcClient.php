...
class ConversionValueRuleSetServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V20\Services\MutateConversionValueRuleSetsResponse>
     */
    public function MutateConversionValueRuleSets(\Google\Ads\GoogleAds\V20\Services\MutateConversionValueRuleSetsRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
            [\Google\Ads\GoogleAds\V20\Services\MutateConversionValueRuleSetsResponse::class, 'decode'],
        $metadata, $options);
    }
