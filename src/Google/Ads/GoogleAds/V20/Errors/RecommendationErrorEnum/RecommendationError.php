...
namespace Google\Ads\GoogleAds\V20\Errors\RecommendationErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v20.errors.RecommendationErrorEnum.RecommendationError</code>
 */
class RecommendationError
{
     ...
     * PERFORMANCE_MAX.
     *
     * Generated from protobuf enum <code>MERCHANT_CENTER_ACCOUNT_ID_NOT_SUPPORTED_ADVERTISING_CHANNEL_TYPE = 36;</code>
     */
    const MERCHANT_CENTER_ACCOUNT_ID_NOT_SUPPORTED_ADVERTISING_CHANNEL_TYPE = 36;
    ...
    private static $valueToName = [
        ...
        self::MERCHANT_CENTER_ACCOUNT_ID_NOT_SUPPORTED_ADVERTISING_CHANNEL_TYPE => 'MERCHANT_CENTER_ACCOUNT_ID_NOT_SUPPORTED_ADVERTISING_CHANNEL_TYPE',
    ];
...
class_alias(RecommendationError::class, \Google\Ads\GoogleAds\V20\Errors\RecommendationErrorEnum_RecommendationError::class);
