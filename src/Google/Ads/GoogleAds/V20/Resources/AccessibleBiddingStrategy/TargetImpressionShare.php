 ...
 * location).
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.resources.AccessibleBiddingStrategy.TargetImpressionShare</code>
 */
class TargetImpressionShare extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.enums.TargetImpressionShareLocationEnum.TargetImpressionShareLocation location = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
...
class_alias(TargetImpressionShare::class, \Google\Ads\GoogleAds\V20\Resources\AccessibleBiddingStrategy_TargetImpressionShare::class);
