...
# source: google/ads/googleads/v20/resources/product_category_constant.proto
 ...
 * A Product Category.
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.resources.ProductCategoryConstant</code>
 */
class ProductCategoryConstant extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.enums.ProductCategoryLevelEnum.ProductCategoryLevel level = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $level = 0;
    /**
     * Output only. State of the product category.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.enums.ProductCategoryStateEnum.ProductCategoryState state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V20\Resources\ProductCategoryConstant::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V20\Enums\ProductCategoryLevelEnum\ProductCategoryLevel::class);
        $this->level = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V20\Enums\ProductCategoryStateEnum\ProductCategoryState::class);
        $this->state = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Resources\ProductCategoryConstant\ProductCategoryLocalization::class);
