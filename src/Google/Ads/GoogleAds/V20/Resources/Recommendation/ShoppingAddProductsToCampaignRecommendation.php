 ...
 * Inventory.
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.resources.Recommendation.ShoppingAddProductsToCampaignRecommendation</code>
 */
class ShoppingAddProductsToCampaignRecommendation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.resources.Recommendation.MerchantInfo merchant = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason reason = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $reason = 0;
     ...
     *
     *     @type \Google\Ads\GoogleAds\V20\Resources\Recommendation\MerchantInfo $merchant
     *           Output only. The details of the Merchant Center account.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.resources.Recommendation.MerchantInfo merchant = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Ads\GoogleAds\V20\Resources\Recommendation\MerchantInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.resources.Recommendation.MerchantInfo merchant = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V20\Resources\Recommendation\MerchantInfo $var
     * @return $this
     */
    public function setMerchant($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V20\Resources\Recommendation\MerchantInfo::class);
        $this->merchant = $var;
