 ...
 * segments is allowed.
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.resources.ShoppingProduct</code>
 */
class ShoppingProduct extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.enums.ProductChannelEnum.ProductChannel channel = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $channel = 0;
    /**
     ...
     * merchant.
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v20.enums.ProductChannelExclusivityEnum.ProductChannelExclusivity channel_exclusivity = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $channel_exclusivity = null;
    /**
     * Output only. The condition of the product as provided by the merchant.
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v20.enums.ProductConditionEnum.ProductCondition condition = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $condition = null;
    /**
     * Output only. The availability of the product as provided by the merchant.
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v20.enums.ProductAvailabilityEnum.ProductAvailability availability = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.enums.ProductStatusEnum.ProductStatus status = 32 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V20\Enums\ProductAvailabilityEnum\ProductAvailability::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V20\Enums\ProductStatusEnum\ProductStatus::class);
        $this->status = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V20\Resources\ShoppingProduct\ProductIssue::class);
        $this->issues = $arr;
