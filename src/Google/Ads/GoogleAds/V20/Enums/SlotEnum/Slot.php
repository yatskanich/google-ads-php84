...
namespace Google\Ads\GoogleAds\V20\Enums\SlotEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v20.enums.SlotEnum.Slot</code>
 */
class Slot
{
    /**
...
class_alias(Slot::class, \Google\Ads\GoogleAds\V20\Enums\SlotEnum_Slot::class);
