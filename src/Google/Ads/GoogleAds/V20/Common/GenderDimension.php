 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.common.GenderDimension</code>
 */
class GenderDimension extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V20\Enums\GenderTypeEnum\GenderType::class);
        $this->genders = $arr;
