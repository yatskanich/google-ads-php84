...
namespace Google\Ads\GoogleAds\V20\Common\TargetRestrictionOperation;
 ...
 * The operator.
 *
 * Protobuf type <code>google.ads.googleads.v20.common.TargetRestrictionOperation.Operator</code>
 */
class Operator
{
    /**
