 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v20.common.ChainSet</code>
 */
class ChainSet extends \Google\Protobuf\Internal\Message
{
     ...
     * advertiser.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v20.enums.ChainRelationshipTypeEnum.ChainRelationshipType relationship_type = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE];</code>
     */
    protected $relationship_type = 0;
    /**
     * Required. A list of chain level filters, all filters are OR'ed together.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.common.ChainFilter chains = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $chains;
     ...
     *           Required. Immutable. Relationship type the specified chains have with this
     *           advertiser.
     *     @type \Google\Ads\GoogleAds\V20\Common\ChainFilter[] $chains
     *           Required. A list of chain level filters, all filters are OR'ed together.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.common.ChainFilter chains = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V20\Common\ChainFilter>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v20.common.ChainFilter chains = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\GoogleAds\V20\Common\ChainFilter[] $var
     * @return $this
     */
