...
class CustomerExtensionSettingServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringLengthError]()
     *   [UrlFieldError]()
     * @param \Google\Ads\GoogleAds\V18\Services\MutateCustomerExtensionSettingsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateCustomerExtensionSettings(\Google\Ads\GoogleAds\V18\Services\MutateCustomerExtensionSettingsRequest $argument,
      $metadata = [], $options = []) {
