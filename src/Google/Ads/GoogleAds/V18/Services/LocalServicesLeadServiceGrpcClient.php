...
class LocalServicesLeadServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * Lead resources.
     * @param \Google\Ads\GoogleAds\V18\Services\AppendLeadConversationRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function AppendLeadConversation(\Google\Ads\GoogleAds\V18\Services\AppendLeadConversationRequest $argument,
      $metadata = [], $options = []) {
