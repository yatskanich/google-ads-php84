...
class KeywordPlanAdGroupKeywordServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Ads\GoogleAds\V18\Services\MutateKeywordPlanAdGroupKeywordsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateKeywordPlanAdGroupKeywords(\Google\Ads\GoogleAds\V18\Services\MutateKeywordPlanAdGroupKeywordsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v18.services.KeywordPlanAdGroupKeywordService/MutateKeywordPlanAdGroupKeywords',
        $argument,
            [\Google\Ads\GoogleAds\V18\Services\MutateKeywordPlanAdGroupKeywordsResponse::class, 'decode'],
        $metadata, $options);
    }
