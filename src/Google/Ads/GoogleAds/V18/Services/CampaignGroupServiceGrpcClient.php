...
class CampaignGroupServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * returned.
     * @param \Google\Ads\GoogleAds\V18\Services\MutateCampaignGroupsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateCampaignGroups(\Google\Ads\GoogleAds\V18\Services\MutateCampaignGroupsRequest $argument,
      $metadata = [], $options = []) {
