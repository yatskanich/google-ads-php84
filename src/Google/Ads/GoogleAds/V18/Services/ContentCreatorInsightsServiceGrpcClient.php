...
class ContentCreatorInsightsServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [RangeError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V18\Services\GenerateCreatorInsightsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GenerateCreatorInsights(\Google\Ads\GoogleAds\V18\Services\GenerateCreatorInsightsRequest $argument,
      $metadata = [], $options = []) {
