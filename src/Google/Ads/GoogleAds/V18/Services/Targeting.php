 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v18.services.Targeting</code>
 */
class Targeting extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v18.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange age_range = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.common.GenderInfo genders = 3;</code>
     */
    private $genders;
    /**
     * Targeted devices.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.common.DeviceInfo devices = 4;</code>
     */
    private $devices;
    /**
     ...
     * [ReachPlanService.ListPlannableProducts][google.ads.googleads.v18.services.ReachPlanService.ListPlannableProducts].
     *
     * Generated from protobuf field <code>.google.ads.googleads.v18.enums.ReachPlanNetworkEnum.ReachPlanNetwork network = 5;</code>
     */
    protected $network = 0;
    /**
     * Targeted audiences.
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v18.services.AudienceTargeting audience_targeting = 7;</code>
     */
     ...
     *           Targeted age range.
     *           An unset value is equivalent to targeting all ages.
     *     @type array<\Google\Ads\GoogleAds\V18\Common\GenderInfo>|\Google\Protobuf\Internal\RepeatedField $genders
     *           Targeted genders.
     *           An unset value is equivalent to targeting MALE and FEMALE.
     *     @type array<\Google\Ads\GoogleAds\V18\Common\DeviceInfo>|\Google\Protobuf\Internal\RepeatedField $devices
     *           Targeted devices.
     *           If not specified, targets all applicable devices. Applicable devices vary
     *           by product and region and can be obtained from
     *           [ReachPlanService.ListPlannableProducts][google.ads.googleads.v18.services.ReachPlanService.ListPlannableProducts].
     ...
     *           by product and region and can be obtained from
     *           [ReachPlanService.ListPlannableProducts][google.ads.googleads.v18.services.ReachPlanService.ListPlannableProducts].
     *     @type \Google\Ads\GoogleAds\V18\Services\AudienceTargeting $audience_targeting
     *           Targeted audiences.
     *           If not specified, does not target any specific audience.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V18\Enums\ReachPlanAgeRangeEnum\ReachPlanAgeRange::class);
        $this->age_range = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.common.GenderInfo genders = 3;</code>
     * @param array<\Google\Ads\GoogleAds\V18\Common\GenderInfo>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setGenders($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V18\Common\GenderInfo::class);
        $this->genders = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.common.DeviceInfo devices = 4;</code>
     * @param array<\Google\Ads\GoogleAds\V18\Common\DeviceInfo>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDevices($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V18\Common\DeviceInfo::class);
        $this->devices = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V18\Enums\ReachPlanNetworkEnum\ReachPlanNetwork::class);
        $this->network = $var;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v18.services.AudienceTargeting audience_targeting = 7;</code>
     * @return \Google\Ads\GoogleAds\V18\Services\AudienceTargeting|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v18.services.AudienceTargeting audience_targeting = 7;</code>
     * @param \Google\Ads\GoogleAds\V18\Services\AudienceTargeting $var
     * @return $this
     */
    public function setAudienceTargeting($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V18\Services\AudienceTargeting::class);
