...
class CustomerServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [RequestError]()
     *   [UrlFieldError]()
     * @param \Google\Ads\GoogleAds\V18\Services\MutateCustomerRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateCustomer(\Google\Ads\GoogleAds\V18\Services\MutateCustomerRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V18\Services\ListAccessibleCustomersRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function ListAccessibleCustomers(\Google\Ads\GoogleAds\V18\Services\ListAccessibleCustomersRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [StringLengthError]()
     *   [TimeZoneError]()
     * @param \Google\Ads\GoogleAds\V18\Services\CreateCustomerClientRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function CreateCustomerClient(\Google\Ads\GoogleAds\V18\Services\CreateCustomerClientRequest $argument,
      $metadata = [], $options = []) {
