...
class CampaignCriterionServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringFormatError]()
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V18\Services\MutateCampaignCriteriaRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateCampaignCriteria(\Google\Ads\GoogleAds\V18\Services\MutateCampaignCriteriaRequest $argument,
      $metadata = [], $options = []) {
