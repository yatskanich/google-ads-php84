...
class RecommendationServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [RequestError]()
     *   [UrlFieldError]()
     * @param \Google\Ads\GoogleAds\V18\Services\ApplyRecommendationRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function ApplyRecommendation(\Google\Ads\GoogleAds\V18\Services\ApplyRecommendationRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [RecommendationError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V18\Services\DismissRecommendationRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function DismissRecommendation(\Google\Ads\GoogleAds\V18\Services\DismissRecommendationRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [RecommendationError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V18\Services\GenerateRecommendationsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GenerateRecommendations(\Google\Ads\GoogleAds\V18\Services\GenerateRecommendationsRequest $argument,
      $metadata = [], $options = []) {
