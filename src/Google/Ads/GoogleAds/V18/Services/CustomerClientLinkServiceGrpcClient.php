...
class CustomerClientLinkServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V18\Services\MutateCustomerClientLinkRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateCustomerClientLink(\Google\Ads\GoogleAds\V18\Services\MutateCustomerClientLinkRequest $argument,
      $metadata = [], $options = []) {
