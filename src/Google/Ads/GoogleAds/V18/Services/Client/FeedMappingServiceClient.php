 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v18/services/feed_mapping_service.proto
 ...
 *
 * @method PromiseInterface<MutateFeedMappingsResponse> mutateFeedMappingsAsync(MutateFeedMappingsRequest $request, array $optionalArgs = [])
 */
class FeedMappingServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v18.services.FeedMappingService';
     ...
     * [StringLengthError]()
     *
     * The async variant is {@see FeedMappingServiceClient::mutateFeedMappingsAsync()}
     * .
     *
     * @param MutateFeedMappingsRequest $request     A request to house fields associated with the call.
     ...
     */
    public function mutateFeedMappings(MutateFeedMappingsRequest $request, array $callOptions = []): MutateFeedMappingsResponse
    {
        return $this->startApiCall('MutateFeedMappings', $request, $callOptions)->wait();
    }
}
