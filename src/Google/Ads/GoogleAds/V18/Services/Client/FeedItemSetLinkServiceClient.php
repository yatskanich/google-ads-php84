 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v18/services/feed_item_set_link_service.proto
 ...
 *
 * @method PromiseInterface<MutateFeedItemSetLinksResponse> mutateFeedItemSetLinksAsync(MutateFeedItemSetLinksRequest $request, array $optionalArgs = [])
 */
class FeedItemSetLinkServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v18.services.FeedItemSetLinkService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/feed_item_set_link_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/feed_item_set_link_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/feed_item_set_link_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/feed_item_set_link_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * {@see FeedItemSetLinkServiceClient::mutateFeedItemSetLinksAsync()} .
     *
     * @param MutateFeedItemSetLinksRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateFeedItemSetLinksResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateFeedItemSetLinks(MutateFeedItemSetLinksRequest $request, array $callOptions = []): MutateFeedItemSetLinksResponse
    {
        return $this->startApiCall('MutateFeedItemSetLinks', $request, $callOptions)->wait();
    }
}
