 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v18/services/campaign_feed_service.proto
 ...
 *
 * @method PromiseInterface<MutateCampaignFeedsResponse> mutateCampaignFeedsAsync(MutateCampaignFeedsRequest $request, array $optionalArgs = [])
 */
class CampaignFeedServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v18.services.CampaignFeedService';
     ...
     * {@see CampaignFeedServiceClient::mutateCampaignFeedsAsync()} .
     *
     * @param MutateCampaignFeedsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateCampaignFeedsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCampaignFeeds(MutateCampaignFeedsRequest $request, array $callOptions = []): MutateCampaignFeedsResponse
    {
        return $this->startApiCall('MutateCampaignFeeds', $request, $callOptions)->wait();
    }
}
