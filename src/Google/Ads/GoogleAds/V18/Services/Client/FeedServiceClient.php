 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v18/services/feed_service.proto
 ...
 *
 * @method PromiseInterface<MutateFeedsResponse> mutateFeedsAsync(MutateFeedsRequest $request, array $optionalArgs = [])
 */
class FeedServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v18.services.FeedService';
     ...
     * [StringLengthError]()
     *
     * The async variant is {@see FeedServiceClient::mutateFeedsAsync()} .
     *
     * @param MutateFeedsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateFeedsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateFeeds(MutateFeedsRequest $request, array $callOptions = []): MutateFeedsResponse
    {
        return $this->startApiCall('MutateFeeds', $request, $callOptions)->wait();
    }
}
