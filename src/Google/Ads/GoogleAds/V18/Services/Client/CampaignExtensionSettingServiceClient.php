 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v18/services/campaign_extension_setting_service.proto
 ...
 *
 * @method PromiseInterface<MutateCampaignExtensionSettingsResponse> mutateCampaignExtensionSettingsAsync(MutateCampaignExtensionSettingsRequest $request, array $optionalArgs = [])
 */
class CampaignExtensionSettingServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v18.services.CampaignExtensionSettingService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/campaign_extension_setting_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/campaign_extension_setting_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/campaign_extension_setting_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/campaign_extension_setting_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * {@see CampaignExtensionSettingServiceClient::mutateCampaignExtensionSettingsAsync()}
     * .
     *
     * @param MutateCampaignExtensionSettingsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateCampaignExtensionSettingsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCampaignExtensionSettings(MutateCampaignExtensionSettingsRequest $request, array $callOptions = []): MutateCampaignExtensionSettingsResponse
    {
        return $this->startApiCall('MutateCampaignExtensionSettings', $request, $callOptions)->wait();
    }
}
