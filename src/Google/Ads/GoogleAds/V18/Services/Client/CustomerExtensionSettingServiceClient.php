 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v18/services/customer_extension_setting_service.proto
 ...
 *
 * @method PromiseInterface<MutateCustomerExtensionSettingsResponse> mutateCustomerExtensionSettingsAsync(MutateCustomerExtensionSettingsRequest $request, array $optionalArgs = [])
 */
class CustomerExtensionSettingServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v18.services.CustomerExtensionSettingService';
     ...
     * {@see CustomerExtensionSettingServiceClient::mutateCustomerExtensionSettingsAsync()}
     * .
     *
     * @param MutateCustomerExtensionSettingsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateCustomerExtensionSettingsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCustomerExtensionSettings(MutateCustomerExtensionSettingsRequest $request, array $callOptions = []): MutateCustomerExtensionSettingsResponse
    {
        return $this->startApiCall('MutateCustomerExtensionSettings', $request, $callOptions)->wait();
    }
}
