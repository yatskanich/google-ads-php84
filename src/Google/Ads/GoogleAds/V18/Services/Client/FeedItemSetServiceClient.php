 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v18/services/feed_item_set_service.proto
 ...
 *
 * @method PromiseInterface<MutateFeedItemSetsResponse> mutateFeedItemSetsAsync(MutateFeedItemSetsRequest $request, array $optionalArgs = [])
 */
class FeedItemSetServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v18.services.FeedItemSetService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/feed_item_set_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/feed_item_set_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/feed_item_set_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/feed_item_set_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * [RequestError]()
     *
     * The async variant is {@see FeedItemSetServiceClient::mutateFeedItemSetsAsync()}
     * .
     *
     * @param MutateFeedItemSetsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateFeedItemSetsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateFeedItemSets(MutateFeedItemSetsRequest $request, array $callOptions = []): MutateFeedItemSetsResponse
    {
        return $this->startApiCall('MutateFeedItemSets', $request, $callOptions)->wait();
    }
}
