 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v18/services/feed_item_service.proto
 ...
 *
 * @method PromiseInterface<MutateFeedItemsResponse> mutateFeedItemsAsync(MutateFeedItemsRequest $request, array $optionalArgs = [])
 */
class FeedItemServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v18.services.FeedItemService';
     ...
     * [UrlFieldError]()
     *
     * The async variant is {@see FeedItemServiceClient::mutateFeedItemsAsync()} .
     *
     * @param MutateFeedItemsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateFeedItemsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateFeedItems(MutateFeedItemsRequest $request, array $callOptions = []): MutateFeedItemsResponse
    {
        return $this->startApiCall('MutateFeedItems', $request, $callOptions)->wait();
    }
}
