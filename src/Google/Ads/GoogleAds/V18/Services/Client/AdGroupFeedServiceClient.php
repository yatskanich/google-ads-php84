 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v18/services/ad_group_feed_service.proto
 ...
 *
 * @method PromiseInterface<MutateAdGroupFeedsResponse> mutateAdGroupFeedsAsync(MutateAdGroupFeedsRequest $request, array $optionalArgs = [])
 */
class AdGroupFeedServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v18.services.AdGroupFeedService';
     ...
     * [StringLengthError]()
     *
     * The async variant is {@see AdGroupFeedServiceClient::mutateAdGroupFeedsAsync()}
     * .
     *
     * @param MutateAdGroupFeedsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateAdGroupFeedsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAdGroupFeeds(MutateAdGroupFeedsRequest $request, array $callOptions = []): MutateAdGroupFeedsResponse
    {
        return $this->startApiCall('MutateAdGroupFeeds', $request, $callOptions)->wait();
    }
}
