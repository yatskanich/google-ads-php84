 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v18/services/ad_group_extension_setting_service.proto
 ...
 *
 * @method PromiseInterface<MutateAdGroupExtensionSettingsResponse> mutateAdGroupExtensionSettingsAsync(MutateAdGroupExtensionSettingsRequest $request, array $optionalArgs = [])
 */
class AdGroupExtensionSettingServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v18.services.AdGroupExtensionSettingService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/ad_group_extension_setting_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/ad_group_extension_setting_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/ad_group_extension_setting_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/ad_group_extension_setting_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * {@see AdGroupExtensionSettingServiceClient::mutateAdGroupExtensionSettingsAsync()}
     * .
     *
     * @param MutateAdGroupExtensionSettingsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateAdGroupExtensionSettingsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAdGroupExtensionSettings(MutateAdGroupExtensionSettingsRequest $request, array $callOptions = []): MutateAdGroupExtensionSettingsResponse
    {
        return $this->startApiCall('MutateAdGroupExtensionSettings', $request, $callOptions)->wait();
    }
}
