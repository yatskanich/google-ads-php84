 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v18/services/customer_feed_service.proto
 ...
 *
 * @method PromiseInterface<MutateCustomerFeedsResponse> mutateCustomerFeedsAsync(MutateCustomerFeedsRequest $request, array $optionalArgs = [])
 */
class CustomerFeedServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v18.services.CustomerFeedService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/customer_feed_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/customer_feed_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/customer_feed_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/customer_feed_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * {@see CustomerFeedServiceClient::mutateCustomerFeedsAsync()} .
     *
     * @param MutateCustomerFeedsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateCustomerFeedsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCustomerFeeds(MutateCustomerFeedsRequest $request, array $callOptions = []): MutateCustomerFeedsResponse
    {
        return $this->startApiCall('MutateCustomerFeeds', $request, $callOptions)->wait();
    }
}
