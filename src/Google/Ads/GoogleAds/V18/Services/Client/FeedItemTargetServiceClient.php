 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v18/services/feed_item_target_service.proto
 ...
 *
 * @method PromiseInterface<MutateFeedItemTargetsResponse> mutateFeedItemTargetsAsync(MutateFeedItemTargetsRequest $request, array $optionalArgs = [])
 */
class FeedItemTargetServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v18.services.FeedItemTargetService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/feed_item_target_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/feed_item_target_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/feed_item_target_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/feed_item_target_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * {@see FeedItemTargetServiceClient::mutateFeedItemTargetsAsync()} .
     *
     * @param MutateFeedItemTargetsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateFeedItemTargetsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateFeedItemTargets(MutateFeedItemTargetsRequest $request, array $callOptions = []): MutateFeedItemTargetsResponse
    {
        return $this->startApiCall('MutateFeedItemTargets', $request, $callOptions)->wait();
    }
}
