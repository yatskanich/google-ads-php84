...
class CampaignLabelServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V18\Services\MutateCampaignLabelsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateCampaignLabels(\Google\Ads\GoogleAds\V18\Services\MutateCampaignLabelsRequest $argument,
      $metadata = [], $options = []) {
