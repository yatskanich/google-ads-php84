...
class KeywordThemeConstantServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V18\Services\SuggestKeywordThemeConstantsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function SuggestKeywordThemeConstants(\Google\Ads\GoogleAds\V18\Services\SuggestKeywordThemeConstantsRequest $argument,
      $metadata = [], $options = []) {
