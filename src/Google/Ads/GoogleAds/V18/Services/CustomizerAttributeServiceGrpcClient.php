...
class CustomizerAttributeServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * returned.
     * @param \Google\Ads\GoogleAds\V18\Services\MutateCustomizerAttributesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateCustomizerAttributes(\Google\Ads\GoogleAds\V18\Services\MutateCustomizerAttributesRequest $argument,
      $metadata = [], $options = []) {
