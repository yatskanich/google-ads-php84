...
return [
    'interfaces' => [
        'google.ads.googleads.v18.services.AssetGroupListingGroupFilterService' => [
            'MutateAssetGroupListingGroupFilters' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V18\Services\MutateAssetGroupListingGroupFiltersResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
