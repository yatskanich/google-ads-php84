...
return [
    'interfaces' => [
        'google.ads.googleads.v18.services.CustomerExtensionSettingService' => [
            'MutateCustomerExtensionSettings' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V18\Services\MutateCustomerExtensionSettingsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
