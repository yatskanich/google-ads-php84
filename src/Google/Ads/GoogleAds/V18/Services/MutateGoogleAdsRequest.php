 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v18.services.MutateGoogleAdsRequest</code>
 */
class MutateGoogleAdsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.services.MutateOperation mutate_operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Ads\GoogleAds\V18\Services\MutateOperation[] $mutateOperations Required. The list of operations to perform on individual resources.
     *
     * @return \Google\Ads\GoogleAds\V18\Services\MutateGoogleAdsRequest
     *
     * @experimental
     */
     ...
     *           Required. The ID of the customer whose resources are being modified.
     *     @type array<\Google\Ads\GoogleAds\V18\Services\MutateOperation>|\Google\Protobuf\Internal\RepeatedField $mutate_operations
     *           Required. The list of operations to perform on individual resources.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.services.MutateOperation mutate_operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V18\Services\MutateOperation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMutateOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V18\Services\MutateOperation::class);
