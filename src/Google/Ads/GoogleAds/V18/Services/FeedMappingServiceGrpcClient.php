...
class FeedMappingServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [StringFormatError]()
     *   [StringLengthError]()
     * @param \Google\Ads\GoogleAds\V18\Services\MutateFeedMappingsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MutateFeedMappings(\Google\Ads\GoogleAds\V18\Services\MutateFeedMappingsRequest $argument,
      $metadata = [], $options = []) {
