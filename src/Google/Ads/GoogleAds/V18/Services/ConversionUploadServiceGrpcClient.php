...
class ConversionUploadServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V18\Services\UploadClickConversionsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function UploadClickConversions(\Google\Ads\GoogleAds\V18\Services\UploadClickConversionsRequest $argument,
      $metadata = [], $options = []) {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V18\Services\UploadCallConversionsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function UploadCallConversions(\Google\Ads\GoogleAds\V18\Services\UploadCallConversionsRequest $argument,
      $metadata = [], $options = []) {
