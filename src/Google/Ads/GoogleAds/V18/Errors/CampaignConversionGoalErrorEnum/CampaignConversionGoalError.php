...
# source: google/ads/googleads/v18/errors/campaign_conversion_goal_error.proto

namespace Google\Ads\GoogleAds\V18\Errors\CampaignConversionGoalErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v18.errors.CampaignConversionGoalErrorEnum.CampaignConversionGoalError</code>
 */
class CampaignConversionGoalError
{
     ...
     *
     * Generated from protobuf enum <code>CANNOT_USE_STORE_SALE_GOAL_FOR_PERFORMANCE_MAX_CAMPAIGN = 3;</code>
     */
...
class_alias(CampaignConversionGoalError::class, \Google\Ads\GoogleAds\V18\Errors\CampaignConversionGoalErrorEnum_CampaignConversionGoalError::class);
