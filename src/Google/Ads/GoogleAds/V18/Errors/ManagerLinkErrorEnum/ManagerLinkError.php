...
namespace Google\Ads\GoogleAds\V18\Errors\ManagerLinkErrorEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v18.errors.ManagerLinkErrorEnum.ManagerLinkError</code>
 */
class ManagerLinkError
{
    ...
    private static $valueToName = [
        ...
        self::CUSTOMER_CANNOT_MANAGE_SELF => 'CUSTOMER_CANNOT_MANAGE_SELF',
        self::CREATING_ENABLED_LINK_NOT_ALLOWED => 'CREATING_ENABLED_LINK_NOT_ALLOWED',
    ];
...
class_alias(ManagerLinkError::class, \Google\Ads\GoogleAds\V18\Errors\ManagerLinkErrorEnum_ManagerLinkError::class);
