 ...
 * graph.
 *
 * Generated from protobuf message <code>google.ads.googleads.v18.common.BrandInfo</code>
 */
class BrandInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v18.enums.BrandRequestRejectionReasonEnum.BrandRequestRejectionReason rejection_reason = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $rejection_reason = null;
    /**
     * Output only. The status of a brand.
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v18.enums.BrandStateEnum.BrandState status = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V18\Enums\BrandRequestRejectionReasonEnum\BrandRequestRejectionReason::class);
