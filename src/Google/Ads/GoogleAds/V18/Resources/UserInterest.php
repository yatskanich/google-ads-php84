 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v18.resources.UserInterest</code>
 */
class UserInterest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v18.enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType taxonomy_type = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.common.CriterionCategoryAvailability availabilities = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. True if the user interest is launched to all channels and
     *           locales.
     *     @type array<\Google\Ads\GoogleAds\V18\Common\CriterionCategoryAvailability>|\Google\Protobuf\Internal\RepeatedField $availabilities
     *           Output only. Availability information of the user interest.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V18\Resources\UserInterest::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V18\Enums\UserInterestTaxonomyTypeEnum\UserInterestTaxonomyType::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v18.common.CriterionCategoryAvailability availabilities = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Ads\GoogleAds\V18\Common\CriterionCategoryAvailability>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAvailabilities($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V18\Common\CriterionCategoryAvailability::class);
