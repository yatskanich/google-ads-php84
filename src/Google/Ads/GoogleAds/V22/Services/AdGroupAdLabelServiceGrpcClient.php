...
class AdGroupAdLabelServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateAdGroupAdLabels(\Google\Ads\GoogleAds\V22\Services\MutateAdGroupAdLabelsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.AdGroupAdLabelService/MutateAdGroupAdLabels',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\MutateAdGroupAdLabelsResponse::class, 'decode'],
        $metadata, $options);
    }
