...
class BiddingStrategyServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateBiddingStrategies(\Google\Ads\GoogleAds\V22\Services\MutateBiddingStrategiesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.BiddingStrategyService/MutateBiddingStrategies',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\MutateBiddingStrategiesResponse::class, 'decode'],
        $metadata, $options);
    }
