...
/**
 * Request message for
 * [SmartCampaignSettingService.MutateSmartCampaignSettings][google.ads.googleads.v22.services.SmartCampaignSettingService.MutateSmartCampaignSettings].
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.MutateSmartCampaignSettingsRequest</code>
 */
class MutateSmartCampaignSettingsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                                       modified.
     * @param \Google\Ads\GoogleAds\V22\Services\SmartCampaignSettingOperation[] $operations Required. The list of operations to perform on individual Smart campaign
     *                                                                                       settings.
     *
     * @return \Google\Ads\GoogleAds\V22\Services\MutateSmartCampaignSettingsRequest
     *
     * @experimental
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Services\SmartCampaignSettingOperation::class);
        $this->operations = $arr;
