 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.ApplyRecommendationOperation.AdAssetApplyParameters</code>
 */
class AdAssetApplyParameters extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v22.resources.Asset new_assets = 1;</code>
     */
    private $new_assets;
    /**
     ...
     * customer scope.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.services.ApplyRecommendationOperation.AdAssetApplyParameters.ApplyScope scope = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $scope = 0;
     ...
     *
     *     @type \Google\Ads\GoogleAds\V22\Resources\Asset[] $new_assets
     *           The assets to create and attach to a scope. This may be combined with
     *           existing_assets in the same call.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v22.resources.Asset new_assets = 1;</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V22\Resources\Asset>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v22.resources.Asset new_assets = 1;</code>
     * @param \Google\Ads\GoogleAds\V22\Resources\Asset[] $var
     * @return $this
     */
    public function setNewAssets($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Resources\Asset::class);
        $this->new_assets = $arr;
