...
/**
 * Request message for
 * [ConversionValueRuleSetService.MutateConversionValueRuleSets][google.ads.googleads.v22.services.ConversionValueRuleSetService.MutateConversionValueRuleSets].
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.MutateConversionValueRuleSetsRequest</code>
 */
class MutateConversionValueRuleSetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                                         modified.
     * @param \Google\Ads\GoogleAds\V22\Services\ConversionValueRuleSetOperation[] $operations Required. The list of operations to perform on individual conversion value
     *                                                                                         rule sets.
     *
     * @return \Google\Ads\GoogleAds\V22\Services\MutateConversionValueRuleSetsRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V22\Services\ConversionValueRuleSetService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Services\ConversionValueRuleSetOperation::class);
        $this->operations = $arr;
