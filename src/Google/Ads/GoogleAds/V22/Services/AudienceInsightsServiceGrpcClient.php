...
class AudienceInsightsServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GenerateInsightsFinderReport(\Google\Ads\GoogleAds\V22\Services\GenerateInsightsFinderReportRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.AudienceInsightsService/GenerateInsightsFinderReport',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\GenerateInsightsFinderReportResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function ListAudienceInsightsAttributes(\Google\Ads\GoogleAds\V22\Services\ListAudienceInsightsAttributesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.AudienceInsightsService/ListAudienceInsightsAttributes',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\ListAudienceInsightsAttributesResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function ListInsightsEligibleDates(\Google\Ads\GoogleAds\V22\Services\ListInsightsEligibleDatesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.AudienceInsightsService/ListInsightsEligibleDates',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\ListInsightsEligibleDatesResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function GenerateAudienceCompositionInsights(\Google\Ads\GoogleAds\V22\Services\GenerateAudienceCompositionInsightsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.AudienceInsightsService/GenerateAudienceCompositionInsights',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\GenerateAudienceCompositionInsightsResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function GenerateSuggestedTargetingInsights(\Google\Ads\GoogleAds\V22\Services\GenerateSuggestedTargetingInsightsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.AudienceInsightsService/GenerateSuggestedTargetingInsights',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\GenerateSuggestedTargetingInsightsResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function GenerateAudienceOverlapInsights(\Google\Ads\GoogleAds\V22\Services\GenerateAudienceOverlapInsightsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.AudienceInsightsService/GenerateAudienceOverlapInsights',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\GenerateAudienceOverlapInsightsResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function GenerateTargetingSuggestionMetrics(\Google\Ads\GoogleAds\V22\Services\GenerateTargetingSuggestionMetricsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.AudienceInsightsService/GenerateTargetingSuggestionMetrics',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\GenerateTargetingSuggestionMetricsResponse::class, 'decode'],
        $metadata, $options);
    }
