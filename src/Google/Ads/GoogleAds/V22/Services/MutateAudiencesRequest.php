...
/**
 * Request message for
 * [AudienceService.MutateAudiences][google.ads.googleads.v22.services.AudienceService.MutateAudiences].
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.MutateAudiencesRequest</code>
 */
class MutateAudiencesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Ads\GoogleAds\V22\Services\AudienceOperation[] $operations Required. The list of operations to perform on individual audiences.
     *
     * @return \Google\Ads\GoogleAds\V22\Services\MutateAudiencesRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V22\Services\AudienceService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Services\AudienceOperation::class);
        $this->operations = $arr;
