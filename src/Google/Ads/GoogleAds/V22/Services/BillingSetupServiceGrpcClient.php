...
class BillingSetupServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V22\Services\MutateBillingSetupRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Google\Ads\GoogleAds\V22\Services\MutateBillingSetupResponse>
     */
    public function MutateBillingSetup(\Google\Ads\GoogleAds\V22\Services\MutateBillingSetupRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.BillingSetupService/MutateBillingSetup',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\MutateBillingSetupResponse::class, 'decode'],
        $metadata, $options);
    }
