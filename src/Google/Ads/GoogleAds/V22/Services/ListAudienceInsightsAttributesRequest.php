 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.ListAudienceInsightsAttributesRequest</code>
 */
class ListAudienceInsightsAttributesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.common.LocationInfo youtube_reach_location = 6;</code>
     */
     ...
     *                           returned.
     *
     * @return \Google\Ads\GoogleAds\V22\Services\ListAudienceInsightsAttributesRequest
     *
     * @experimental
     */
     ...
     *           attributes are not filtered by country. Setting this field when
     *           SUB_COUNTRY_LOCATION attributes are not requested will return an error.
     *     @type \Google\Ads\GoogleAds\V22\Common\LocationInfo $youtube_reach_location
     *           If present, potential YouTube reach estimates within the specified market
     *           will be returned for attributes for which they are available.  Reach is
     *           only available for the AGE_RANGE, GENDER, AFFINITY_USER_INTEREST and
     *           IN_MARKET_USER_INTEREST dimensions, and may not be available for every
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Common\LocationInfo::class);
