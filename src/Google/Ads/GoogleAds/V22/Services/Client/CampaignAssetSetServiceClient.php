 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/campaign_asset_set_service.proto
 ...
 *
 * @method PromiseInterface<MutateCampaignAssetSetsResponse> mutateCampaignAssetSetsAsync(MutateCampaignAssetSetsRequest $request, array $optionalArgs = [])
 */
class CampaignAssetSetServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.CampaignAssetSetService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/campaign_asset_set_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/campaign_asset_set_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/campaign_asset_set_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/campaign_asset_set_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V22\Services\CampaignAssetSetServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CampaignAssetSetServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateCampaignAssetSetsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCampaignAssetSets(MutateCampaignAssetSetsRequest $request, array $callOptions = []): MutateCampaignAssetSetsResponse
    {
        return $this->startApiCall('MutateCampaignAssetSets', $request, $callOptions)->wait();
    }
}
