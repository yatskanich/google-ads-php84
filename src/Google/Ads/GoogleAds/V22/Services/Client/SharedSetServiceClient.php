 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/shared_set_service.proto
 ...
 *
 * @method PromiseInterface<MutateSharedSetsResponse> mutateSharedSetsAsync(MutateSharedSetsRequest $request, array $optionalArgs = [])
 */
class SharedSetServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.SharedSetService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/shared_set_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/shared_set_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/shared_set_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/shared_set_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V22\Services\SharedSetServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new SharedSetServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateSharedSetsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateSharedSets(MutateSharedSetsRequest $request, array $callOptions = []): MutateSharedSetsResponse
    {
        return $this->startApiCall('MutateSharedSets', $request, $callOptions)->wait();
    }
}
