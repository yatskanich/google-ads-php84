 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/campaign_bid_modifier_service.proto
 ...
 *
 * @method PromiseInterface<MutateCampaignBidModifiersResponse> mutateCampaignBidModifiersAsync(MutateCampaignBidModifiersRequest $request, array $optionalArgs = [])
 */
class CampaignBidModifierServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.CampaignBidModifierService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/campaign_bid_modifier_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/campaign_bid_modifier_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/campaign_bid_modifier_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/campaign_bid_modifier_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V22\Services\CampaignBidModifierServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CampaignBidModifierServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see CampaignBidModifierServiceClient::mutateCampaignBidModifiersAsync()} .
     *
     * @param MutateCampaignBidModifiersRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateCampaignBidModifiersResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCampaignBidModifiers(MutateCampaignBidModifiersRequest $request, array $callOptions = []): MutateCampaignBidModifiersResponse
    {
        return $this->startApiCall('MutateCampaignBidModifiers', $request, $callOptions)->wait();
    }
}
