 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/keyword_plan_campaign_service.proto
 ...
 *
 * @method PromiseInterface<MutateKeywordPlanCampaignsResponse> mutateKeywordPlanCampaignsAsync(MutateKeywordPlanCampaignsRequest $request, array $optionalArgs = [])
 */
class KeywordPlanCampaignServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.KeywordPlanCampaignService';
     ...
     *           use Google\Ads\GoogleAds\V22\Services\KeywordPlanCampaignServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new KeywordPlanCampaignServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see KeywordPlanCampaignServiceClient::mutateKeywordPlanCampaignsAsync()} .
     *
     * @param MutateKeywordPlanCampaignsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateKeywordPlanCampaignsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateKeywordPlanCampaigns(MutateKeywordPlanCampaignsRequest $request, array $callOptions = []): MutateKeywordPlanCampaignsResponse
    {
        return $this->startApiCall('MutateKeywordPlanCampaigns', $request, $callOptions)->wait();
    }
}
