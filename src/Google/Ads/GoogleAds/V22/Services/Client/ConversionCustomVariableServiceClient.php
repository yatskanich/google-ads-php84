 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/conversion_custom_variable_service.proto
 ...
 *
 * @method PromiseInterface<MutateConversionCustomVariablesResponse> mutateConversionCustomVariablesAsync(MutateConversionCustomVariablesRequest $request, array $optionalArgs = [])
 */
class ConversionCustomVariableServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.ConversionCustomVariableService';
     ...
     *           use Google\Ads\GoogleAds\V22\Services\ConversionCustomVariableServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ConversionCustomVariableServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see ConversionCustomVariableServiceClient::mutateConversionCustomVariablesAsync()}
     * .
     *
     * @param MutateConversionCustomVariablesRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateConversionCustomVariablesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateConversionCustomVariables(MutateConversionCustomVariablesRequest $request, array $callOptions = []): MutateConversionCustomVariablesResponse
    {
        return $this->startApiCall('MutateConversionCustomVariables', $request, $callOptions)->wait();
    }
}
