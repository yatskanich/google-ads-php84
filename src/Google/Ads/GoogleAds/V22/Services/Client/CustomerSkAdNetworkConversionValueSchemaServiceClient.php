 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/customer_sk_ad_network_conversion_value_schema_service.proto
...
use Google\Ads\GoogleAds\V22\Services\MutateCustomerSkAdNetworkConversionValueSchemaRequest;
use Google\Ads\GoogleAds\V22\Services\MutateCustomerSkAdNetworkConversionValueSchemaResponse;
 ...
 *
 * @method PromiseInterface<MutateCustomerSkAdNetworkConversionValueSchemaResponse> mutateCustomerSkAdNetworkConversionValueSchemaAsync(MutateCustomerSkAdNetworkConversionValueSchemaRequest $request, array $optionalArgs = [])
 */
class CustomerSkAdNetworkConversionValueSchemaServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.CustomerSkAdNetworkConversionValueSchemaService';
     ...
     */
    public static function customerSkAdNetworkConversionValueSchemaName(string $customerId, string $accountLinkId): string
    {
        return self::getPathTemplate('customerSkAdNetworkConversionValueSchema')->render([
     ...
     *           use
     *           Google\Ads\GoogleAds\V22\Services\CustomerSkAdNetworkConversionValueSchemaServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new
     *           CustomerSkAdNetworkConversionValueSchemaServiceClient(['credentials' =>
     *           $creds]);
     *           ```
     *           {@see
     ...
     * {@see CustomerSkAdNetworkConversionValueSchemaServiceClient::mutateCustomerSkAdNetworkConversionValueSchemaAsync()}
     * .
     *
     * @param MutateCustomerSkAdNetworkConversionValueSchemaRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateCustomerSkAdNetworkConversionValueSchemaResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCustomerSkAdNetworkConversionValueSchema(MutateCustomerSkAdNetworkConversionValueSchemaRequest $request, array $callOptions = []): MutateCustomerSkAdNetworkConversionValueSchemaResponse
    {
        return $this->startApiCall('MutateCustomerSkAdNetworkConversionValueSchema', $request, $callOptions)->wait();
    }
}
