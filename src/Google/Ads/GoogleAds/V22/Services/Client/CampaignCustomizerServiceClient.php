 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/campaign_customizer_service.proto
 ...
 *
 * @method PromiseInterface<MutateCampaignCustomizersResponse> mutateCampaignCustomizersAsync(MutateCampaignCustomizersRequest $request, array $optionalArgs = [])
 */
class CampaignCustomizerServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.CampaignCustomizerService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/campaign_customizer_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/campaign_customizer_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/campaign_customizer_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/campaign_customizer_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V22\Services\CampaignCustomizerServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CampaignCustomizerServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see CampaignCustomizerServiceClient::mutateCampaignCustomizersAsync()} .
     *
     * @param MutateCampaignCustomizersRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateCampaignCustomizersResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCampaignCustomizers(MutateCampaignCustomizersRequest $request, array $callOptions = []): MutateCampaignCustomizersResponse
    {
        return $this->startApiCall('MutateCampaignCustomizers', $request, $callOptions)->wait();
    }
}
