 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/smart_campaign_setting_service.proto
...
class SmartCampaignSettingServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.SmartCampaignSettingService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/smart_campaign_setting_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/smart_campaign_setting_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/smart_campaign_setting_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/smart_campaign_setting_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V22\Services\SmartCampaignSettingServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new SmartCampaignSettingServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function getSmartCampaignStatus(GetSmartCampaignStatusRequest $request, array $callOptions = []): GetSmartCampaignStatusResponse
    {
        return $this->startApiCall('GetSmartCampaignStatus', $request, $callOptions)->wait();
    }
     ...
     * }
     *
     * @return MutateSmartCampaignSettingsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateSmartCampaignSettings(MutateSmartCampaignSettingsRequest $request, array $callOptions = []): MutateSmartCampaignSettingsResponse
    {
        return $this->startApiCall('MutateSmartCampaignSettings', $request, $callOptions)->wait();
    }
}
