 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/campaign_shared_set_service.proto
 ...
 *
 * @method PromiseInterface<MutateCampaignSharedSetsResponse> mutateCampaignSharedSetsAsync(MutateCampaignSharedSetsRequest $request, array $optionalArgs = [])
 */
class CampaignSharedSetServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.CampaignSharedSetService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/campaign_shared_set_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/campaign_shared_set_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/campaign_shared_set_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/campaign_shared_set_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V22\Services\CampaignSharedSetServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CampaignSharedSetServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see CampaignSharedSetServiceClient::mutateCampaignSharedSetsAsync()} .
     *
     * @param MutateCampaignSharedSetsRequest $request     A request to house fields associated with the call.
     ...
     */
    public function mutateCampaignSharedSets(MutateCampaignSharedSetsRequest $request, array $callOptions = []): MutateCampaignSharedSetsResponse
    {
        return $this->startApiCall('MutateCampaignSharedSets', $request, $callOptions)->wait();
    }
}
