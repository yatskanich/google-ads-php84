 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/conversion_adjustment_upload_service.proto
 ...
 *
 * @method PromiseInterface<UploadConversionAdjustmentsResponse> uploadConversionAdjustmentsAsync(UploadConversionAdjustmentsRequest $request, array $optionalArgs = [])
 */
class ConversionAdjustmentUploadServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.ConversionAdjustmentUploadService';
     ...
     *           use Google\Ads\GoogleAds\V22\Services\ConversionAdjustmentUploadServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ConversionAdjustmentUploadServiceClient(['credentials' =>
     *           $creds]);
     *           ```
     *           {@see
     ...
     * {@see ConversionAdjustmentUploadServiceClient::uploadConversionAdjustmentsAsync()}
     * .
     *
     * @param UploadConversionAdjustmentsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return UploadConversionAdjustmentsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function uploadConversionAdjustments(UploadConversionAdjustmentsRequest $request, array $callOptions = []): UploadConversionAdjustmentsResponse
    {
        return $this->startApiCall('UploadConversionAdjustments', $request, $callOptions)->wait();
    }
}
