 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/ad_group_customizer_service.proto
 ...
 *
 * @method PromiseInterface<MutateAdGroupCustomizersResponse> mutateAdGroupCustomizersAsync(MutateAdGroupCustomizersRequest $request, array $optionalArgs = [])
 */
class AdGroupCustomizerServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.AdGroupCustomizerService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/ad_group_customizer_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/ad_group_customizer_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/ad_group_customizer_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/ad_group_customizer_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V22\Services\AdGroupCustomizerServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AdGroupCustomizerServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see AdGroupCustomizerServiceClient::mutateAdGroupCustomizersAsync()} .
     *
     * @param MutateAdGroupCustomizersRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateAdGroupCustomizersResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAdGroupCustomizers(MutateAdGroupCustomizersRequest $request, array $callOptions = []): MutateAdGroupCustomizersResponse
    {
        return $this->startApiCall('MutateAdGroupCustomizers', $request, $callOptions)->wait();
    }
}
