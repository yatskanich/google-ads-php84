 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/local_services_lead_service.proto
...
use Google\Ads\GoogleAds\V22\Services\Conversation;
...
class LocalServicesLeadServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.LocalServicesLeadService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/local_services_lead_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/local_services_lead_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/local_services_lead_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/local_services_lead_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * local_services_lead resource.
     *
     * @param string $customerId
     * @param string $localServicesLeadId
     *
     * @return string The formatted local_services_lead resource.
     */
    public static function localServicesLeadName(string $customerId, string $localServicesLeadId): string
    {
        return self::getPathTemplate('localServicesLead')->render([
     ...
     *           use Google\Ads\GoogleAds\V22\Services\LocalServicesLeadServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new LocalServicesLeadServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return AppendLeadConversationResponse
     *
