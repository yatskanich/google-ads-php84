 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/asset_group_listing_group_filter_service.proto
 ...
 *
 * @method PromiseInterface<MutateAssetGroupListingGroupFiltersResponse> mutateAssetGroupListingGroupFiltersAsync(MutateAssetGroupListingGroupFiltersRequest $request, array $optionalArgs = [])
 */
class AssetGroupListingGroupFilterServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.AssetGroupListingGroupFilterService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/asset_group_listing_group_filter_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/asset_group_listing_group_filter_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/asset_group_listing_group_filter_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/asset_group_listing_group_filter_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V22\Services\AssetGroupListingGroupFilterServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AssetGroupListingGroupFilterServiceClient(['credentials' =>
     *           $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateAssetGroupListingGroupFiltersResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAssetGroupListingGroupFilters(MutateAssetGroupListingGroupFiltersRequest $request, array $callOptions = []): MutateAssetGroupListingGroupFiltersResponse
    {
        return $this->startApiCall('MutateAssetGroupListingGroupFilters', $request, $callOptions)->wait();
    }
}
