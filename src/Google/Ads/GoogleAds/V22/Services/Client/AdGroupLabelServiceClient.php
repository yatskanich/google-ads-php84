 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/ad_group_label_service.proto
 ...
 *
 * @method PromiseInterface<MutateAdGroupLabelsResponse> mutateAdGroupLabelsAsync(MutateAdGroupLabelsRequest $request, array $optionalArgs = [])
 */
class AdGroupLabelServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.AdGroupLabelService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/ad_group_label_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/ad_group_label_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/ad_group_label_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/ad_group_label_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V22\Services\AdGroupLabelServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AdGroupLabelServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see AdGroupLabelServiceClient::mutateAdGroupLabelsAsync()} .
     *
     * @param MutateAdGroupLabelsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateAdGroupLabelsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAdGroupLabels(MutateAdGroupLabelsRequest $request, array $callOptions = []): MutateAdGroupLabelsResponse
    {
        return $this->startApiCall('MutateAdGroupLabels', $request, $callOptions)->wait();
    }
}
