 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/google_ads_field_service.proto
 ...
 *
 * @method PromiseInterface<GoogleAdsField> getGoogleAdsFieldAsync(GetGoogleAdsFieldRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> searchGoogleAdsFieldsAsync(SearchGoogleAdsFieldsRequest $request, array $optionalArgs = [])
 */
class GoogleAdsFieldServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.GoogleAdsFieldService';
     ...
     */
    public static function googleAdsFieldName(string $googleAdsField): string
    {
        return self::getPathTemplate('googleAdsField')->render([
     ...
     *           use Google\Ads\GoogleAds\V22\Services\GoogleAdsFieldServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new GoogleAdsFieldServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function getGoogleAdsField(GetGoogleAdsFieldRequest $request, array $callOptions = []): GoogleAdsField
    {
        return $this->startApiCall('GetGoogleAdsField', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function searchGoogleAdsFields(SearchGoogleAdsFieldsRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('SearchGoogleAdsFields', $request, $callOptions);
    }
}
