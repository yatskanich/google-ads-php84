 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/audience_service.proto
 ...
 *
 * @method PromiseInterface<MutateAudiencesResponse> mutateAudiencesAsync(MutateAudiencesRequest $request, array $optionalArgs = [])
 */
class AudienceServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.AudienceService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/audience_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/audience_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/audience_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/audience_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V22\Services\AudienceServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AudienceServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * [AudienceError]()
     *
     * The async variant is {@see AudienceServiceClient::mutateAudiencesAsync()} .
     *
     ...
     * }
     *
     * @return MutateAudiencesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateAudiences(MutateAudiencesRequest $request, array $callOptions = []): MutateAudiencesResponse
    {
        return $this->startApiCall('MutateAudiences', $request, $callOptions)->wait();
    }
}
