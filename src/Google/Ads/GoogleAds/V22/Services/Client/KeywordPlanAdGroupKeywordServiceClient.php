 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/keyword_plan_ad_group_keyword_service.proto
 ...
 *
 * @method PromiseInterface<MutateKeywordPlanAdGroupKeywordsResponse> mutateKeywordPlanAdGroupKeywordsAsync(MutateKeywordPlanAdGroupKeywordsRequest $request, array $optionalArgs = [])
 */
class KeywordPlanAdGroupKeywordServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.KeywordPlanAdGroupKeywordService';
     ...
     *           use Google\Ads\GoogleAds\V22\Services\KeywordPlanAdGroupKeywordServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new KeywordPlanAdGroupKeywordServiceClient(['credentials' =>
     *           $creds]);
     *           ```
     *           {@see
     ...
     * {@see KeywordPlanAdGroupKeywordServiceClient::mutateKeywordPlanAdGroupKeywordsAsync()}
     * .
     *
     * @param MutateKeywordPlanAdGroupKeywordsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return MutateKeywordPlanAdGroupKeywordsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateKeywordPlanAdGroupKeywords(MutateKeywordPlanAdGroupKeywordsRequest $request, array $callOptions = []): MutateKeywordPlanAdGroupKeywordsResponse
    {
        return $this->startApiCall('MutateKeywordPlanAdGroupKeywords', $request, $callOptions)->wait();
    }
}
