 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/smart_campaign_suggest_service.proto
 ...
 *
 * @method PromiseInterface<SuggestKeywordThemesResponse> suggestKeywordThemesAsync(SuggestKeywordThemesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<SuggestSmartCampaignAdResponse> suggestSmartCampaignAdAsync(SuggestSmartCampaignAdRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<SuggestSmartCampaignBudgetOptionsResponse> suggestSmartCampaignBudgetOptionsAsync(SuggestSmartCampaignBudgetOptionsRequest $request, array $optionalArgs = [])
 */
class SmartCampaignSuggestServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.SmartCampaignSuggestService';
     ...
     *           use Google\Ads\GoogleAds\V22\Services\SmartCampaignSuggestServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new SmartCampaignSuggestServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return SuggestKeywordThemesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function suggestKeywordThemes(SuggestKeywordThemesRequest $request, array $callOptions = []): SuggestKeywordThemesResponse
    {
        return $this->startApiCall('SuggestKeywordThemes', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function suggestSmartCampaignAd(SuggestSmartCampaignAdRequest $request, array $callOptions = []): SuggestSmartCampaignAdResponse
    {
        return $this->startApiCall('SuggestSmartCampaignAd', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function suggestSmartCampaignBudgetOptions(SuggestSmartCampaignBudgetOptionsRequest $request, array $callOptions = []): SuggestSmartCampaignBudgetOptionsResponse
    {
        return $this->startApiCall('SuggestSmartCampaignBudgetOptions', $request, $callOptions)->wait();
    }
}
