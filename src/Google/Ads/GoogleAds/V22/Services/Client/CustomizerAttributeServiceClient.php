 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v22/services/customizer_attribute_service.proto
 ...
 *
 * @method PromiseInterface<MutateCustomizerAttributesResponse> mutateCustomizerAttributesAsync(MutateCustomizerAttributesRequest $request, array $optionalArgs = [])
 */
class CustomizerAttributeServiceClient
{
    ...
    private const string SERVICE_NAME = 'google.ads.googleads.v22.services.CustomizerAttributeService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/customizer_attribute_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/customizer_attribute_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/customizer_attribute_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/customizer_attribute_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\GoogleAds\V22\Services\CustomizerAttributeServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomizerAttributeServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return MutateCustomizerAttributesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function mutateCustomizerAttributes(MutateCustomizerAttributesRequest $request, array $callOptions = []): MutateCustomizerAttributesResponse
    {
        return $this->startApiCall('MutateCustomizerAttributes', $request, $callOptions)->wait();
    }
}
