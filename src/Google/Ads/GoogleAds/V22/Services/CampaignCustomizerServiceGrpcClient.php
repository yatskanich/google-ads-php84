...
class CampaignCustomizerServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateCampaignCustomizers(\Google\Ads\GoogleAds\V22\Services\MutateCampaignCustomizersRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.CampaignCustomizerService/MutateCampaignCustomizers',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\MutateCampaignCustomizersResponse::class, 'decode'],
        $metadata, $options);
    }
