...
class MutateRecommendationSubscriptionRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Ads\GoogleAds\V22\Services\RecommendationSubscriptionOperation[] $operations Required. The list of create or update operations.
     *
     * @return \Google\Ads\GoogleAds\V22\Services\MutateRecommendationSubscriptionRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V22\Services\RecommendationSubscriptionService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Services\RecommendationSubscriptionOperation::class);
        $this->operations = $arr;
