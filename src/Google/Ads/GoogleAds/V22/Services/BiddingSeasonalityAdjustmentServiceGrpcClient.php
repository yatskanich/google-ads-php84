...
class BiddingSeasonalityAdjustmentServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateBiddingSeasonalityAdjustments(\Google\Ads\GoogleAds\V22\Services\MutateBiddingSeasonalityAdjustmentsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.BiddingSeasonalityAdjustmentService/MutateBiddingSeasonalityAdjustments',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\MutateBiddingSeasonalityAdjustmentsResponse::class, 'decode'],
        $metadata, $options);
    }
