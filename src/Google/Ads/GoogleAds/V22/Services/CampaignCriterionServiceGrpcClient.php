...
class CampaignCriterionServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateCampaignCriteria(\Google\Ads\GoogleAds\V22\Services\MutateCampaignCriteriaRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.CampaignCriterionService/MutateCampaignCriteria',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\MutateCampaignCriteriaResponse::class, 'decode'],
        $metadata, $options);
    }
