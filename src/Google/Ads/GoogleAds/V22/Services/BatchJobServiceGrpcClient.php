...
class BatchJobServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateBatchJob(\Google\Ads\GoogleAds\V22\Services\MutateBatchJobRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.BatchJobService/MutateBatchJob',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\MutateBatchJobResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function ListBatchJobResults(\Google\Ads\GoogleAds\V22\Services\ListBatchJobResultsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.BatchJobService/ListBatchJobResults',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\ListBatchJobResultsResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function RunBatchJob(\Google\Ads\GoogleAds\V22\Services\RunBatchJobRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.BatchJobService/RunBatchJob',
        $argument,
    ...
    public function AddBatchJobOperations(\Google\Ads\GoogleAds\V22\Services\AddBatchJobOperationsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.BatchJobService/AddBatchJobOperations',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\AddBatchJobOperationsResponse::class, 'decode'],
        $metadata, $options);
    }
