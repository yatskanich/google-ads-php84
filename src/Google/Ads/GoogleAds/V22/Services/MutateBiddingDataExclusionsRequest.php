...
# source: google/ads/googleads/v22/services/bidding_data_exclusion_service.proto
...
/**
 * Request message for
 * [BiddingDataExclusionService.MutateBiddingDataExclusions][google.ads.googleads.v22.services.BiddingDataExclusionService.MutateBiddingDataExclusions].
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.MutateBiddingDataExclusionsRequest</code>
 */
class MutateBiddingDataExclusionsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Ads\GoogleAds\V22\Services\BiddingDataExclusionOperation[] $operations Required. The list of operations to perform on individual data exclusions.
     *
     * @return \Google\Ads\GoogleAds\V22\Services\MutateBiddingDataExclusionsRequest
     *
     * @experimental
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V22\Services\BiddingDataExclusionService::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Services\BiddingDataExclusionOperation::class);
        $this->operations = $arr;
