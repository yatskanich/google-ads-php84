...
class ExperimentServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function MutateExperiments(\Google\Ads\GoogleAds\V22\Services\MutateExperimentsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.ExperimentService/MutateExperiments',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\MutateExperimentsResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function EndExperiment(\Google\Ads\GoogleAds\V22\Services\EndExperimentRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.ExperimentService/EndExperiment',
        $argument,
    ...
    public function ListExperimentAsyncErrors(\Google\Ads\GoogleAds\V22\Services\ListExperimentAsyncErrorsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.ExperimentService/ListExperimentAsyncErrors',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\ListExperimentAsyncErrorsResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function GraduateExperiment(\Google\Ads\GoogleAds\V22\Services\GraduateExperimentRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.ExperimentService/GraduateExperiment',
        $argument,
        [\Google\Protobuf\GPBEmpty::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function ScheduleExperiment(\Google\Ads\GoogleAds\V22\Services\ScheduleExperimentRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.ExperimentService/ScheduleExperiment',
        $argument,
    ...
    public function PromoteExperiment(\Google\Ads\GoogleAds\V22\Services\PromoteExperimentRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.ExperimentService/PromoteExperiment',
        $argument,
        [\Google\LongRunning\Operation::class, 'decode'],
        $metadata, $options);
    }
