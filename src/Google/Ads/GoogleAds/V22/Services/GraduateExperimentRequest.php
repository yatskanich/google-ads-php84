 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.services.GraduateExperimentRequest</code>
 */
class GraduateExperimentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Ads\GoogleAds\V22\Services\CampaignBudgetMapping[] $campaignBudgetMappings Required. List of campaign budget mappings for graduation. Each campaign
     *                                                                                           that appears here will graduate, and will be assigned a new budget that is
     *                                                                                           paired with it in the mapping. The maximum size is one.
     *
     * @return \Google\Ads\GoogleAds\V22\Services\GraduateExperimentRequest
     *
     * @experimental
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Services\CampaignBudgetMapping::class);
