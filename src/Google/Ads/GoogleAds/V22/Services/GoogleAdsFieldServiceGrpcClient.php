...
class GoogleAdsFieldServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function GetGoogleAdsField(\Google\Ads\GoogleAds\V22\Services\GetGoogleAdsFieldRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.GoogleAdsFieldService/GetGoogleAdsField',
        $argument,
        [\Google\Ads\GoogleAds\V22\Resources\GoogleAdsField::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function SearchGoogleAdsFields(\Google\Ads\GoogleAds\V22\Services\SearchGoogleAdsFieldsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v22.services.GoogleAdsFieldService/SearchGoogleAdsFields',
        $argument,
        [\Google\Ads\GoogleAds\V22\Services\SearchGoogleAdsFieldsResponse::class, 'decode'],
        $metadata, $options);
    }
