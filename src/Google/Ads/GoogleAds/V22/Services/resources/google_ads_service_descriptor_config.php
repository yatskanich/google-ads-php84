    ...
    'interfaces' => [
        'google.ads.googleads.v22.services.GoogleAdsService' => [
            'Mutate' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V22\Services\MutateGoogleAdsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
            ...
            'Search' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V22\Services\SearchGoogleAdsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
            ...
            'SearchStream' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V22\Services\SearchGoogleAdsStreamResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
