 ...
 * A Product Category.
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.resources.ProductCategoryConstant</code>
 */
class ProductCategoryConstant extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.enums.ProductCategoryLevelEnum.ProductCategoryLevel level = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $level = 0;
    /**
     * Output only. State of the product category.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.enums.ProductCategoryStateEnum.ProductCategoryState state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     * Output only. List of all available localizations of the product category.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v22.resources.ProductCategoryConstant.ProductCategoryLocalization localizations = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *     @type int $state
     *           Output only. State of the product category.
     *     @type \Google\Ads\GoogleAds\V22\Resources\ProductCategoryConstant\ProductCategoryLocalization[] $localizations
     *           Output only. List of all available localizations of the product category.
     * }
     */
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Ads\GoogleAds\V22\Resources\ProductCategoryConstant::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v22.resources.ProductCategoryConstant.ProductCategoryLocalization localizations = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V22\Resources\ProductCategoryConstant\ProductCategoryLocalization>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v22.resources.ProductCategoryConstant.ProductCategoryLocalization localizations = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Ads\GoogleAds\V22\Resources\ProductCategoryConstant\ProductCategoryLocalization[] $var
     * @return $this
     */
    public function setLocalizations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Resources\ProductCategoryConstant\ProductCategoryLocalization::class);
