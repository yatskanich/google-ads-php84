...
namespace Google\Ads\GoogleAds\V22\Enums\UserListCrmDataSourceTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v22.enums.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceType</code>
 */
class UserListCrmDataSourceType
{
     ...
     *
     * Generated from protobuf enum <code>THIRD_PARTY_PARTNER_DATA = 5;</code>
     */
    const THIRD_PARTY_PARTNER_DATA = 5;
    ...
    private static $valueToName = [
        ...
        self::THIRD_PARTY_PARTNER_DATA => 'THIRD_PARTY_PARTNER_DATA',
    ];
