...
# source: google/ads/googleads/v22/enums/click_type.proto

namespace Google\Ads\GoogleAds\V22\Enums\ClickTypeEnum;
 ...
 *
 * Protobuf type <code>google.ads.googleads.v22.enums.ClickTypeEnum.ClickType</code>
 */
class ClickType
{
    /**
     ...
     * Vehicle Feed Assets.
     *
     * Generated from protobuf enum <code>VEHICLE_ASSETS = 60;</code>
     */
    const VEHICLE_ASSETS = 60;
    /**
     * Product Feed Assets.
     *
     * Generated from protobuf enum <code>PRODUCT_ASSETS = 61;</code>
     */
    const PRODUCT_ASSETS = 61;
    /**
     * Click on channel icon that navigates the user to the corresponding
     * YouTube channel.
     *
     * Generated from protobuf enum <code>VIDEO_CHANNEL_CLICK = 62;</code>
     */
    const VIDEO_CHANNEL_CLICK = 62;
    /**
     * Click on a related video that navigates the user to the video watch page.
     *
     * Generated from protobuf enum <code>VIDEO_RELATED_VIDEOS_CLICK = 63;</code>
     */
    const VIDEO_RELATED_VIDEOS_CLICK = 63;
    /**
     ...
     *
     * Generated from protobuf enum <code>CLICK_TO_MESSAGE_THIRD_PARTY_CLICK = 64;</code>
     */
    const CLICK_TO_MESSAGE_THIRD_PARTY_CLICK = 64;
    /**
     * Click on non-button surface of message ad that navigates the user to the
     * Google-hosted landing page.
     *
     * Generated from protobuf enum <code>CLICK_TO_MESSAGE_LANDING_PAGE_CLICK = 65;</code>
     */
    const CLICK_TO_MESSAGE_LANDING_PAGE_CLICK = 65;
    ...
    private static $valueToName = [
        ...
        self::VEHICLE_ASSETS => 'VEHICLE_ASSETS',
        self::PRODUCT_ASSETS => 'PRODUCT_ASSETS',
        self::VIDEO_CHANNEL_CLICK => 'VIDEO_CHANNEL_CLICK',
        self::VIDEO_RELATED_VIDEOS_CLICK => 'VIDEO_RELATED_VIDEOS_CLICK',
        self::CLICK_TO_MESSAGE_THIRD_PARTY_CLICK => 'CLICK_TO_MESSAGE_THIRD_PARTY_CLICK',
        self::CLICK_TO_MESSAGE_LANDING_PAGE_CLICK => 'CLICK_TO_MESSAGE_LANDING_PAGE_CLICK',
    ];
