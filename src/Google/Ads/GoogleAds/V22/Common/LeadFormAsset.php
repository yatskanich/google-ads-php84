 ...
 * A Lead Form asset.
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.common.LeadFormAsset</code>
 */
class LeadFormAsset extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionType call_to_action_type = 17 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * submitted.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.enums.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType post_submit_call_to_action_type = 19;</code>
     */
     ...
     * qualified.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent desired_intent = 21;</code>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Common\LeadFormField::class);
        $this->fields = $arr;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Common\LeadFormCustomQuestionField::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Common\LeadFormDeliveryMethod::class);
