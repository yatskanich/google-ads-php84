...
namespace Google\Ads\GoogleAds\V22\Common\TargetRestrictionOperation;
 ...
 * The operator.
 *
 * Protobuf type <code>google.ads.googleads.v22.common.TargetRestrictionOperation.Operator</code>
 */
class Operator
{
    /**
