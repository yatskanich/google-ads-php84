 ...
 * exclusive operands.
 *
 * Generated from protobuf message <code>google.ads.googleads.v22.common.FlexibleRuleUserListInfo</code>
 */
class FlexibleRuleUserListInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v22.enums.UserListFlexibleRuleOperatorEnum.UserListFlexibleRuleOperator inclusive_rule_operator = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v22.common.FlexibleRuleOperandInfo inclusive_operands = 2;</code>
     */
     ...
     * by OR.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v22.common.FlexibleRuleOperandInfo exclusive_operands = 3;</code>
     */
     ...
     *           Operator that defines how the inclusive operands are combined.
     *     @type \Google\Ads\GoogleAds\V22\Common\FlexibleRuleOperandInfo[] $inclusive_operands
     *           Rules representing users that should be included in the user list. These
     *           are located on the left side of the AND_NOT operator, and joined together
     *           by either AND/OR as specified by the inclusive_rule_operator.
     *     @type \Google\Ads\GoogleAds\V22\Common\FlexibleRuleOperandInfo[] $exclusive_operands
     *           Rules representing users that should be excluded from the user list. These
     *           are located on the right side of the AND_NOT operator, and joined together
     *           by OR.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v22.common.FlexibleRuleOperandInfo inclusive_operands = 2;</code>
     * @return RepeatedField<\Google\Ads\GoogleAds\V22\Common\FlexibleRuleOperandInfo>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v22.common.FlexibleRuleOperandInfo inclusive_operands = 2;</code>
     * @param \Google\Ads\GoogleAds\V22\Common\FlexibleRuleOperandInfo[] $var
     * @return $this
     */
    public function setInclusiveOperands($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V22\Common\FlexibleRuleOperandInfo::class);
