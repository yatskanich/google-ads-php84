...
namespace Google\Ads\GoogleAds\Util\V24;

use Google\Rpc\Status;
use Google\Ads\GoogleAds\V24\Errors\GoogleAdsError;
use Google\Ads\GoogleAds\V24\Errors\GoogleAdsFailure;
use Google\Ads\GoogleAds\V24\Errors\ErrorLocation\FieldPathElement;
