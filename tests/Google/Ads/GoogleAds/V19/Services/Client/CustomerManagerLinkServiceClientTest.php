...
use Google\Ads\GoogleAds\V19\Services\MoveManagerLinkRequest;
use Google\Ads\GoogleAds\V19\Services\MoveManagerLinkResponse;
use Google\Ads\GoogleAds\V19\Services\MutateCustomerManagerLinkRequest;
use Google\Ads\GoogleAds\V19\Services\MutateCustomerManagerLinkResponse;
...
class CustomerManagerLinkServiceClientTest extends GeneratedTest
{
    ...
    public function moveManagerLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v19.services.CustomerManagerLinkService/MoveManagerLink', $actualFuncCall);
    ...
    public function mutateCustomerManagerLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v19.services.CustomerManagerLinkService/MutateCustomerManagerLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
