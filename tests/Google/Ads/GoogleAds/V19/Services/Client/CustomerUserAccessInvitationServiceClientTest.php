...
use Google\Ads\GoogleAds\V19\Services\CustomerUserAccessInvitationOperation;
use Google\Ads\GoogleAds\V19\Services\MutateCustomerUserAccessInvitationRequest;
use Google\Ads\GoogleAds\V19\Services\MutateCustomerUserAccessInvitationResponse;
...
class CustomerUserAccessInvitationServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCustomerUserAccessInvitationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v19.services.CustomerUserAccessInvitationService/MutateCustomerUserAccessInvitation', $actualFuncCall);
