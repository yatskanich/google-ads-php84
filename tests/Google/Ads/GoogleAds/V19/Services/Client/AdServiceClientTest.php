...
use Google\Ads\GoogleAds\V19\Services\MutateAdsRequest;
use Google\Ads\GoogleAds\V19\Services\MutateAdsResponse;
...
class AdServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v19.services.AdService/MutateAds', $actualFuncCall);
