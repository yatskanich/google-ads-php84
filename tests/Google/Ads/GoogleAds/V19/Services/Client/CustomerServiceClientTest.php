...
use Google\Ads\GoogleAds\V19\Services\CreateCustomerClientResponse;
use Google\Ads\GoogleAds\V19\Services\CustomerOperation;
...
use Google\Ads\GoogleAds\V19\Services\MutateCustomerRequest;
use Google\Ads\GoogleAds\V19\Services\MutateCustomerResponse;
...
class CustomerServiceClientTest extends GeneratedTest
{
    ...
    public function createCustomerClientTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v19.services.CustomerService/CreateCustomerClient', $actualFuncCall);
    ...
    public function listAccessibleCustomersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v19.services.CustomerService/ListAccessibleCustomers', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function mutateCustomerTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v19.services.CustomerService/MutateCustomer', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
