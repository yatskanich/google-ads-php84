...
use Google\Ads\GoogleAds\V19\Services\MutateCampaignBudgetsRequest;
use Google\Ads\GoogleAds\V19\Services\MutateCampaignBudgetsResponse;
...
class CampaignBudgetServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCampaignBudgetsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v19.services.CampaignBudgetService/MutateCampaignBudgets', $actualFuncCall);
    ...
    public function mutateCampaignBudgetsExceptionTest()
    {
        ...
        $request = new MutateCampaignBudgetsRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateCampaignBudgets($request);
    ...
    /** @test */
    public function mutateCampaignBudgetsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
