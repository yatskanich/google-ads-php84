...
use Google\Ads\GoogleAds\V19\Services\CampaignLifecycleGoalOperation;
use Google\Ads\GoogleAds\V19\Services\ConfigureCampaignLifecycleGoalsRequest;
use Google\Ads\GoogleAds\V19\Services\ConfigureCampaignLifecycleGoalsResponse;
...
class CampaignLifecycleGoalServiceClientTest extends GeneratedTest
{
    ...
    public function configureCampaignLifecycleGoalsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v19.services.CampaignLifecycleGoalService/ConfigureCampaignLifecycleGoals', $actualFuncCall);
