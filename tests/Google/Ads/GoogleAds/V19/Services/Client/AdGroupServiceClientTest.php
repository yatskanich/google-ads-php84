...
use Google\Ads\GoogleAds\V19\Services\MutateAdGroupsRequest;
use Google\Ads\GoogleAds\V19\Services\MutateAdGroupsResponse;
...
class AdGroupServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdGroupsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v19.services.AdGroupService/MutateAdGroups', $actualFuncCall);
    ...
    public function mutateAdGroupsExceptionTest()
    {
        ...
        $request = new MutateAdGroupsRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateAdGroups($request);
    ...
    /** @test */
    public function mutateAdGroupsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
