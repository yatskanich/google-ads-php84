...
use Google\Ads\GoogleAds\V19\Services\AccountBudgetProposalOperation;
use Google\Ads\GoogleAds\V19\Services\MutateAccountBudgetProposalRequest;
use Google\Ads\GoogleAds\V19\Services\MutateAccountBudgetProposalResponse;
...
class AccountBudgetProposalServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAccountBudgetProposalTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v19.services.AccountBudgetProposalService/MutateAccountBudgetProposal', $actualFuncCall);
