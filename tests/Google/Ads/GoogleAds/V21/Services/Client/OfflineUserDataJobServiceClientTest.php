...
use Google\Ads\GoogleAds\V21\Services\AddOfflineUserDataJobOperationsRequest;
use Google\Ads\GoogleAds\V21\Services\AddOfflineUserDataJobOperationsResponse;
use Google\Ads\GoogleAds\V21\Services\Client\OfflineUserDataJobServiceClient;
use Google\Ads\GoogleAds\V21\Services\CreateOfflineUserDataJobRequest;
use Google\Ads\GoogleAds\V21\Services\CreateOfflineUserDataJobResponse;
use Google\Ads\GoogleAds\V21\Services\RunOfflineUserDataJobRequest;
...
class OfflineUserDataJobServiceClientTest extends GeneratedTest
{
    ...
    public function addOfflineUserDataJobOperationsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v21.services.OfflineUserDataJobService/AddOfflineUserDataJobOperations', $actualFuncCall);
    ...
    public function addOfflineUserDataJobOperationsExceptionTest()
    {
        ...
        $request = new AddOfflineUserDataJobOperationsRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->addOfflineUserDataJobOperations($request);
    ...
    public function createOfflineUserDataJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v21.services.OfflineUserDataJobService/CreateOfflineUserDataJob', $actualFuncCall);
    ...
    public function createOfflineUserDataJobExceptionTest()
    {
        ...
        $request = new CreateOfflineUserDataJobRequest()
            ...
            ->setJob($job);
        try {
            $gapicClient->createOfflineUserDataJob($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function runOfflineUserDataJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v21.services.OfflineUserDataJobService/RunOfflineUserDataJob', $actualApiFuncCall);
    ...
    /** @test */
    public function addOfflineUserDataJobOperationsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
