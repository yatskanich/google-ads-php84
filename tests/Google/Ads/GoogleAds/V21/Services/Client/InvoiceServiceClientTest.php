...
use Google\Ads\GoogleAds\V21\Services\ListInvoicesRequest;
use Google\Ads\GoogleAds\V21\Services\ListInvoicesResponse;
...
class InvoiceServiceClientTest extends GeneratedTest
{
    ...
    public function listInvoicesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v21.services.InvoiceService/ListInvoices', $actualFuncCall);
