...
use Google\Ads\GoogleAds\V21\Services\AccountBudgetProposalOperation;
use Google\Ads\GoogleAds\V21\Services\Client\AccountBudgetProposalServiceClient;
use Google\Ads\GoogleAds\V21\Services\MutateAccountBudgetProposalRequest;
use Google\Ads\GoogleAds\V21\Services\MutateAccountBudgetProposalResponse;
...
class AccountBudgetProposalServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAccountBudgetProposalTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v21.services.AccountBudgetProposalService/MutateAccountBudgetProposal', $actualFuncCall);
