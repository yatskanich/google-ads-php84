...
use Google\Ads\GoogleAds\V21\Services\MutateKeywordPlansRequest;
use Google\Ads\GoogleAds\V21\Services\MutateKeywordPlansResponse;
...
class KeywordPlanServiceClientTest extends GeneratedTest
{
    ...
    public function mutateKeywordPlansTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v21.services.KeywordPlanService/MutateKeywordPlans', $actualFuncCall);
    ...
    public function mutateKeywordPlansExceptionTest()
    {
        ...
        $request = new MutateKeywordPlansRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateKeywordPlans($request);
    ...
    /** @test */
    public function mutateKeywordPlansAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
