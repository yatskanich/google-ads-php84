...
use Google\Ads\GoogleAds\V21\Services\CampaignLifecycleGoalOperation;
use Google\Ads\GoogleAds\V21\Services\Client\CampaignLifecycleGoalServiceClient;
use Google\Ads\GoogleAds\V21\Services\ConfigureCampaignLifecycleGoalsRequest;
use Google\Ads\GoogleAds\V21\Services\ConfigureCampaignLifecycleGoalsResponse;
...
class CampaignLifecycleGoalServiceClientTest extends GeneratedTest
{
    ...
    public function configureCampaignLifecycleGoalsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v21.services.CampaignLifecycleGoalService/ConfigureCampaignLifecycleGoals', $actualFuncCall);
