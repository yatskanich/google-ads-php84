...
use Google\Ads\GoogleAds\V21\Enums\LocalServicesLeadSurveyAnswerEnum\SurveyAnswer;
use Google\Ads\GoogleAds\V21\Services\AppendLeadConversationRequest;
use Google\Ads\GoogleAds\V21\Services\AppendLeadConversationResponse;
use Google\Ads\GoogleAds\V21\Services\Client\LocalServicesLeadServiceClient;
use Google\Ads\GoogleAds\V21\Services\ProvideLeadFeedbackRequest;
use Google\Ads\GoogleAds\V21\Services\ProvideLeadFeedbackResponse;
...
class LocalServicesLeadServiceClientTest extends GeneratedTest
{
    ...
    public function appendLeadConversationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v21.services.LocalServicesLeadService/AppendLeadConversation', $actualFuncCall);
    ...
    public function provideLeadFeedbackTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v21.services.LocalServicesLeadService/ProvideLeadFeedback', $actualFuncCall);
