...
use Google\Ads\GoogleAds\V21\Services\GenerateAdGroupThemesRequest;
use Google\Ads\GoogleAds\V21\Services\GenerateAdGroupThemesResponse;
use Google\Ads\GoogleAds\V21\Services\GenerateKeywordForecastMetricsRequest;
use Google\Ads\GoogleAds\V21\Services\GenerateKeywordForecastMetricsResponse;
use Google\Ads\GoogleAds\V21\Services\GenerateKeywordHistoricalMetricsRequest;
use Google\Ads\GoogleAds\V21\Services\GenerateKeywordHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V21\Services\GenerateKeywordIdeaResponse;
use Google\Ads\GoogleAds\V21\Services\GenerateKeywordIdeaResult;
...
class KeywordPlanIdeaServiceClientTest extends GeneratedTest
{
    ...
    public function generateAdGroupThemesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v21.services.KeywordPlanIdeaService/GenerateAdGroupThemes', $actualFuncCall);
    ...
    public function generateKeywordForecastMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v21.services.KeywordPlanIdeaService/GenerateKeywordForecastMetrics', $actualFuncCall);
    ...
    public function generateKeywordHistoricalMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v21.services.KeywordPlanIdeaService/GenerateKeywordHistoricalMetrics', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateKeywordIdeasTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v21.services.KeywordPlanIdeaService/GenerateKeywordIdeas', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
