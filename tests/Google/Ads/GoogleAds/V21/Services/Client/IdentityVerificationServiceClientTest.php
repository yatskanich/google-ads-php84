...
use Google\Ads\GoogleAds\V21\Enums\IdentityVerificationProgramEnum\IdentityVerificationProgram;
use Google\Ads\GoogleAds\V21\Services\Client\IdentityVerificationServiceClient;
use Google\Ads\GoogleAds\V21\Services\GetIdentityVerificationRequest;
use Google\Ads\GoogleAds\V21\Services\GetIdentityVerificationResponse;
use Google\Ads\GoogleAds\V21\Services\StartIdentityVerificationRequest;
...
class IdentityVerificationServiceClientTest extends GeneratedTest
{
    ...
    public function getIdentityVerificationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v21.services.IdentityVerificationService/GetIdentityVerification', $actualFuncCall);
    ...
    public function startIdentityVerificationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v21.services.IdentityVerificationService/StartIdentityVerification', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
