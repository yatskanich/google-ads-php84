...
namespace Google\Ads\GoogleAds\Lib\V24;

use Google\Ads\GoogleAds\V24\Services\Client\AccountBudgetProposalServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AccountLinkServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AdGroupAdLabelServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AdGroupAdServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AdGroupAssetServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AdGroupAssetSetServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AdGroupBidModifierServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AdGroupCriterionCustomizerServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AdGroupCriterionLabelServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AdGroupCriterionServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AdGroupCustomizerServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AdGroupLabelServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AdGroupServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AdParameterServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AdServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AssetGenerationServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AssetGroupAssetServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AssetGroupListingGroupFilterServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AssetGroupServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AssetGroupSignalServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AssetServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AssetSetAssetServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AssetSetServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AudienceInsightsServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AudienceServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\AutomaticallyCreatedAssetRemovalServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\BatchJobServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\BenchmarksServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\BiddingDataExclusionServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\BiddingSeasonalityAdjustmentServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\BiddingStrategyServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\BillingSetupServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\BrandSuggestionServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignAssetServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignAssetSetServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignBidModifierServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignBudgetServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignConversionGoalServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignCriterionServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignCustomizerServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignDraftServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignGoalConfigServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignGroupServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignLabelServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignLifecycleGoalServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignSharedSetServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\ContentCreatorInsightsServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\ConversionActionServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\ConversionAdjustmentUploadServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\ConversionCustomVariableServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\ConversionGoalCampaignConfigServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\ConversionUploadServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\ConversionValueRuleServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\ConversionValueRuleSetServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomAudienceServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomConversionGoalServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomerAssetServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomerAssetSetServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomerClientLinkServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomerConversionGoalServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomerCustomizerServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomerLabelServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomerLifecycleGoalServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomerManagerLinkServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomerNegativeCriterionServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomerServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomerSkAdNetworkConversionValueSchemaServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomerUserAccessInvitationServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomerUserAccessServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomInterestServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\CustomizerAttributeServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\DataLinkServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\ExperimentArmServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\ExperimentServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\GeoTargetConstantServiceClient;
...
use Google\Ads\GoogleAds\V24\Services\Client\IncentiveServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\InvoiceServiceClient;
...
use Google\Ads\GoogleAds\V24\Services\Client\KeywordPlanCampaignServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\KeywordPlanIdeaServiceClient;
...
use Google\Ads\GoogleAds\V24\Services\Client\ReachPlanServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\RecommendationServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\RecommendationSubscriptionServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\RemarketingActionServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\ReservationServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\ShareablePreviewServiceClient;
...
use Google\Ads\GoogleAds\V24\Services\Client\TravelAssetSuggestionServiceClient;
use Google\Ads\GoogleAds\V24\Services\Client\UserDataServiceClient;
...
use Google\Ads\GoogleAds\V24\Services\Client\YouTubeVideoUploadServiceClient;
 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V24\ServiceClientFactoryTrait
 * @small
 */
class ServiceClientFactoryTraitTest extends TestCase
{
    ...
    public function testGetAssetGenerationServiceClient()
    {
        $this->assertInstanceOf(
            AssetGenerationServiceClient::class,
            $this->googleAdsClient->getAssetGenerationServiceClient()
        );
    }
    ...
    public function testGetAutomaticallyCreatedAssetRemovalServiceClient()
    {
        $this->assertInstanceOf(
            AutomaticallyCreatedAssetRemovalServiceClient::class,
            $this->googleAdsClient->getAutomaticallyCreatedAssetRemovalServiceClient()
        );
    }
    ...
    public function testGetBenchmarksServiceClient()
    {
        $this->assertInstanceOf(
            BenchmarksServiceClient::class,
            $this->googleAdsClient->getBenchmarksServiceClient()
        );
    }
    ...
    public function testGetCampaignGoalConfigServiceClient()
    {
        $this->assertInstanceOf(
            CampaignGoalConfigServiceClient::class,
            $this->googleAdsClient->getCampaignGoalConfigServiceClient()
        );
    }
    ...
    public function testGetGoalServiceClient()
    {
        $this->assertInstanceOf(
            GoalServiceClient::class,
            $this->googleAdsClient->getGoalServiceClient()
        );
    }
    ...
    public function testGetIncentiveServiceClient()
    {
        $this->assertInstanceOf(
            IncentiveServiceClient::class,
            $this->googleAdsClient->getIncentiveServiceClient()
        );
    }
    ...
    public function testGetReservationServiceClient()
    {
        $this->assertInstanceOf(
            ReservationServiceClient::class,
            $this->googleAdsClient->getReservationServiceClient()
        );
    }
