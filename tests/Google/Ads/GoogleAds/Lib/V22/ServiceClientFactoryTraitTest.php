...
use Google\Ads\GoogleAds\V22\Services\Client\AccountBudgetProposalServiceClient;
...
use Google\Ads\GoogleAds\V22\Services\Client\AdGroupAssetServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AdGroupAssetSetServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AdGroupBidModifierServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AdGroupCriterionCustomizerServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AdGroupCriterionLabelServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AdGroupCriterionServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AdGroupCustomizerServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AdGroupLabelServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AdGroupServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AdParameterServiceClient;
...
use Google\Ads\GoogleAds\V22\Services\Client\AssetGroupAssetServiceClient;
...
use Google\Ads\GoogleAds\V22\Services\Client\AssetGroupSignalServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AssetServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AssetSetAssetServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AssetSetServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AudienceInsightsServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AudienceServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\AutomaticallyCreatedAssetRemovalServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\BatchJobServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\BiddingDataExclusionServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\BiddingSeasonalityAdjustmentServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\BiddingStrategyServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\BillingSetupServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\BrandSuggestionServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignAssetServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignAssetSetServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignBidModifierServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignBudgetServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignConversionGoalServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignCriterionServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignCustomizerServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignDraftServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignGoalConfigServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignGroupServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignLabelServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignLifecycleGoalServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignSharedSetServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\ContentCreatorInsightsServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\ConversionActionServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\ConversionAdjustmentUploadServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\ConversionCustomVariableServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\ConversionGoalCampaignConfigServiceClient;
...
use Google\Ads\GoogleAds\V22\Services\Client\CustomAudienceServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CustomConversionGoalServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CustomerAssetServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CustomerAssetSetServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CustomerClientLinkServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CustomerConversionGoalServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CustomerCustomizerServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CustomerLabelServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CustomerLifecycleGoalServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CustomerManagerLinkServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CustomerNegativeCriterionServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CustomerServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CustomerSkAdNetworkConversionValueSchemaServiceClient;
...
use Google\Ads\GoogleAds\V22\Services\Client\CustomInterestServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\CustomizerAttributeServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\DataLinkServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\ExperimentArmServiceClient;
...
use Google\Ads\GoogleAds\V22\Services\Client\GoalServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\GoogleAdsFieldServiceClient;
...
use Google\Ads\GoogleAds\V22\Services\Client\InvoiceServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\KeywordPlanAdGroupKeywordServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\KeywordPlanAdGroupServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\KeywordPlanCampaignKeywordServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\KeywordPlanCampaignServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\KeywordPlanIdeaServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\KeywordPlanServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\KeywordThemeConstantServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\LabelServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\LocalServicesLeadServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\OfflineUserDataJobServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\PaymentsAccountServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\ProductLinkInvitationServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\ProductLinkServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\ReachPlanServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\RecommendationServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\RecommendationSubscriptionServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\RemarketingActionServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\ShareablePreviewServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\SharedCriterionServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\SharedSetServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\SmartCampaignSettingServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\SmartCampaignSuggestServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\ThirdPartyAppAnalyticsLinkServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\TravelAssetSuggestionServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\UserDataServiceClient;
use Google\Ads\GoogleAds\V22\Services\Client\UserListCustomerTypeServiceClient;
 ...
 *
 * @covers \Google\Ads\GoogleAds\Lib\V22\ServiceClientFactoryTrait
 * @small
 */
