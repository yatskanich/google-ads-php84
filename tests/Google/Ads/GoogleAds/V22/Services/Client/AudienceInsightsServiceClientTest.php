...
use Google\Ads\GoogleAds\V22\Common\AudienceInsightsAttribute;
...
use Google\Ads\GoogleAds\V22\Services\GenerateAudienceCompositionInsightsRequest;
use Google\Ads\GoogleAds\V22\Services\GenerateAudienceCompositionInsightsResponse;
use Google\Ads\GoogleAds\V22\Services\GenerateAudienceOverlapInsightsRequest;
use Google\Ads\GoogleAds\V22\Services\GenerateAudienceOverlapInsightsResponse;
use Google\Ads\GoogleAds\V22\Services\GenerateInsightsFinderReportRequest;
use Google\Ads\GoogleAds\V22\Services\GenerateInsightsFinderReportResponse;
use Google\Ads\GoogleAds\V22\Services\GenerateSuggestedTargetingInsightsRequest;
use Google\Ads\GoogleAds\V22\Services\GenerateSuggestedTargetingInsightsResponse;
use Google\Ads\GoogleAds\V22\Services\GenerateTargetingSuggestionMetricsRequest;
use Google\Ads\GoogleAds\V22\Services\GenerateTargetingSuggestionMetricsResponse;
use Google\Ads\GoogleAds\V22\Services\InsightsAudience;
use Google\Ads\GoogleAds\V22\Services\ListAudienceInsightsAttributesRequest;
use Google\Ads\GoogleAds\V22\Services\ListAudienceInsightsAttributesResponse;
use Google\Ads\GoogleAds\V22\Services\ListInsightsEligibleDatesRequest;
use Google\Ads\GoogleAds\V22\Services\ListInsightsEligibleDatesResponse;
...
class AudienceInsightsServiceClientTest extends GeneratedTest
{
    ...
    public function generateAudienceCompositionInsightsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v22.services.AudienceInsightsService/GenerateAudienceCompositionInsights', $actualFuncCall);
    ...
    public function generateAudienceOverlapInsightsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v22.services.AudienceInsightsService/GenerateAudienceOverlapInsights', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function generateInsightsFinderReportTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v22.services.AudienceInsightsService/GenerateInsightsFinderReport', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function generateSuggestedTargetingInsightsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v22.services.AudienceInsightsService/GenerateSuggestedTargetingInsights', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateTargetingSuggestionMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v22.services.AudienceInsightsService/GenerateTargetingSuggestionMetrics', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function listAudienceInsightsAttributesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v22.services.AudienceInsightsService/ListAudienceInsightsAttributes', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getDimensions();
        $this->assertProtobufEquals($dimensions, $actualValue);
    ...
    public function listInsightsEligibleDatesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v22.services.AudienceInsightsService/ListInsightsEligibleDates', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
