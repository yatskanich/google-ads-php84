...
use Google\Ads\GoogleAds\V22\Enums\LocalServicesLeadSurveyAnswerEnum\SurveyAnswer;
use Google\Ads\GoogleAds\V22\Services\AppendLeadConversationRequest;
use Google\Ads\GoogleAds\V22\Services\AppendLeadConversationResponse;
use Google\Ads\GoogleAds\V22\Services\Client\LocalServicesLeadServiceClient;
use Google\Ads\GoogleAds\V22\Services\ProvideLeadFeedbackRequest;
use Google\Ads\GoogleAds\V22\Services\ProvideLeadFeedbackResponse;
...
class LocalServicesLeadServiceClientTest extends GeneratedTest
{
    ...
    public function appendLeadConversationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v22.services.LocalServicesLeadService/AppendLeadConversation', $actualFuncCall);
    ...
    public function provideLeadFeedbackTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v22.services.LocalServicesLeadService/ProvideLeadFeedback', $actualFuncCall);
