...
use Google\Ads\GoogleAds\V22\Services\MutateSharedCriteriaResponse;
...
class SharedCriterionServiceClientTest extends GeneratedTest
{
    ...
    public function mutateSharedCriteriaTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v22.services.SharedCriterionService/MutateSharedCriteria', $actualFuncCall);
    ...
    public function mutateSharedCriteriaExceptionTest()
    {
        ...
        $request = new MutateSharedCriteriaRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateSharedCriteria($request);
    ...
    /** @test */
    public function mutateSharedCriteriaAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
