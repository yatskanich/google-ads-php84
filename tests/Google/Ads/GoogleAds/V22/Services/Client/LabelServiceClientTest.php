...
use Google\Ads\GoogleAds\V22\Services\MutateLabelsRequest;
use Google\Ads\GoogleAds\V22\Services\MutateLabelsResponse;
...
class LabelServiceClientTest extends GeneratedTest
{
    ...
    public function mutateLabelsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v22.services.LabelService/MutateLabels', $actualFuncCall);
    ...
    public function mutateLabelsExceptionTest()
    {
        ...
        $request = new MutateLabelsRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateLabels($request);
    ...
    /** @test */
    public function mutateLabelsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
