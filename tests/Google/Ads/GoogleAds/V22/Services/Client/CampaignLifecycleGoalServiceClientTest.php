...
use Google\Ads\GoogleAds\V22\Services\CampaignLifecycleGoalOperation;
use Google\Ads\GoogleAds\V22\Services\Client\CampaignLifecycleGoalServiceClient;
use Google\Ads\GoogleAds\V22\Services\ConfigureCampaignLifecycleGoalsRequest;
use Google\Ads\GoogleAds\V22\Services\ConfigureCampaignLifecycleGoalsResponse;
...
class CampaignLifecycleGoalServiceClientTest extends GeneratedTest
{
    ...
    public function configureCampaignLifecycleGoalsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v22.services.CampaignLifecycleGoalService/ConfigureCampaignLifecycleGoals', $actualFuncCall);
