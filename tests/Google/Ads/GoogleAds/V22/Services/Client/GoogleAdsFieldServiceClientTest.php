...
use Google\Ads\GoogleAds\V22\Resources\GoogleAdsField;
use Google\Ads\GoogleAds\V22\Services\Client\GoogleAdsFieldServiceClient;
use Google\Ads\GoogleAds\V22\Services\GetGoogleAdsFieldRequest;
use Google\Ads\GoogleAds\V22\Services\SearchGoogleAdsFieldsRequest;
use Google\Ads\GoogleAds\V22\Services\SearchGoogleAdsFieldsResponse;
...
class GoogleAdsFieldServiceClientTest extends GeneratedTest
{
    ...
    public function getGoogleAdsFieldTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v22.services.GoogleAdsFieldService/GetGoogleAdsField', $actualFuncCall);
    ...
    public function searchGoogleAdsFieldsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v22.services.GoogleAdsFieldService/SearchGoogleAdsFields', $actualFuncCall);
