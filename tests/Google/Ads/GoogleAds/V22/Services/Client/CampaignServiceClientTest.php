...
use Google\Ads\GoogleAds\V22\Services\EnablePMaxBrandGuidelinesRequest;
use Google\Ads\GoogleAds\V22\Services\EnablePMaxBrandGuidelinesResponse;
...
class CampaignServiceClientTest extends GeneratedTest
{
    ...
    public function enablePMaxBrandGuidelinesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v22.services.CampaignService/EnablePMaxBrandGuidelines', $actualFuncCall);
    ...
    public function mutateCampaignsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v22.services.CampaignService/MutateCampaigns', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getOperations();
        $this->assertProtobufEquals($operations, $actualValue);
