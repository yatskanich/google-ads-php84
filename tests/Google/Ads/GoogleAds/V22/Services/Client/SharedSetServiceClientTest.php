...
use Google\Ads\GoogleAds\V22\Services\MutateSharedSetsResponse;
 ...
 * @group gapic
 */
class SharedSetServiceClientTest extends GeneratedTest
{
    ...
    public function mutateSharedSetsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v22.services.SharedSetService/MutateSharedSets', $actualFuncCall);
    ...
    public function mutateSharedSetsExceptionTest()
    {
        ...
        $request = new MutateSharedSetsRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateSharedSets($request);
    ...
    /** @test */
    public function mutateSharedSetsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
