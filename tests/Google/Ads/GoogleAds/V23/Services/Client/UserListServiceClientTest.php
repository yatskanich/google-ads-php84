...
use Google\Ads\GoogleAds\V23\Services\MutateUserListsRequest;
use Google\Ads\GoogleAds\V23\Services\MutateUserListsResponse;
...
class UserListServiceClientTest extends GeneratedTest
{
    ...
    public function mutateUserListsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.UserListService/MutateUserLists', $actualFuncCall);
    ...
    public function mutateUserListsExceptionTest()
    {
        ...
        $request = new MutateUserListsRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateUserLists($request);
    ...
    /** @test */
    public function mutateUserListsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
