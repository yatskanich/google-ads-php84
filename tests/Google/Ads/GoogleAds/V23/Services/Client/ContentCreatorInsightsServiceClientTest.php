...
use Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest;
use Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsResponse;
use Google\Ads\GoogleAds\V23\Services\GenerateTrendingInsightsRequest;
use Google\Ads\GoogleAds\V23\Services\GenerateTrendingInsightsResponse;
...
class ContentCreatorInsightsServiceClientTest extends GeneratedTest
{
    ...
    public function generateCreatorInsightsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.ContentCreatorInsightsService/GenerateCreatorInsights', $actualFuncCall);
    ...
    public function generateTrendingInsightsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.ContentCreatorInsightsService/GenerateTrendingInsights', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getCustomerInsightsGroup();
        $this->assertProtobufEquals($customerInsightsGroup, $actualValue);
