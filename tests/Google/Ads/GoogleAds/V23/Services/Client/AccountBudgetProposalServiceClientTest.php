...
use Google\Ads\GoogleAds\V23\Services\AccountBudgetProposalOperation;
use Google\Ads\GoogleAds\V23\Services\Client\AccountBudgetProposalServiceClient;
use Google\Ads\GoogleAds\V23\Services\MutateAccountBudgetProposalRequest;
use Google\Ads\GoogleAds\V23\Services\MutateAccountBudgetProposalResponse;
...
class AccountBudgetProposalServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAccountBudgetProposalTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.AccountBudgetProposalService/MutateAccountBudgetProposal', $actualFuncCall);
