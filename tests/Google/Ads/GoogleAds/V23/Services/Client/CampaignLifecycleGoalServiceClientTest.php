...
use Google\Ads\GoogleAds\V23\Services\CampaignLifecycleGoalOperation;
use Google\Ads\GoogleAds\V23\Services\Client\CampaignLifecycleGoalServiceClient;
use Google\Ads\GoogleAds\V23\Services\ConfigureCampaignLifecycleGoalsRequest;
use Google\Ads\GoogleAds\V23\Services\ConfigureCampaignLifecycleGoalsResponse;
...
class CampaignLifecycleGoalServiceClientTest extends GeneratedTest
{
    ...
    public function configureCampaignLifecycleGoalsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.CampaignLifecycleGoalService/ConfigureCampaignLifecycleGoals', $actualFuncCall);
