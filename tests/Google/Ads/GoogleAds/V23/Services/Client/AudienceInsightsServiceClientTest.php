...
use Google\Ads\GoogleAds\V23\Common\AudienceInsightsAttribute;
...
use Google\Ads\GoogleAds\V23\Services\GenerateAudienceCompositionInsightsRequest;
use Google\Ads\GoogleAds\V23\Services\GenerateAudienceCompositionInsightsResponse;
use Google\Ads\GoogleAds\V23\Services\GenerateAudienceDefinitionRequest;
use Google\Ads\GoogleAds\V23\Services\GenerateAudienceDefinitionResponse;
use Google\Ads\GoogleAds\V23\Services\GenerateAudienceOverlapInsightsRequest;
use Google\Ads\GoogleAds\V23\Services\GenerateAudienceOverlapInsightsResponse;
use Google\Ads\GoogleAds\V23\Services\GenerateInsightsFinderReportRequest;
use Google\Ads\GoogleAds\V23\Services\GenerateInsightsFinderReportResponse;
use Google\Ads\GoogleAds\V23\Services\GenerateSuggestedTargetingInsightsRequest;
use Google\Ads\GoogleAds\V23\Services\GenerateSuggestedTargetingInsightsResponse;
use Google\Ads\GoogleAds\V23\Services\GenerateTargetingSuggestionMetricsRequest;
use Google\Ads\GoogleAds\V23\Services\GenerateTargetingSuggestionMetricsResponse;
use Google\Ads\GoogleAds\V23\Services\InsightsAudience;
use Google\Ads\GoogleAds\V23\Services\InsightsAudienceDescription;
use Google\Ads\GoogleAds\V23\Services\ListAudienceInsightsAttributesRequest;
use Google\Ads\GoogleAds\V23\Services\ListAudienceInsightsAttributesResponse;
use Google\Ads\GoogleAds\V23\Services\ListInsightsEligibleDatesRequest;
use Google\Ads\GoogleAds\V23\Services\ListInsightsEligibleDatesResponse;
...
class AudienceInsightsServiceClientTest extends GeneratedTest
{
    ...
    public function generateAudienceCompositionInsightsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.AudienceInsightsService/GenerateAudienceCompositionInsights', $actualFuncCall);
    ...
    public function generateAudienceDefinitionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.AudienceInsightsService/GenerateAudienceDefinition', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function generateAudienceOverlapInsightsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.AudienceInsightsService/GenerateAudienceOverlapInsights', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function generateInsightsFinderReportTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.AudienceInsightsService/GenerateInsightsFinderReport', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function generateSuggestedTargetingInsightsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.AudienceInsightsService/GenerateSuggestedTargetingInsights', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateTargetingSuggestionMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.AudienceInsightsService/GenerateTargetingSuggestionMetrics', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function listAudienceInsightsAttributesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.AudienceInsightsService/ListAudienceInsightsAttributes', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getDimensions();
        $this->assertProtobufEquals($dimensions, $actualValue);
    ...
    public function listInsightsEligibleDatesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.AudienceInsightsService/ListInsightsEligibleDates', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
