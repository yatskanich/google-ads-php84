...
use Google\Ads\GoogleAds\V23\Enums\KeywordPlanNetworkEnum\KeywordPlanNetwork;
use Google\Ads\GoogleAds\V23\Services\CampaignToForecast;
use Google\Ads\GoogleAds\V23\Services\CampaignToForecast\CampaignBiddingStrategy;
use Google\Ads\GoogleAds\V23\Services\Client\KeywordPlanIdeaServiceClient;
use Google\Ads\GoogleAds\V23\Services\GenerateAdGroupThemesRequest;
use Google\Ads\GoogleAds\V23\Services\GenerateAdGroupThemesResponse;
use Google\Ads\GoogleAds\V23\Services\GenerateKeywordForecastMetricsRequest;
use Google\Ads\GoogleAds\V23\Services\GenerateKeywordForecastMetricsResponse;
use Google\Ads\GoogleAds\V23\Services\GenerateKeywordHistoricalMetricsRequest;
use Google\Ads\GoogleAds\V23\Services\GenerateKeywordHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V23\Services\GenerateKeywordIdeaResponse;
use Google\Ads\GoogleAds\V23\Services\GenerateKeywordIdeaResult;
use Google\Ads\GoogleAds\V23\Services\GenerateKeywordIdeasRequest;
...
class KeywordPlanIdeaServiceClientTest extends GeneratedTest
{
    ...
    public function generateAdGroupThemesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.KeywordPlanIdeaService/GenerateAdGroupThemes', $actualFuncCall);
    ...
    /** @test */
    public function generateKeywordForecastMetricsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $this->assertTrue($transport->isExhausted());
        // Mock response
        $expectedResponse = new GenerateKeywordForecastMetricsResponse();
        $transport->addResponse($expectedResponse);
        // Mock request
        $campaign = new CampaignToForecast();
        $campaignKeywordPlanNetwork = KeywordPlanNetwork::UNSPECIFIED;
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.KeywordPlanIdeaService/GenerateKeywordForecastMetrics', $actualFuncCall);
        $actualValue = $actualRequestObject->getCampaign();
        $this->assertProtobufEquals($campaign, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }

    /** @test */
    public function generateKeywordForecastMetricsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    public function generateKeywordHistoricalMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.KeywordPlanIdeaService/GenerateKeywordHistoricalMetrics', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateKeywordIdeasTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.KeywordPlanIdeaService/GenerateKeywordIdeas', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
