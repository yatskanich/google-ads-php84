...
use Google\Ads\GoogleAds\V23\Services\CampaignDuration;
use Google\Ads\GoogleAds\V23\Services\Client\ReachPlanServiceClient;
use Google\Ads\GoogleAds\V23\Services\GenerateConversionRatesRequest;
use Google\Ads\GoogleAds\V23\Services\GenerateConversionRatesResponse;
use Google\Ads\GoogleAds\V23\Services\GenerateReachForecastRequest;
use Google\Ads\GoogleAds\V23\Services\GenerateReachForecastResponse;
use Google\Ads\GoogleAds\V23\Services\ListPlannableLocationsRequest;
use Google\Ads\GoogleAds\V23\Services\ListPlannableLocationsResponse;
use Google\Ads\GoogleAds\V23\Services\ListPlannableProductsRequest;
use Google\Ads\GoogleAds\V23\Services\ListPlannableProductsResponse;
use Google\Ads\GoogleAds\V23\Services\ListPlannableUserInterestsRequest;
use Google\Ads\GoogleAds\V23\Services\ListPlannableUserInterestsResponse;
use Google\Ads\GoogleAds\V23\Services\ListPlannableUserListsRequest;
use Google\Ads\GoogleAds\V23\Services\ListPlannableUserListsResponse;
...
class ReachPlanServiceClientTest extends GeneratedTest
{
    ...
    public function generateConversionRatesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.ReachPlanService/GenerateConversionRates', $actualFuncCall);
    ...
    public function generateReachForecastTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.ReachPlanService/GenerateReachForecast', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function listPlannableLocationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.ReachPlanService/ListPlannableLocations', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listPlannableProductsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.ReachPlanService/ListPlannableProducts', $actualFuncCall);
    ...
    public function listPlannableUserInterestsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.ReachPlanService/ListPlannableUserInterests', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listPlannableUserListsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.ReachPlanService/ListPlannableUserLists', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
