...
use Google\Ads\GoogleAds\V23\Services\BillingSetupOperation;
use Google\Ads\GoogleAds\V23\Services\Client\BillingSetupServiceClient;
use Google\Ads\GoogleAds\V23\Services\MutateBillingSetupRequest;
use Google\Ads\GoogleAds\V23\Services\MutateBillingSetupResponse;
...
class BillingSetupServiceClientTest extends GeneratedTest
{
    ...
    public function mutateBillingSetupTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.BillingSetupService/MutateBillingSetup', $actualFuncCall);
