...
use Google\Ads\GoogleAds\V23\Services\ListPaymentsAccountsRequest;
use Google\Ads\GoogleAds\V23\Services\ListPaymentsAccountsResponse;
 ...
 * @group gapic
 */
class PaymentsAccountServiceClientTest extends GeneratedTest
{
    ...
    public function listPaymentsAccountsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.PaymentsAccountService/ListPaymentsAccounts', $actualFuncCall);
    ...
    /** @test */
    public function listPaymentsAccountsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
