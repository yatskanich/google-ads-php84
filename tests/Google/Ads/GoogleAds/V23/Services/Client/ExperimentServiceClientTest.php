...
use Google\Ads\GoogleAds\V23\Services\EndExperimentRequest;
use Google\Ads\GoogleAds\V23\Services\GraduateExperimentRequest;
use Google\Ads\GoogleAds\V23\Services\ListExperimentAsyncErrorsRequest;
use Google\Ads\GoogleAds\V23\Services\ListExperimentAsyncErrorsResponse;
use Google\Ads\GoogleAds\V23\Services\MutateExperimentsRequest;
use Google\Ads\GoogleAds\V23\Services\MutateExperimentsResponse;
use Google\Ads\GoogleAds\V23\Services\PromoteExperimentRequest;
use Google\Ads\GoogleAds\V23\Services\ScheduleExperimentRequest;
...
class ExperimentServiceClientTest extends GeneratedTest
{
    ...
    public function endExperimentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.ExperimentService/EndExperiment', $actualFuncCall);
        $actualValue = $actualRequestObject->getExperiment();
        $this->assertProtobufEquals($formattedExperiment, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function graduateExperimentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.ExperimentService/GraduateExperiment', $actualFuncCall);
        $actualValue = $actualRequestObject->getExperiment();
        $this->assertProtobufEquals($formattedExperiment, $actualValue);
        $actualValue = $actualRequestObject->getCampaignBudgetMappings();
        $this->assertProtobufEquals($campaignBudgetMappings, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listExperimentAsyncErrorsTest()
    {
        ...
        $expectedResponse = new ListExperimentAsyncErrorsResponse();
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.ExperimentService/ListExperimentAsyncErrors', $actualFuncCall);
    ...
    public function mutateExperimentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.ExperimentService/MutateExperiments', $actualFuncCall);
    ...
    public function mutateExperimentsExceptionTest()
    {
        ...
        $request = new MutateExperimentsRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateExperiments($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function promoteExperimentTest()
    {
        ...
        $incompleteOperation->setName('operations/promoteExperimentTest');
        ...
        $completeOperation->setName('operations/promoteExperimentTest');
        ...
        $this->assertSame('/google.ads.googleads.v23.services.ExperimentService/PromoteExperiment', $actualApiFuncCall);
    ...
    public function scheduleExperimentTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/scheduleExperimentTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new GPBEmpty();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/scheduleExperimentTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.ExperimentService/ScheduleExperiment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getResourceName();
        $this->assertProtobufEquals($formattedResourceName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
