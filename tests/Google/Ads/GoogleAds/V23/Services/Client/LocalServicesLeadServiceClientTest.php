...
use Google\Ads\GoogleAds\V23\Enums\LocalServicesLeadSurveyAnswerEnum\SurveyAnswer;
use Google\Ads\GoogleAds\V23\Services\AppendLeadConversationRequest;
use Google\Ads\GoogleAds\V23\Services\AppendLeadConversationResponse;
use Google\Ads\GoogleAds\V23\Services\Client\LocalServicesLeadServiceClient;
use Google\Ads\GoogleAds\V23\Services\ProvideLeadFeedbackRequest;
use Google\Ads\GoogleAds\V23\Services\ProvideLeadFeedbackResponse;
...
class LocalServicesLeadServiceClientTest extends GeneratedTest
{
    ...
    public function appendLeadConversationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.LocalServicesLeadService/AppendLeadConversation', $actualFuncCall);
    ...
    public function provideLeadFeedbackTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.LocalServicesLeadService/ProvideLeadFeedback', $actualFuncCall);
