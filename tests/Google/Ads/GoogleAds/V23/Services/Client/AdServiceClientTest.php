...
use Google\Ads\GoogleAds\V23\Services\MutateAdsRequest;
use Google\Ads\GoogleAds\V23\Services\MutateAdsResponse;
...
class AdServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.AdService/MutateAds', $actualFuncCall);
