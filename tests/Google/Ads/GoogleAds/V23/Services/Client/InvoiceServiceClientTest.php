...
use Google\Ads\GoogleAds\V23\Enums\MonthOfYearEnum\MonthOfYear;
use Google\Ads\GoogleAds\V23\Services\Client\InvoiceServiceClient;
use Google\Ads\GoogleAds\V23\Services\ListInvoicesRequest;
use Google\Ads\GoogleAds\V23\Services\ListInvoicesResponse;
...
class InvoiceServiceClientTest extends GeneratedTest
{
    ...
    public function listInvoicesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.InvoiceService/ListInvoices', $actualFuncCall);
