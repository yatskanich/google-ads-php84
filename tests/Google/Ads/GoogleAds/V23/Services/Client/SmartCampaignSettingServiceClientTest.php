...
use Google\Ads\GoogleAds\V23\Services\GetSmartCampaignStatusRequest;
use Google\Ads\GoogleAds\V23\Services\GetSmartCampaignStatusResponse;
use Google\Ads\GoogleAds\V23\Services\MutateSmartCampaignSettingsRequest;
use Google\Ads\GoogleAds\V23\Services\MutateSmartCampaignSettingsResponse;
...
class SmartCampaignSettingServiceClientTest extends GeneratedTest
{
    ...
    public function getSmartCampaignStatusTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.SmartCampaignSettingService/GetSmartCampaignStatus', $actualFuncCall);
    ...
    public function mutateSmartCampaignSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.SmartCampaignSettingService/MutateSmartCampaignSettings', $actualFuncCall);
