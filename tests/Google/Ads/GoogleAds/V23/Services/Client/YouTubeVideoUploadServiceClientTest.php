...
use Google\Ads\GoogleAds\V23\Resources\YouTubeVideoUpload;
use Google\Ads\GoogleAds\V23\Services\Client\YouTubeVideoUploadServiceClient;
use Google\Ads\GoogleAds\V23\Services\CreateYouTubeVideoUploadRequest;
use Google\Ads\GoogleAds\V23\Services\CreateYouTubeVideoUploadResponse;
use Google\Ads\GoogleAds\V23\Services\RemoveYouTubeVideoUploadRequest;
use Google\Ads\GoogleAds\V23\Services\RemoveYouTubeVideoUploadResponse;
use Google\Ads\GoogleAds\V23\Services\UpdateYouTubeVideoUploadRequest;
use Google\Ads\GoogleAds\V23\Services\UpdateYouTubeVideoUploadResponse;
...
class YouTubeVideoUploadServiceClientTest extends GeneratedTest
{
    ...
    public function createYouTubeVideoUploadTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.YouTubeVideoUploadService/CreateYouTubeVideoUpload', $actualFuncCall);
    ...
    public function removeYouTubeVideoUploadTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.YouTubeVideoUploadService/RemoveYouTubeVideoUpload', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateYouTubeVideoUploadTest()
    {
        ...
        // Mock response
        $resourceName = 'resourceName979421212';
        $expectedResponse = new UpdateYouTubeVideoUploadResponse();
        $expectedResponse->setResourceName($resourceName);
        $transport->addResponse($expectedResponse);
        // Mock request
        $customerId = 'customerId-1772061412';
        ...
        $response = $gapicClient->updateYouTubeVideoUpload($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.YouTubeVideoUploadService/UpdateYouTubeVideoUpload', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getYouTubeVideoUpload();
        $this->assertProtobufEquals($youTubeVideoUpload, $actualValue);
    ...
    public function updateYouTubeVideoUploadExceptionTest()
    {
        ...
        $request = new UpdateYouTubeVideoUploadRequest()
            ...
            ->setUpdateMask($updateMask);
        try {
            $gapicClient->updateYouTubeVideoUpload($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
