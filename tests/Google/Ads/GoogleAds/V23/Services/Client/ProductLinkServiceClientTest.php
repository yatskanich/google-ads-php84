...
use Google\Ads\GoogleAds\V23\Resources\ProductLink;
use Google\Ads\GoogleAds\V23\Services\Client\ProductLinkServiceClient;
use Google\Ads\GoogleAds\V23\Services\CreateProductLinkRequest;
use Google\Ads\GoogleAds\V23\Services\CreateProductLinkResponse;
use Google\Ads\GoogleAds\V23\Services\RemoveProductLinkRequest;
use Google\Ads\GoogleAds\V23\Services\RemoveProductLinkResponse;
...
class ProductLinkServiceClientTest extends GeneratedTest
{
    ...
    public function createProductLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v23.services.ProductLinkService/CreateProductLink', $actualFuncCall);
    ...
    public function removeProductLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v23.services.ProductLinkService/RemoveProductLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
