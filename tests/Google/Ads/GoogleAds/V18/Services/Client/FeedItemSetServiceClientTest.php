 ...
 * @group gapic
 */
class FeedItemSetServiceClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new FeedItemSetServiceClient($options);
    }

    /** @test */
    public function mutateFeedItemSetsTest()
    {
        ...
        // Mock response
        $expectedResponse = new MutateFeedItemSetsResponse();
        ...
        $this->assertSame('/google.ads.googleads.v18.services.FeedItemSetService/MutateFeedItemSets', $actualFuncCall);
    ...
    /** @test */
    public function mutateFeedItemSetsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = new MutateFeedItemSetsRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateFeedItemSets($request);
    ...
    /** @test */
    public function mutateFeedItemSetsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
