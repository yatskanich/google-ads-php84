...
use Google\Ads\GoogleAds\V18\Services\MoveManagerLinkRequest;
use Google\Ads\GoogleAds\V18\Services\MoveManagerLinkResponse;
use Google\Ads\GoogleAds\V18\Services\MutateCustomerManagerLinkRequest;
use Google\Ads\GoogleAds\V18\Services\MutateCustomerManagerLinkResponse;
...
class CustomerManagerLinkServiceClientTest extends GeneratedTest
{
    ...
    public function moveManagerLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v18.services.CustomerManagerLinkService/MoveManagerLink', $actualFuncCall);
    ...
    public function mutateCustomerManagerLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v18.services.CustomerManagerLinkService/MutateCustomerManagerLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
