 ...
 * @group gapic
 */
class FeedMappingServiceClientTest extends GeneratedTest
{
    ...
    public function mutateFeedMappingsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v18.services.FeedMappingService/MutateFeedMappings', $actualFuncCall);
    ...
    public function mutateFeedMappingsExceptionTest()
    {
        ...
        $request = new MutateFeedMappingsRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateFeedMappings($request);
    ...
    /** @test */
    public function mutateFeedMappingsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
