...
use Google\Ads\GoogleAds\V20\Services\GenerateKeywordForecastMetricsResponse;
use Google\Ads\GoogleAds\V20\Services\GenerateKeywordHistoricalMetricsRequest;
use Google\Ads\GoogleAds\V20\Services\GenerateKeywordHistoricalMetricsResponse;
use Google\Ads\GoogleAds\V20\Services\GenerateKeywordIdeaResponse;
use Google\Ads\GoogleAds\V20\Services\GenerateKeywordIdeaResult;
...
class KeywordPlanIdeaServiceClientTest extends GeneratedTest
{
    ...
    public function generateAdGroupThemesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v20.services.KeywordPlanIdeaService/GenerateAdGroupThemes', $actualFuncCall);
    ...
    public function generateKeywordForecastMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.KeywordPlanIdeaService/GenerateKeywordForecastMetrics', $actualFuncCall);
    ...
    public function generateKeywordHistoricalMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.KeywordPlanIdeaService/GenerateKeywordHistoricalMetrics', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateKeywordIdeasTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.KeywordPlanIdeaService/GenerateKeywordIdeas', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
