...
use Google\Ads\GoogleAds\V20\Services\AddBatchJobOperationsResponse;
...
use Google\Ads\GoogleAds\V20\Services\ListBatchJobResultsResponse;
use Google\Ads\GoogleAds\V20\Services\MutateBatchJobRequest;
use Google\Ads\GoogleAds\V20\Services\MutateBatchJobResponse;
...
class BatchJobServiceClientTest extends GeneratedTest
{
    ...
    public function addBatchJobOperationsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v20.services.BatchJobService/AddBatchJobOperations', $actualFuncCall);
    ...
    public function listBatchJobResultsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.BatchJobService/ListBatchJobResults', $actualFuncCall);
        $actualValue = $actualRequestObject->getResourceName();
        $this->assertProtobufEquals($formattedResourceName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function mutateBatchJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.BatchJobService/MutateBatchJob', $actualFuncCall);
    ...
    public function runBatchJobTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v20.services.BatchJobService/RunBatchJob', $actualApiFuncCall);
