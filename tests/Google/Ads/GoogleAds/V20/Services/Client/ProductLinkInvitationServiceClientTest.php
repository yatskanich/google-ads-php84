...
use Google\Ads\GoogleAds\V20\Services\CreateProductLinkInvitationRequest;
use Google\Ads\GoogleAds\V20\Services\CreateProductLinkInvitationResponse;
use Google\Ads\GoogleAds\V20\Services\RemoveProductLinkInvitationRequest;
use Google\Ads\GoogleAds\V20\Services\RemoveProductLinkInvitationResponse;
use Google\Ads\GoogleAds\V20\Services\UpdateProductLinkInvitationRequest;
use Google\Ads\GoogleAds\V20\Services\UpdateProductLinkInvitationResponse;
...
class ProductLinkInvitationServiceClientTest extends GeneratedTest
{
    ...
    public function createProductLinkInvitationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v20.services.ProductLinkInvitationService/CreateProductLinkInvitation', $actualFuncCall);
    ...
    public function removeProductLinkInvitationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.ProductLinkInvitationService/RemoveProductLinkInvitation', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function updateProductLinkInvitationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.ProductLinkInvitationService/UpdateProductLinkInvitation', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
