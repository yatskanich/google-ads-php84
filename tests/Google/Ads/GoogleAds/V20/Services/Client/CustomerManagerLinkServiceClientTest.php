...
use Google\Ads\GoogleAds\V20\Services\MoveManagerLinkRequest;
use Google\Ads\GoogleAds\V20\Services\MoveManagerLinkResponse;
use Google\Ads\GoogleAds\V20\Services\MutateCustomerManagerLinkRequest;
use Google\Ads\GoogleAds\V20\Services\MutateCustomerManagerLinkResponse;
...
class CustomerManagerLinkServiceClientTest extends GeneratedTest
{
    ...
    public function moveManagerLinkTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v20.services.CustomerManagerLinkService/MoveManagerLink', $actualFuncCall);
    ...
    public function mutateCustomerManagerLinkTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.CustomerManagerLinkService/MutateCustomerManagerLink', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
