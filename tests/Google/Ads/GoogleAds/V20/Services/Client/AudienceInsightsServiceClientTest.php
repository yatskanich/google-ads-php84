...
use Google\Ads\GoogleAds\V20\Common\AudienceInsightsAttribute;
use Google\Ads\GoogleAds\V20\Common\LocationInfo;
use Google\Ads\GoogleAds\V20\Services\BasicInsightsAudience;
use Google\Ads\GoogleAds\V20\Services\GenerateAudienceCompositionInsightsRequest;
use Google\Ads\GoogleAds\V20\Services\GenerateAudienceCompositionInsightsResponse;
use Google\Ads\GoogleAds\V20\Services\GenerateAudienceOverlapInsightsRequest;
use Google\Ads\GoogleAds\V20\Services\GenerateAudienceOverlapInsightsResponse;
use Google\Ads\GoogleAds\V20\Services\GenerateInsightsFinderReportRequest;
use Google\Ads\GoogleAds\V20\Services\GenerateInsightsFinderReportResponse;
use Google\Ads\GoogleAds\V20\Services\GenerateSuggestedTargetingInsightsRequest;
use Google\Ads\GoogleAds\V20\Services\GenerateSuggestedTargetingInsightsResponse;
use Google\Ads\GoogleAds\V20\Services\GenerateTargetingSuggestionMetricsRequest;
use Google\Ads\GoogleAds\V20\Services\GenerateTargetingSuggestionMetricsResponse;
use Google\Ads\GoogleAds\V20\Services\InsightsAudience;
use Google\Ads\GoogleAds\V20\Services\ListAudienceInsightsAttributesRequest;
use Google\Ads\GoogleAds\V20\Services\ListAudienceInsightsAttributesResponse;
use Google\Ads\GoogleAds\V20\Services\ListInsightsEligibleDatesRequest;
use Google\Ads\GoogleAds\V20\Services\ListInsightsEligibleDatesResponse;
...
class AudienceInsightsServiceClientTest extends GeneratedTest
{
    ...
    public function generateAudienceCompositionInsightsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v20.services.AudienceInsightsService/GenerateAudienceCompositionInsights', $actualFuncCall);
    ...
    public function generateAudienceOverlapInsightsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.AudienceInsightsService/GenerateAudienceOverlapInsights', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function generateInsightsFinderReportTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.AudienceInsightsService/GenerateInsightsFinderReport', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function generateSuggestedTargetingInsightsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.AudienceInsightsService/GenerateSuggestedTargetingInsights', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateTargetingSuggestionMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.AudienceInsightsService/GenerateTargetingSuggestionMetrics', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function listAudienceInsightsAttributesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.AudienceInsightsService/ListAudienceInsightsAttributes', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getDimensions();
        $this->assertProtobufEquals($dimensions, $actualValue);
    ...
    public function listInsightsEligibleDatesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.AudienceInsightsService/ListInsightsEligibleDates', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
