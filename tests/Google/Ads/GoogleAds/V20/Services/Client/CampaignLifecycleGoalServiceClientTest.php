...
use Google\Ads\GoogleAds\V20\Services\CampaignLifecycleGoalOperation;
use Google\Ads\GoogleAds\V20\Services\ConfigureCampaignLifecycleGoalsRequest;
use Google\Ads\GoogleAds\V20\Services\ConfigureCampaignLifecycleGoalsResponse;
...
class CampaignLifecycleGoalServiceClientTest extends GeneratedTest
{
    ...
    public function configureCampaignLifecycleGoalsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v20.services.CampaignLifecycleGoalService/ConfigureCampaignLifecycleGoals', $actualFuncCall);
