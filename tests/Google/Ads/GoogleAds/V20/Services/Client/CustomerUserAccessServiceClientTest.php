...
use Google\Ads\GoogleAds\V20\Services\CustomerUserAccessOperation;
use Google\Ads\GoogleAds\V20\Services\MutateCustomerUserAccessRequest;
use Google\Ads\GoogleAds\V20\Services\MutateCustomerUserAccessResponse;
...
class CustomerUserAccessServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCustomerUserAccessTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v20.services.CustomerUserAccessService/MutateCustomerUserAccess', $actualFuncCall);
    ...
    public function mutateCustomerUserAccessExceptionTest()
    {
        ...
        $request = new MutateCustomerUserAccessRequest()
            ...
            ->setOperation($operation);
        try {
            $gapicClient->mutateCustomerUserAccess($request);
    ...
    /** @test */
    public function mutateCustomerUserAccessAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
