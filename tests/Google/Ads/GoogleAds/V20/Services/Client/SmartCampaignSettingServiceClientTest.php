...
use Google\Ads\GoogleAds\V20\Services\GetSmartCampaignStatusRequest;
use Google\Ads\GoogleAds\V20\Services\GetSmartCampaignStatusResponse;
use Google\Ads\GoogleAds\V20\Services\MutateSmartCampaignSettingsRequest;
use Google\Ads\GoogleAds\V20\Services\MutateSmartCampaignSettingsResponse;
...
class SmartCampaignSettingServiceClientTest extends GeneratedTest
{
    ...
    public function getSmartCampaignStatusTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v20.services.SmartCampaignSettingService/GetSmartCampaignStatus', $actualFuncCall);
    ...
    public function mutateSmartCampaignSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v20.services.SmartCampaignSettingService/MutateSmartCampaignSettings', $actualFuncCall);
