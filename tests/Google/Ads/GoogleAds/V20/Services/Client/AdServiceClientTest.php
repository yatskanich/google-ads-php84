...
use Google\Ads\GoogleAds\V20\Services\MutateAdsRequest;
use Google\Ads\GoogleAds\V20\Services\MutateAdsResponse;
...
class AdServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v20.services.AdService/MutateAds', $actualFuncCall);
