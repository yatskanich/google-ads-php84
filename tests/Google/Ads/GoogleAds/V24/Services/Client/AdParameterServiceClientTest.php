...
use Google\Ads\GoogleAds\V24\Services\MutateAdParametersRequest;
use Google\Ads\GoogleAds\V24\Services\MutateAdParametersResponse;
...
class AdParameterServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdParametersTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.AdParameterService/MutateAdParameters', $actualFuncCall);
    ...
    public function mutateAdParametersExceptionTest()
    {
        ...
        $request = new MutateAdParametersRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateAdParameters($request);
    ...
    /** @test */
    public function mutateAdParametersAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
