...
use Google\Ads\GoogleAds\V24\Services\CreateCustomerClientResponse;
use Google\Ads\GoogleAds\V24\Services\CustomerOperation;
use Google\Ads\GoogleAds\V24\Services\ListAccessibleCustomersRequest;
use Google\Ads\GoogleAds\V24\Services\ListAccessibleCustomersResponse;
use Google\Ads\GoogleAds\V24\Services\MutateCustomerRequest;
use Google\Ads\GoogleAds\V24\Services\MutateCustomerResponse;
...
class CustomerServiceClientTest extends GeneratedTest
{
    ...
    public function createCustomerClientTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.CustomerService/CreateCustomerClient', $actualFuncCall);
    ...
    public function listAccessibleCustomersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.CustomerService/ListAccessibleCustomers', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function mutateCustomerTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.CustomerService/MutateCustomer', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
