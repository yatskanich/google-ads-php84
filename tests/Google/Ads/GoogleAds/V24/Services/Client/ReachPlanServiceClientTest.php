...
use Google\Ads\GoogleAds\V24\Services\CampaignDuration;
use Google\Ads\GoogleAds\V24\Services\Client\ReachPlanServiceClient;
use Google\Ads\GoogleAds\V24\Services\GenerateConversionRatesRequest;
use Google\Ads\GoogleAds\V24\Services\GenerateConversionRatesResponse;
use Google\Ads\GoogleAds\V24\Services\GenerateReachForecastRequest;
use Google\Ads\GoogleAds\V24\Services\GenerateReachForecastResponse;
use Google\Ads\GoogleAds\V24\Services\ListPlannableLocationsRequest;
use Google\Ads\GoogleAds\V24\Services\ListPlannableLocationsResponse;
use Google\Ads\GoogleAds\V24\Services\ListPlannableProductsRequest;
use Google\Ads\GoogleAds\V24\Services\ListPlannableProductsResponse;
use Google\Ads\GoogleAds\V24\Services\ListPlannableUserInterestsRequest;
use Google\Ads\GoogleAds\V24\Services\ListPlannableUserInterestsResponse;
use Google\Ads\GoogleAds\V24\Services\ListPlannableUserListsRequest;
use Google\Ads\GoogleAds\V24\Services\ListPlannableUserListsResponse;
...
class ReachPlanServiceClientTest extends GeneratedTest
{
    ...
    public function generateConversionRatesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.ReachPlanService/GenerateConversionRates', $actualFuncCall);
    ...
    public function generateReachForecastTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.ReachPlanService/GenerateReachForecast', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function listPlannableLocationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.ReachPlanService/ListPlannableLocations', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listPlannableProductsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.ReachPlanService/ListPlannableProducts', $actualFuncCall);
    ...
    /** @test */
    public function listPlannableUserInterestsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $this->assertTrue($transport->isExhausted());
        // Mock response
        $expectedResponse = new ListPlannableUserInterestsResponse();
        $transport->addResponse($expectedResponse);
        // Mock request
        $customerId = 'customerId-1772061412';
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.ReachPlanService/ListPlannableUserInterests', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function listPlannableUserInterestsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    public function listPlannableUserListsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.ReachPlanService/ListPlannableUserLists', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
