...
use Google\Ads\GoogleAds\V24\Services\MutateBiddingStrategiesRequest;
use Google\Ads\GoogleAds\V24\Services\MutateBiddingStrategiesResponse;
...
class BiddingStrategyServiceClientTest extends GeneratedTest
{
    ...
    public function mutateBiddingStrategiesTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.BiddingStrategyService/MutateBiddingStrategies', $actualFuncCall);
    ...
    public function mutateBiddingStrategiesExceptionTest()
    {
        ...
        $request = new MutateBiddingStrategiesRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateBiddingStrategies($request);
    ...
    /** @test */
    public function mutateBiddingStrategiesAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
