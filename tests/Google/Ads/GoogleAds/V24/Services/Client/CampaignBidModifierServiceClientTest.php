...
use Google\Ads\GoogleAds\V24\Services\MutateCampaignBidModifiersRequest;
use Google\Ads\GoogleAds\V24\Services\MutateCampaignBidModifiersResponse;
...
class CampaignBidModifierServiceClientTest extends GeneratedTest
{
    ...
    public function mutateCampaignBidModifiersTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.CampaignBidModifierService/MutateCampaignBidModifiers', $actualFuncCall);
    ...
    public function mutateCampaignBidModifiersExceptionTest()
    {
        ...
        $request = new MutateCampaignBidModifiersRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateCampaignBidModifiers($request);
    ...
    /** @test */
    public function mutateCampaignBidModifiersAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
