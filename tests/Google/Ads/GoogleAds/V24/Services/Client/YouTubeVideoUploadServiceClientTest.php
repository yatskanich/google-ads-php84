...
use Google\Ads\GoogleAds\V24\Resources\YouTubeVideoUpload;
...
use Google\Ads\GoogleAds\V24\Services\UpdateYouTubeVideoUploadResponse;
...
class YouTubeVideoUploadServiceClientTest extends GeneratedTest
{
    ...
    public function createYouTubeVideoUploadTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.YouTubeVideoUploadService/CreateYouTubeVideoUpload', $actualFuncCall);
    ...
    public function removeYouTubeVideoUploadTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.YouTubeVideoUploadService/RemoveYouTubeVideoUpload', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateYouTubeVideoUploadTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.YouTubeVideoUploadService/UpdateYouTubeVideoUpload', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getYouTubeVideoUpload();
        $this->assertProtobufEquals($youTubeVideoUpload, $actualValue);
