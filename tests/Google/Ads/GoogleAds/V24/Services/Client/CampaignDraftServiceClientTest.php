...
use Google\Ads\GoogleAds\V24\Services\ListCampaignDraftAsyncErrorsRequest;
use Google\Ads\GoogleAds\V24\Services\ListCampaignDraftAsyncErrorsResponse;
use Google\Ads\GoogleAds\V24\Services\MutateCampaignDraftsRequest;
use Google\Ads\GoogleAds\V24\Services\MutateCampaignDraftsResponse;
use Google\Ads\GoogleAds\V24\Services\PromoteCampaignDraftRequest;
...
class CampaignDraftServiceClientTest extends GeneratedTest
{
    ...
    public function listCampaignDraftAsyncErrorsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.CampaignDraftService/ListCampaignDraftAsyncErrors', $actualFuncCall);
    ...
    public function mutateCampaignDraftsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.CampaignDraftService/MutateCampaignDrafts', $actualFuncCall);
    ...
    public function mutateCampaignDraftsExceptionTest()
    {
        ...
        $request = new MutateCampaignDraftsRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateCampaignDrafts($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function promoteCampaignDraftTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.CampaignDraftService/PromoteCampaignDraft', $actualApiFuncCall);
