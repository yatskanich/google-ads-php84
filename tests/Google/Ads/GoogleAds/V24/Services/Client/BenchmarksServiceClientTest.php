...
use Google\Ads\GoogleAds\V24\Services\BenchmarksSource;
use Google\Ads\GoogleAds\V24\Services\Client\BenchmarksServiceClient;
use Google\Ads\GoogleAds\V24\Services\GenerateBenchmarksMetricsRequest;
use Google\Ads\GoogleAds\V24\Services\GenerateBenchmarksMetricsResponse;
use Google\Ads\GoogleAds\V24\Services\ListBenchmarksAvailableDatesRequest;
use Google\Ads\GoogleAds\V24\Services\ListBenchmarksAvailableDatesResponse;
use Google\Ads\GoogleAds\V24\Services\ListBenchmarksLocationsRequest;
use Google\Ads\GoogleAds\V24\Services\ListBenchmarksLocationsResponse;
use Google\Ads\GoogleAds\V24\Services\ListBenchmarksProductsRequest;
use Google\Ads\GoogleAds\V24\Services\ListBenchmarksProductsResponse;
use Google\Ads\GoogleAds\V24\Services\ListBenchmarksSourcesRequest;
use Google\Ads\GoogleAds\V24\Services\ListBenchmarksSourcesResponse;
use Google\Ads\GoogleAds\V24\Services\ProductFilter;
...
class BenchmarksServiceClientTest extends GeneratedTest
{
    ...
    public function generateBenchmarksMetricsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.BenchmarksService/GenerateBenchmarksMetrics', $actualFuncCall);
    ...
    public function listBenchmarksAvailableDatesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.BenchmarksService/ListBenchmarksAvailableDates', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listBenchmarksLocationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.BenchmarksService/ListBenchmarksLocations', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listBenchmarksProductsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.BenchmarksService/ListBenchmarksProducts', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listBenchmarksSourcesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.BenchmarksService/ListBenchmarksSources', $actualFuncCall);
