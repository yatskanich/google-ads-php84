...
use Google\Ads\GoogleAds\V24\Services\MutateAdGroupAdLabelsRequest;
use Google\Ads\GoogleAds\V24\Services\MutateAdGroupAdLabelsResponse;
...
class AdGroupAdLabelServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdGroupAdLabelsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.AdGroupAdLabelService/MutateAdGroupAdLabels', $actualFuncCall);
    ...
    public function mutateAdGroupAdLabelsExceptionTest()
    {
        ...
        $request = new MutateAdGroupAdLabelsRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateAdGroupAdLabels($request);
    ...
    /** @test */
    public function mutateAdGroupAdLabelsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
