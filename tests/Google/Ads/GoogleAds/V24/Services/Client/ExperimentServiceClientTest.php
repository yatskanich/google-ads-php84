...
use Google\Ads\GoogleAds\V24\Services\EndExperimentRequest;
use Google\Ads\GoogleAds\V24\Services\GraduateExperimentRequest;
use Google\Ads\GoogleAds\V24\Services\ListExperimentAsyncErrorsRequest;
use Google\Ads\GoogleAds\V24\Services\ListExperimentAsyncErrorsResponse;
use Google\Ads\GoogleAds\V24\Services\MutateExperimentsRequest;
use Google\Ads\GoogleAds\V24\Services\MutateExperimentsResponse;
use Google\Ads\GoogleAds\V24\Services\PromoteExperimentRequest;
use Google\Ads\GoogleAds\V24\Services\ScheduleExperimentRequest;
...
class ExperimentServiceClientTest extends GeneratedTest
{
    ...
    public function endExperimentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.ExperimentService/EndExperiment', $actualFuncCall);
    ...
    public function graduateExperimentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.ExperimentService/GraduateExperiment', $actualFuncCall);
        $actualValue = $actualRequestObject->getExperiment();
        $this->assertProtobufEquals($formattedExperiment, $actualValue);
    ...
    public function listExperimentAsyncErrorsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.ExperimentService/ListExperimentAsyncErrors', $actualFuncCall);
    ...
    public function mutateExperimentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.ExperimentService/MutateExperiments', $actualFuncCall);
    ...
    public function promoteExperimentTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.ExperimentService/PromoteExperiment', $actualApiFuncCall);
    ...
    public function scheduleExperimentTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.ExperimentService/ScheduleExperiment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getResourceName();
        $this->assertProtobufEquals($formattedResourceName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
