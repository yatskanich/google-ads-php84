...
use Google\Ads\GoogleAds\V24\Services\MutateAdsRequest;
use Google\Ads\GoogleAds\V24\Services\MutateAdsResponse;
...
class AdServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAdsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.AdService/MutateAds', $actualFuncCall);
    ...
    /** @test */
    public function mutateAdsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = new MutateAdsRequest()
            ->setCustomerId($customerId)
            ->setOperations($operations);
        $response = $gapicClient->mutateAdsAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
