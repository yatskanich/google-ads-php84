...
use Google\Ads\GoogleAds\V24\Services\UploadConversionAdjustmentsRequest;
use Google\Ads\GoogleAds\V24\Services\UploadConversionAdjustmentsResponse;
...
class ConversionAdjustmentUploadServiceClientTest extends GeneratedTest
{
    ...
    public function uploadConversionAdjustmentsTest()
    {
        ...
        $response = $gapicClient->uploadConversionAdjustments($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.ConversionAdjustmentUploadService/UploadConversionAdjustments', $actualFuncCall);
    ...
    public function uploadConversionAdjustmentsExceptionTest()
    {
        ...
        $request = new UploadConversionAdjustmentsRequest()
            ...
            ->setPartialFailure($partialFailure);
        try {
            $gapicClient->uploadConversionAdjustments($request);
    ...
    /** @test */
    public function uploadConversionAdjustmentsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = new UploadConversionAdjustmentsRequest()
            ...
            ->setConversionAdjustments($conversionAdjustments)
            ->setPartialFailure($partialFailure);
        $response = $gapicClient->uploadConversionAdjustmentsAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
