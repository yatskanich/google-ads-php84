...
use Google\Ads\GoogleAds\V24\Services\BillingSetupOperation;
use Google\Ads\GoogleAds\V24\Services\Client\BillingSetupServiceClient;
use Google\Ads\GoogleAds\V24\Services\MutateBillingSetupRequest;
use Google\Ads\GoogleAds\V24\Services\MutateBillingSetupResponse;
...
class BillingSetupServiceClientTest extends GeneratedTest
{
    ...
    public function mutateBillingSetupTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.BillingSetupService/MutateBillingSetup', $actualFuncCall);
