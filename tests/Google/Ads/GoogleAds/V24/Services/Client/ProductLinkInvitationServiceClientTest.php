...
use Google\Ads\GoogleAds\V24\Enums\ProductLinkInvitationStatusEnum\ProductLinkInvitationStatus;
use Google\Ads\GoogleAds\V24\Resources\ProductLinkInvitation;
use Google\Ads\GoogleAds\V24\Services\Client\ProductLinkInvitationServiceClient;
use Google\Ads\GoogleAds\V24\Services\CreateProductLinkInvitationRequest;
use Google\Ads\GoogleAds\V24\Services\CreateProductLinkInvitationResponse;
use Google\Ads\GoogleAds\V24\Services\RemoveProductLinkInvitationRequest;
use Google\Ads\GoogleAds\V24\Services\RemoveProductLinkInvitationResponse;
use Google\Ads\GoogleAds\V24\Services\UpdateProductLinkInvitationRequest;
use Google\Ads\GoogleAds\V24\Services\UpdateProductLinkInvitationResponse;
...
class ProductLinkInvitationServiceClientTest extends GeneratedTest
{
    ...
    public function createProductLinkInvitationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.ProductLinkInvitationService/CreateProductLinkInvitation', $actualFuncCall);
    ...
    public function removeProductLinkInvitationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.ProductLinkInvitationService/RemoveProductLinkInvitation', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function updateProductLinkInvitationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.ProductLinkInvitationService/UpdateProductLinkInvitation', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
