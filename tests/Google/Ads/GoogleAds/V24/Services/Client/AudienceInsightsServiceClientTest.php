...
namespace Google\Ads\GoogleAds\V24\Services\Client;

use Google\Ads\GoogleAds\V24\Common\AudienceInsightsAttribute;
...
use Google\Ads\GoogleAds\V24\Services\GenerateAudienceCompositionInsightsRequest;
use Google\Ads\GoogleAds\V24\Services\GenerateAudienceCompositionInsightsResponse;
use Google\Ads\GoogleAds\V24\Services\GenerateAudienceDefinitionRequest;
use Google\Ads\GoogleAds\V24\Services\GenerateAudienceDefinitionResponse;
use Google\Ads\GoogleAds\V24\Services\GenerateAudienceOverlapInsightsRequest;
use Google\Ads\GoogleAds\V24\Services\GenerateAudienceOverlapInsightsResponse;
use Google\Ads\GoogleAds\V24\Services\GenerateInsightsFinderReportRequest;
use Google\Ads\GoogleAds\V24\Services\GenerateInsightsFinderReportResponse;
use Google\Ads\GoogleAds\V24\Services\GenerateSuggestedTargetingInsightsRequest;
use Google\Ads\GoogleAds\V24\Services\GenerateSuggestedTargetingInsightsResponse;
use Google\Ads\GoogleAds\V24\Services\GenerateTargetingSuggestionMetricsRequest;
use Google\Ads\GoogleAds\V24\Services\GenerateTargetingSuggestionMetricsResponse;
use Google\Ads\GoogleAds\V24\Services\InsightsAudience;
use Google\Ads\GoogleAds\V24\Services\InsightsAudienceDescription;
use Google\Ads\GoogleAds\V24\Services\ListAudienceInsightsAttributesRequest;
use Google\Ads\GoogleAds\V24\Services\ListAudienceInsightsAttributesResponse;
use Google\Ads\GoogleAds\V24\Services\ListInsightsEligibleDatesRequest;
use Google\Ads\GoogleAds\V24\Services\ListInsightsEligibleDatesResponse;
...
class AudienceInsightsServiceClientTest extends GeneratedTest
{
    ...
    public function generateAudienceCompositionInsightsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.AudienceInsightsService/GenerateAudienceCompositionInsights', $actualFuncCall);
    ...
    /** @test */
    public function generateAudienceDefinitionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $this->assertTrue($transport->isExhausted());
        // Mock response
        $expectedResponse = new GenerateAudienceDefinitionResponse();
        $transport->addResponse($expectedResponse);
        // Mock request
        $customerId = 'customerId-1772061412';
        $audienceDescription = new InsightsAudienceDescription();
        $audienceDescriptionCountryLocations = [];
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.AudienceInsightsService/GenerateAudienceDefinition', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getAudienceDescription();
        $this->assertProtobufEquals($audienceDescription, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }

    /** @test */
    public function generateAudienceDefinitionExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = new GenerateAudienceDefinitionRequest()
            ...
            ->setAudienceDescription($audienceDescription);
        try {
            $gapicClient->generateAudienceDefinition($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function generateAudienceOverlapInsightsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.AudienceInsightsService/GenerateAudienceOverlapInsights', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function generateInsightsFinderReportTest()
    {
        ...
        // Mock request
        $customerId = 'customerId-1772061412';
        $baselineAudience = new InsightsAudience();
        $baselineAudienceCountryLocations = [];
        $baselineAudience->setCountryLocations($baselineAudienceCountryLocations);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.AudienceInsightsService/GenerateInsightsFinderReport', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function generateSuggestedTargetingInsightsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.AudienceInsightsService/GenerateSuggestedTargetingInsights', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function generateTargetingSuggestionMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.AudienceInsightsService/GenerateTargetingSuggestionMetrics', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
    ...
    public function listAudienceInsightsAttributesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.AudienceInsightsService/ListAudienceInsightsAttributes', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomerId();
        $this->assertProtobufEquals($customerId, $actualValue);
        $actualValue = $actualRequestObject->getDimensions();
        $this->assertProtobufEquals($dimensions, $actualValue);
    ...
    public function listInsightsEligibleDatesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.AudienceInsightsService/ListInsightsEligibleDates', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
