...
use Google\Ads\GoogleAds\V24\Services\MutateBiddingSeasonalityAdjustmentsRequest;
use Google\Ads\GoogleAds\V24\Services\MutateBiddingSeasonalityAdjustmentsResponse;
...
class BiddingSeasonalityAdjustmentServiceClientTest extends GeneratedTest
{
    ...
    public function mutateBiddingSeasonalityAdjustmentsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.BiddingSeasonalityAdjustmentService/MutateBiddingSeasonalityAdjustments', $actualFuncCall);
    ...
    public function mutateBiddingSeasonalityAdjustmentsExceptionTest()
    {
        ...
        $request = new MutateBiddingSeasonalityAdjustmentsRequest()
            ...
            ->setOperations($operations);
        try {
            $gapicClient->mutateBiddingSeasonalityAdjustments($request);
    ...
    /** @test */
    public function mutateBiddingSeasonalityAdjustmentsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
