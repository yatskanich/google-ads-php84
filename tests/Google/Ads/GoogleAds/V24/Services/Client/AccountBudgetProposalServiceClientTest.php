...
use Google\Ads\GoogleAds\V24\Services\AccountBudgetProposalOperation;
use Google\Ads\GoogleAds\V24\Services\Client\AccountBudgetProposalServiceClient;
use Google\Ads\GoogleAds\V24\Services\MutateAccountBudgetProposalRequest;
use Google\Ads\GoogleAds\V24\Services\MutateAccountBudgetProposalResponse;
...
class AccountBudgetProposalServiceClientTest extends GeneratedTest
{
    ...
    public function mutateAccountBudgetProposalTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.AccountBudgetProposalService/MutateAccountBudgetProposal', $actualFuncCall);
    ...
    public function mutateAccountBudgetProposalExceptionTest()
    {
        ...
        $request = new MutateAccountBudgetProposalRequest()
            ...
            ->setOperation($operation);
        try {
            $gapicClient->mutateAccountBudgetProposal($request);
    ...
    /** @test */
    public function mutateAccountBudgetProposalAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
