...
use Google\Ads\GoogleAds\V24\Services\ApplyIncentiveRequest;
use Google\Ads\GoogleAds\V24\Services\ApplyIncentiveResponse;
use Google\Ads\GoogleAds\V24\Services\Client\IncentiveServiceClient;
use Google\Ads\GoogleAds\V24\Services\FetchIncentiveRequest;
use Google\Ads\GoogleAds\V24\Services\FetchIncentiveResponse;
...
class IncentiveServiceClientTest extends GeneratedTest
{
    ...
    public function applyIncentiveTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.IncentiveService/ApplyIncentive', $actualFuncCall);
    ...
    public function fetchIncentiveTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.IncentiveService/FetchIncentive', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
