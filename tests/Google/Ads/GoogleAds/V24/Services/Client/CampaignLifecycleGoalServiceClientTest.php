...
use Google\Ads\GoogleAds\V24\Services\CampaignLifecycleGoalOperation;
use Google\Ads\GoogleAds\V24\Services\Client\CampaignLifecycleGoalServiceClient;
use Google\Ads\GoogleAds\V24\Services\ConfigureCampaignLifecycleGoalsRequest;
use Google\Ads\GoogleAds\V24\Services\ConfigureCampaignLifecycleGoalsResponse;
...
class CampaignLifecycleGoalServiceClientTest extends GeneratedTest
{
    ...
    public function configureCampaignLifecycleGoalsTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.CampaignLifecycleGoalService/ConfigureCampaignLifecycleGoals', $actualFuncCall);
