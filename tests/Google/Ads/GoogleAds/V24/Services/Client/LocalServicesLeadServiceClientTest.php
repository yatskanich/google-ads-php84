...
use Google\Ads\GoogleAds\V24\Services\AppendLeadConversationRequest;
use Google\Ads\GoogleAds\V24\Services\AppendLeadConversationResponse;
...
use Google\Ads\GoogleAds\V24\Services\ProvideLeadFeedbackResponse;
...
class LocalServicesLeadServiceClientTest extends GeneratedTest
{
    ...
    public function appendLeadConversationTest()
    {
        ...
        $this->assertSame('/google.ads.googleads.v24.services.LocalServicesLeadService/AppendLeadConversation', $actualFuncCall);
    ...
    public function provideLeadFeedbackTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.googleads.v24.services.LocalServicesLeadService/ProvideLeadFeedback', $actualFuncCall);
